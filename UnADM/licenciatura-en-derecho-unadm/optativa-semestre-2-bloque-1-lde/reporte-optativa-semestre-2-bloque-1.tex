...
\def\documenttitle {Interaprendizajes en ambientes virtuales}
\def\documentsubtitle {Panorama de la asignatura}
\def\documentsubject {Actividad X - Interaprendizajes en ambientes virtuales}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Interaprendizajes en ambientes virtuales}
\def\coursecode {004}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Interaprendizajes en ambientes virtuales}
...
\begin{abstractd}
  Esta base editorial sintetiza la materia \textit{Interaprendizajes en ambientes virtuales}
  ...
  evidencia profesional verificable. El encuadre se apoya en la malla de Derecho,
  el sitio institucional y las notas de bienvenida e introduccion compartidas por
  la figura docente para esta asignatura \citep{unadmSitioWeb,unadmMallaDerecho2024,santanaBienvenidaInteraprendizaje2026,introduccionInteraprendizajeVirtualDerecho2026}.
\end{abstractd}
...
orientados al Derecho \citep{introduccionInteraprendizajeVirtualDerecho2026}.
...
La bienvenida docente remarca cuatro expectativas permanentes: autonomia,
participacion proactiva, respeto en la interaccion y aprovechamiento reflexivo de
las herramientas digitales. Esas expectativas deben notarse en cada reporte,
presentacion y producto visual de la materia \citep{santanaBienvenidaInteraprendizaje2026}.
...
% - Priorizar cierre de brecha recurrente: pendientes_editoriales (216 nodos).
% - Priorizar cierre de brecha recurrente: tesis (9 nodos).
% --- Fin Ciclo A ---

\section{Conclusion editorial}

Interaprendizajes en ambientes virtuales funciona como una antesala a la practica
...
\clearpage
\nocite{unadmSitioWeb,unadmMallaDerecho2024,santanaBienvenidaInteraprendizaje2026,introduccionInteraprendizajeVirtualDerecho2026}
\bibliography{optativa-semestre-2-bloque-1}


\subsection*{Citas de refuerzo Ciclo A}
La mejora editorial se vincula con la memoria documental disponible mediante las referencias \citep{unadmSitioWeb,unadmMallaDerecho2024,santanaBienvenidaInteraprendizaje2026}. Estas citas deben revisarse en una etapa disciplinar fina para sustituir o complementar fuentes genéricas por literatura específica del tema.

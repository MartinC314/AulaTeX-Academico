...
\newcommand{\coursename}{Optativa Semestre 1 Bloque 1}
\newcommand{\coursecode}{LDE-S1B1}
\newcommand{\activitytitle}{Plantilla base de Optativa Semestre 1 Bloque 1}
\newcommand{\activitysubtitle}{Actividad X - Optativa Semestre 1 Bloque 1}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{optativa-semestre-1-bloque-1.bib}.

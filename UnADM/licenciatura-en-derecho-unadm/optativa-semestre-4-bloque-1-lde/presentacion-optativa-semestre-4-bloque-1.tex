...
\newcommand{\coursename}{Optativa Semestre 4 Bloque 1}
\newcommand{\coursecode}{LDE-S4B1}
\newcommand{\activitytitle}{Plantilla base de Optativa Semestre 4 Bloque 1}
\newcommand{\activitysubtitle}{Actividad X - Optativa Semestre 4 Bloque 1}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{optativa-semestre-4-bloque-1.bib}.

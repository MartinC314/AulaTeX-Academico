...
\newcommand{\coursename}{Optativa Semestre 4 Bloque 2}
\newcommand{\coursecode}{LDE-S4B2}
\newcommand{\activitytitle}{Plantilla base de Optativa Semestre 4 Bloque 2}
\newcommand{\activitysubtitle}{Actividad X - Optativa Semestre 4 Bloque 2}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{optativa-semestre-4-bloque-2.bib}.

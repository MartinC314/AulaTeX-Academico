...
\def\documenttitle {Plantilla base de Seminario de titulacion II}
\def\documentsubtitle {Actividad X - Seminario de titulacion II}
\def\documentsubject {Licenciatura en Derecho}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Seminario de titulacion II}
\def\coursecode {LDE-S8B1}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Seminario de titulacion II}
...
\begin{abstractd}
  ...
  \textit{Seminario de titulacion II} dentro de la Licenciatura en Derecho de la UnADM.
...
\bibliography{seminario-de-titulacion-ii}

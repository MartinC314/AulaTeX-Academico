...
\newcommand{\coursename}{Seminario de titulacion II}
\newcommand{\coursecode}{LDE-S8B1}
\newcommand{\activitytitle}{Plantilla base de Seminario de titulacion II}
\newcommand{\activitysubtitle}{Actividad X - Seminario de titulacion II}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{seminario-de-titulacion-ii.bib}.

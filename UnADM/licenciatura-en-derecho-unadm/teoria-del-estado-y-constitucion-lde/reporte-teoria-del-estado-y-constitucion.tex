...
\def\documenttitle {Plantilla base de Teoria del Estado y Constitucion}
\def\documentsubtitle {Actividad X - Teoria del Estado y Constitucion}
...
\begin{abstractd}
  ...
  \textit{Teoria del Estado y Constitucion} dentro de la Licenciatura en Derecho de la UnADM.
...
\bibliography{teoria-del-estado-y-constitucion}

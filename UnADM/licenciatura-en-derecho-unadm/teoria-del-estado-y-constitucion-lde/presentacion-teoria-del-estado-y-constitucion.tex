...
\newcommand{\coursename}{Teoria del Estado y Constitucion}
\newcommand{\coursecode}{LDE-S2B2}
\newcommand{\activitytitle}{Plantilla base de Teoria del Estado y Constitucion}
\newcommand{\activitysubtitle}{Actividad X - Teoria del Estado y Constitucion}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{teoria-del-estado-y-constitucion.bib}.

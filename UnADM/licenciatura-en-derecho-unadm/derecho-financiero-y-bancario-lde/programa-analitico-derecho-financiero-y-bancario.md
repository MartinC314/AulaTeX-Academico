# Programa analitico editorial - Derecho financiero y bancario

## Encuadre institucional

Asignatura de la Licenciatura en Derecho de la UnADM ubicada en semestre
3, bloque 2. Su funcion editorial es orientar
...
en $(@{Name=Derecho financiero y bancario; Block=2; Credits=8; Type=Obligatoria; Slug=derecho-financiero-y-bancario; Semester=3}.Slug).bib.
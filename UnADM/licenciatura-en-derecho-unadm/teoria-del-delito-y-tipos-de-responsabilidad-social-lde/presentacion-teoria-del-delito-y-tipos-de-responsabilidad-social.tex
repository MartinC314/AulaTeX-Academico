...
\newcommand{\coursename}{Teoria del delito y tipos de responsabilidad social}
\newcommand{\coursecode}{LDE-S4B2}
\newcommand{\activitytitle}{Plantilla base de Teoria del delito y tipos de responsabilidad social}
\newcommand{\activitysubtitle}{Actividad X - Teoria del delito y tipos de responsabilidad social}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{teoria-del-delito-y-tipos-de-responsabilidad-social.bib}.

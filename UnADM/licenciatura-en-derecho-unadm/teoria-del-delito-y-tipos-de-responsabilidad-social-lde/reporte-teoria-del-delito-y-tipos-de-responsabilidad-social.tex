...
\def\documenttitle {Plantilla base de Teoria del delito y tipos de responsabilidad social}
\def\documentsubtitle {Actividad X - Teoria del delito y tipos de responsabilidad social}
\def\documentsubject {Licenciatura en Derecho}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Teoria del delito y tipos de responsabilidad social}
\def\coursecode {LDE-S4B2}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Teoria del delito y tipos de responsabilidad social}
...
\begin{abstractd}
  ...
  \textit{Teoria del delito y tipos de responsabilidad social} dentro de la Licenciatura en Derecho de la UnADM.
...
\bibliography{teoria-del-delito-y-tipos-de-responsabilidad-social}

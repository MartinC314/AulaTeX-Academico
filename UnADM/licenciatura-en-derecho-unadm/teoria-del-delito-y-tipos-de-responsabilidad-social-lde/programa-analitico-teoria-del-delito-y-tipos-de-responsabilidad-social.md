# Programa analitico editorial - Teoria del delito y tipos de responsabilidad social

## Encuadre institucional

Asignatura de la Licenciatura en Derecho de la UnADM ubicada en semestre
4, bloque 2. Su funcion editorial es orientar
...
en $(@{Name=Teoria del delito y tipos de responsabilidad social; Block=2; Credits=8; Type=Obligatoria; Slug=teoria-del-delito-y-tipos-de-responsabilidad-social; Semester=4}.Slug).bib.
...
\newcommand{\coursename}{Optativa Semestre 3 Bloque 2}
\newcommand{\coursecode}{LDE-S3B2}
\newcommand{\activitytitle}{Plantilla base de Optativa Semestre 3 Bloque 2}
\newcommand{\activitysubtitle}{Actividad X - Optativa Semestre 3 Bloque 2}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{optativa-semestre-3-bloque-2.bib}.

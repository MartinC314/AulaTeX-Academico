...
\def\documenttitle {Plantilla base de Derecho de la responsabilidad civil y danos}
\def\documentsubtitle {Actividad X - Derecho de la responsabilidad civil y danos}
\def\documentsubject {Licenciatura en Derecho}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Derecho de la responsabilidad civil y danos}
\def\coursecode {LDE-S6B1}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Derecho de la responsabilidad civil y danos}
...
\begin{abstractd}
  ...
  \textit{Derecho de la responsabilidad civil y danos} dentro de la Licenciatura en Derecho de la UnADM.
...
\bibliography{derecho-de-la-responsabilidad-civil-y-danos}

...
\newcommand{\coursename}{Derecho de la responsabilidad civil y danos}
\newcommand{\coursecode}{LDE-S6B1}
\newcommand{\activitytitle}{Plantilla base de Derecho de la responsabilidad civil y danos}
\newcommand{\activitysubtitle}{Actividad X - Derecho de la responsabilidad civil y danos}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{derecho-de-la-responsabilidad-civil-y-danos.bib}.

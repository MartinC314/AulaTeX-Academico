...
\section{Progresion de la competencia comunicativa escrita}

\subsection{Fundamentos de la escritura academica}

\subsubsection{Criterios de calidad textual}
\textbf{La escritura academica} es un proceso de planificacion, organizacion, revision y adecuacion del discurso al contexto y al receptor. Su calidad depende de la articulacion de varios criterios: la \textbf{claridad} permite comprender el sentido sin ambiguedades; la \textbf{coherencia} ordena las ideas alrededor de un planteamiento reconocible; la \textbf{cohesion} vincula las partes del texto; y la \textbf{pertinencia} ajusta el contenido, el registro y la finalidad a la situacion comunicativa. Por ello, escribir academicamente no consiste en aplicar reglas aisladas, sino en controlar el sentido del mensaje y sustentar las ideas \citep{correaManualBasicoEscritura2018,nunezcortesEscrituraAcademicaTeoria2015}.

\subsubsection{Autonomia y progresion de la competencia}
\textbf{La autonomia en la escritura} implica asumir decisiones sobre la intencion, la estructura, la revision y la presentacion del texto; en consecuencia, se relaciona con la responsabilidad de evaluar el efecto del mensaje y corregirlo antes de comunicarlo \citep{ayalaTallerLecturaRedaccion2010,vitoriaEscrituraAcademicaFormacion2019}. Desde esta base conceptual, el desarrollo presenta las seis actividades como evidencias de una competencia construida progresivamente: la Actividad 1 analiza un mensaje mal formulado; la Actividad 2 distingue la redaccion espontanea de la academica; la Actividad 3 transfiere criterios al ambito laboral; la Actividad 4 examina la legibilidad digital; la Actividad 5 demuestra la reescritura de un registro informal; y la Actividad 6 organiza la relacion entre autonomia, responsabilidad y calidad textual. El portafolio permite asi observar el paso de una reaccion inmediata a una escritura intencional, estructurada y consciente del receptor.
...
\input{anexos-portafolio/actividad-3}
...
La integracion permite reconocer una progresion definida en tres fases:

\begin{itemize}
  \item \textbf{Diagnostico} (actividades 1 y 2): identifican el conflicto comunicativo y distinguen los criterios que separan una opinion espontanea de un texto academico funcional.
  \item \textbf{Transferencia} (actividades 3 y 4): trasladan esos criterios a contextos concretos de escritura profesional y evaluacion digital.
  \item \textbf{Apropiacion} (actividades 5 y 6): consolidan el aprendizaje, primero mediante la reescritura de un texto y luego mediante su organizacion conceptual.
\end{itemize}

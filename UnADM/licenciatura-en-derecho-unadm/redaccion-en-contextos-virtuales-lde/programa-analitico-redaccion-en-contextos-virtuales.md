# Programa analitico editorial - Redaccion en contextos virtuales

## Encuadre institucional

Asignatura de la Licenciatura en Derecho de la UnADM ubicada en semestre
, bloque . Su funcion editorial es orientar
...
en $(@{Name=Redaccion en contextos virtuales; Block=; Credits=; Type=Curso de apoyo existente; Slug=redaccion-en-contextos-virtuales; Semester=}.Slug).bib.
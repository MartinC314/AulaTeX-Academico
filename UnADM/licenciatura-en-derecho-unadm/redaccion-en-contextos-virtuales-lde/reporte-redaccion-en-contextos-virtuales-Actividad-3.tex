...
\section{Análisis comparativo de claridad, tono y estructura}

Los dos correos de la planeación permiten contrastar una diferencia central: el primero comunica urgencia, pero no construye condiciones para la colaboración; el segundo conserva la urgencia, pero la organiza con cortesía, estructura y precisión. En términos de redacción, el problema no es pedir algo con rapidez, sino hacerlo sin asunto claro, sin contexto suficiente y con expresiones que pueden interpretarse como presión o descuido profesional. Por ello, la comparación atenderá a cinco criterios complementarios: asunto, tono, claridad, estructura y adecuación al receptor. Esta organización relaciona cada rasgo observable con la finalidad del mensaje y con las condiciones de su recepción, de acuerdo con la importancia de adecuar el texto a la situación comunicativa \citep{ayalaTallerLecturaRedaccion2010,nunezcortesEscrituraAcademicaTeoria2015}.
...
\end{longtable}
	...
	En el primer correo se identifican al menos tres errores relevantes: asunto vago, tono informal y falta de estructura. También se observa una urgencia mal gestionada, porque el mensaje no explica el motivo de la premura ni ofrece información suficiente para que la otra persona responda con eficiencia. En cambio, el segundo correo presenta tres aciertos claros: asunto específico, cortesía profesional y solicitud contextualizada. Por tanto, la \textbf{claridad} puede entenderse como la organización de la información de modo que el receptor identifique la solicitud, su justificación y la acción esperada; no depende únicamente de usar menos palabras. Esta adecuación al propósito y al destinatario corresponde a la construcción de textos situados comunicativamente \citep{ayalaTallerLecturaRedaccion2010,nunezcortesEscrituraAcademicaTeoria2015,vitoriaEscrituraAcademicaFormacion2019}. En consecuencia, un mensaje eficaz permite identificar qué se solicita, por qué se solicita y cómo puede responder el destinatario.

...
\section{Dos registros para un mismo problema}

Se analizarán dos textos que abordan la experiencia de estudiar en línea. El contraste se examina a partir de cuatro criterios de la escritura académica \citep{nunezcortesEscrituraAcademicaTeoria2015}:

\begin{itemize}
  \item \textbf{Claridad:} el enunciado permite identificar sin ambigüedad qué se afirma.
  \item \textbf{Coherencia:} las ideas guardan una relación lógica y progresan hacia una conclusión.
  \item \textbf{Cohesión:} los conectores enlazan las oraciones y sostienen el hilo del razonamiento.
  \item \textbf{Formalidad:} el registro se ajusta al contexto universitario y evita la carga emotiva.
\end{itemize}

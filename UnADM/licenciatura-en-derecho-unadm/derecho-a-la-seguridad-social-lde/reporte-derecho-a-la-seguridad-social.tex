...
\def\documenttitle {Plantilla base de Derecho a la seguridad social}
\def\documentsubtitle {Actividad X - Derecho a la seguridad social}
...
\begin{abstractd}
  ...
  \textit{Derecho a la seguridad social} dentro de la Licenciatura en Derecho de la UnADM.

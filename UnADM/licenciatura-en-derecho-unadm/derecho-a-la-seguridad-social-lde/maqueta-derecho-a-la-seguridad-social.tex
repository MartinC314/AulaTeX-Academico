...
\title{Derecho a la Seguridad Social}
\author{AulaTeX}
\date{\today}
...
\noindent\textbf{Nodo editorial:} UnADM/licenciatura-en-derecho-unadm/derecho-a-la-seguridad-social-lde\\
\textbf{Padre editorial:} UnADM/licenciatura-en-derecho-unadm\\
...
\begin{itemize}[leftmargin=*]
  ...
  \item Completar la maqueta inicial de Derecho a la Seguridad Social.
\end{itemize}

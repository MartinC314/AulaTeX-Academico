...
\newcommand{\coursename}{Seminario de titulacion I}
\newcommand{\coursecode}{LDE-S7B2}
\newcommand{\activitytitle}{Plantilla base de Seminario de titulacion I}
\newcommand{\activitysubtitle}{Actividad X - Seminario de titulacion I}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{seminario-de-titulacion-i.bib}.

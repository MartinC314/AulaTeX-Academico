...
\def\documentsubject {Semanas 4 y 5 - Actividad 3 - Filosofía del Derecho}
...
\subsection{El matrimonio igualitario ante la jurisprudencia constitucional}
...
En el caso analizado se identifican varios actos jurídicos e institucionales conectados entre sí:

\begin{itemize}
  \item El \textbf{acto jurídico principal}: el matrimonio, donde la voluntad de quienes desean contraerlo busca producir consecuencias reconocidas por el Derecho.
  \item El \textbf{acto legislativo} de definir el matrimonio en una norma civil local.
  \item El \textbf{acto jurisdiccional} de revisar esa definición mediante el juicio de amparo.
  \item El \textbf{acto interpretativo} de la Suprema Corte al fijar jurisprudencia obligatoria.
\end{itemize}

Visto como sistema, el caso no se reduce a una pareja que quiere casarse; muestra una cadena normativa donde voluntad, ley, autoridad y Constitución interactúan.

...
\section{Comparación entre Derecho Natural y Positivismo Jurídico}
	...
	\subsection{Fundamentos filosóficos y criterios de comparación}

La \textbf{filosofía del derecho} estudia los fundamentos, fines y criterios de justificación del fenómeno jurídico; por ello, el cuadro organiza un \textbf{análisis de elementos fundamentales} del Derecho Natural y del Positivismo Jurídico: concepto, autores, fundamento, principios, características, relación entre derecho y moral, interpretación, aplicación de normas legales y ejemplos del contexto mexicano. Esta estructura permite contrastar no sólo definiciones, sino la función que cada corriente cumple al identificar, justificar, interpretar y aplicar el derecho. Además, las teorías contemporáneas permiten situar el debate en problemas de derechos humanos, argumentación, principios constitucionales, justicia distributiva, género y reparación de víctimas \citep{rojas-gonzalezFilosofiaDerecho2018,lovonManualPracticoFilosofia2020}.

Mi postura es que el Derecho no debe reducirse ni a una moral abstracta ni a una formalidad normativa autosuficiente: la primera puede carecer de mecanismos institucionales de cumplimiento, mientras que la segunda puede admitir normas formalmente válidas pero materialmente injustas. En consecuencia, sostengo que el análisis y la \textbf{aplicación de normas legales} deben articular tres exigencias:

% Se enumeran porque cada exigencia responde a una objeción distinta; la prosa
% siguiente las reintegra al criterio de comparación del cuadro.
\begin{enumerate}
  \item \textbf{Validez institucional}: la norma debe provenir de la autoridad competente y del procedimiento previsto, criterio que el positivismo jurídico aporta con precisión \citep{lovonManualPracticoFilosofia2020}.
  \item \textbf{Justificación mediante principios de justicia}: la validez formal no basta cuando el contenido resulta materialmente injusto, y es aquí donde el derecho natural conserva fuerza crítica \citep{rojas-gonzalezFilosofiaDerecho2018}.
  \item \textbf{Protección efectiva de la persona}: el criterio decisivo es si la norma, aplicada al caso, ampara la dignidad de quien la invoca.
\end{enumerate}

El cuadro permite identificar qué aporta cada corriente a ese examen y qué límite crítico impone la otra.
...
\subsection{Justicia, validez y aplicación de normas legales}

La comparación muestra que ambas corrientes responden a necesidades distintas dentro del sistema jurídico. Desde la \textbf{filosofía del derecho}, el \textbf{Derecho Natural} resulta indispensable cuando la ley positiva se vuelve insuficiente para proteger a la persona concreta, porque permite afirmar que la legalidad no basta si una norma vulnera la dignidad humana, desconoce \textbf{derechos fundamentales} o perpetúa desigualdades. Su función crítica consiste en examinar quién soporta el costo de una decisión legal y si ese costo puede justificarse frente a la justicia. Por ello, la \textbf{aplicación de normas legales} no se reduce a ejecutar una regla: también exige valorar sus efectos en materias sensibles como víctimas, género, reparación integral y límites al poder público, para evitar que el propio sistema reproduzca daño \citep{LeyGeneralVictimas,franzoniacevedoLeyGeneralAcceso2017}.
...
La tensión más importante aparece cuando una norma formalmente válida produce consecuencias injustas. Frente a ese problema, sostengo que la solución no consiste en abandonar la legalidad ni en sustituirla por convicciones morales individuales, sino en exigir una interpretación jurídicamente argumentada desde principios constitucionales y derechos humanos. Este criterio obliga a examinar, de manera conjunta, la competencia de la autoridad, el procedimiento aplicable, la finalidad de la norma y sus efectos sobre la dignidad, la igualdad y la protección efectiva de las personas.

Las teorías contemporáneas ayudan a construir ese puente: el constitucionalismo incorpora principios; el positivismo incluyente reconoce criterios morales positivizados; las teorías de la argumentación distinguen reglas y principios; y los enfoques críticos obligan a revisar la eficacia real de las instituciones. Así, la Filosofía del Derecho contemporánea no elimina la oposición entre Derecho Natural y Positivismo Jurídico, sino que la transforma en una herramienta para justificar decisiones con validez, justicia y responsabilidad institucional \citep{rojas-gonzalezFilosofiaDerecho2018,ruizrodriguezFilosofiaDerecho2009}.

\section{Conclusión}

El Derecho Natural y el Positivismo Jurídico ofrecen dimensiones complementarias para comprender el derecho: el primero aporta criterios de justicia material, mientras que el segundo permite identificar la validez institucional de las normas. Mi postura es que la formación jurídica debe mantener ambas exigencias: aplicar el orden normativo conforme a la competencia y al procedimiento, pero examinar también si sus efectos protegen efectivamente a la persona. Así, el Derecho Natural recuerda que la ley debe orientarse por la justicia, la dignidad humana y el bien común; el Positivismo Jurídico aporta las condiciones de certeza y operatividad necesarias para convertir esa orientación en decisiones exigibles. Prescindir de cualquiera de las dos dimensiones genera un riesgo específico: la legalidad puede reducirse a formalismo o la justicia quedar sin instrumentos institucionales de garantía \citep{finnisEstudiosTeoriaDerecho2017,ruizrodriguezFilosofiaDerecho2009}.

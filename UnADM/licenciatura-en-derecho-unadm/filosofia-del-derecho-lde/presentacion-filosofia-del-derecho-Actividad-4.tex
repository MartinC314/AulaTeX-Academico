...
\newcommand{\CoverSlide}{%
  ...
  \noindent\colorbox{unadmGreenDark}{%
    \begin{minipage}[t][10.55cm][t]{0.58\paperwidth}
      ...
      \hspace*{0.75cm}\begin{minipage}{9.7cm}
        {\color{white}\fontsize{24}{29}\selectfont\bfseries Actividad 4: Filosofia del Derecho\par}
        \vspace{0.35cm}
  ...
  \colorbox{unadmGreen}{%
    \begin{minipage}[t][10.55cm][t]{0.42\paperwidth}
      ...
      {\color{white}\small Obligatoria - Semestre 1 - Bloque 2}
    \end{minipage}%
  }%
}
  ...
  \noindent\begin{minipage}[t][10.55cm][t]{\paperwidth}
    ...
    \noindent\colorbox{unadmGreen}{%
      \begin{minipage}[c][0.56cm][c]{\paperwidth}
        \hspace*{0.65cm}{\color{white}\small Filosofia del Derecho - UnADM - \today}
      \end{minipage}%
    }
  \end{minipage}
}
...
\ContentSlide{Objetivo editorial}{
  ...
  \begin{itemize}
    ...
    \item Bibliografia local: \texttt{filosofia-del-derecho.bib}.
  \end{itemize}
}

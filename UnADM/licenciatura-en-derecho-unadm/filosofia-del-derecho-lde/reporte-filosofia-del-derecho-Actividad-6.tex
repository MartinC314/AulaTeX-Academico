...
% ==============================================================================
\section{El caso ante el criterio jurídico}
...
El primer concepto decisivo es la relación entre \textbf{derecho y moral}. Laun sostiene que no son idénticos, pero tampoco pueden separarse de forma absoluta, porque el derecho perdería orientación si renunciara por completo a la idea de bien, deber y respeto a la persona \citep{launDerechoMoral2021}. Esa precisión es útil: no se trata de convertir toda valoración moral en norma jurídica, sino de reconocer que un sistema jurídico que tolere desapariciones, arbitrariedad o impunidad entra en contradicción con los mínimos éticos que hacen defendible su obligatoriedad. Por eso el caso Ayotzinapa importa filosóficamente: obliga a medir si el derecho mexicano opera como orden de justicia o sólo como estructura formal de competencia. El punto crítico es ese: una legalidad sin orientación material puede convertirse en cobertura del fracaso institucional.

El segundo concepto es la \textbf{dignidad humana}. Desde la teoría de los derechos, Ansuátegui explica que el \textbf{Estado de derecho} sólo se justifica cuando organiza el poder para proteger a la persona y limitar la arbitrariedad \citep{ansuategui2007}. Esta idea coincide con la jurisprudencia mexicana que reconoce la dignidad humana como norma jurídica fundamental y no como simple declaración ética \citep{scjnJur37_2016}. La consecuencia es relevante: cuando la persona es reducida a objeto de fuerza, ocultamiento o abandono institucional, no sólo se viola una regla particular; en consecuencia, se lesiona el criterio axiológico que da sentido al sistema completo. En términos prácticos, si la dignidad se quiebra, también se quiebra la pretensión del derecho de presentarse como límite legítimo del poder.

El tercer concepto es la diferencia entre \textbf{validez}, \textbf{eficacia} y \textbf{legitimidad}. En términos formales, un sistema puede contar con Constitución, leyes, jueces y procedimientos. Sin embargo, si esas estructuras no impiden el abuso o no responden con diligencia frente a él, la eficacia protectora se rompe y con ello se erosiona la legitimidad del orden jurídico \citep{kelsen1982,ansuategui2007}. Desde esta perspectiva, Ayotzinapa muestra que la sola existencia de normas no basta para afirmar que el derecho está cumpliendo su función. El punto crítico es si esas normas producen control real del poder y reparación para las víctimas.

\subsection{Aplicación jurídica}

En el sistema jurídico mexicano, el análisis del caso debe apoyarse en cuatro disposiciones constitucionales \citep{cpeum2026}:

\begin{itemize}
  \item \textbf{Artículo 1o.:} obliga a todas las autoridades a promover, respetar, proteger y garantizar los derechos humanos.
  \item \textbf{Artículos 14 y 16:} prohíben la privación arbitraria de la libertad y exigen fundamentación de todo acto de autoridad.
  \item \textbf{Artículo 17:} reconoce el acceso a la justicia como derecho exigible y no como mera aspiración.
  \item \textbf{Artículo 20:} otorga derechos específicos a las víctimas dentro del proceso penal.
\end{itemize}

Bajo esta arquitectura, la desaparición de personas no representa un hecho aislado, sino un fracaso múltiple del deber estatal de protección. Esa es la razón por la que el caso no puede reducirse a una discusión técnica de expediente.

La \textit{Ley General de Víctimas} vuelve operativas esas exigencias al establecer medidas de ayuda, asistencia, atención, verdad y reparación integral. Por su parte, la \textit{Ley General en Materia de Desaparición Forzada de Personas, Desaparición Cometida por Particulares y del Sistema Nacional de Búsqueda de Personas} precisa obligaciones de búsqueda, investigación y coordinación institucional frente a una de las violaciones más graves que puede sufrir la persona \citep{LeyGeneralVictimas,lgmdfp2026}. Ambas leyes importan filosóficamente porque convierten principios abstractos en deberes concretos; es decir, traducen la dignidad y los derechos en procedimientos exigibles. Sin embargo, la existencia del procedimiento no garantiza por sí misma su activación oportuna.

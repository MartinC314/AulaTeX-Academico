...
\def\documentsubtitle {Análisis de caso en asesoría jurídica virtual}
...
El \textbf{ecosistema TICCAD} se entiende aquí como el conjunto articulado y 
...
En consecuencia, ante estos riesgos se proponen las siguientes medidas:
...
Más allá de la tecnología en sí, el ecosistema TICCAD propuesto tiene, además, un valor pedagógico 
explícito:
...
las más sofisticadas del mercado; sin embargo, son accesibles, seguras, y respetan la dignidad 
e interculturalidad de la comunidad. Por ello, lejos de ser una lista de aplicaciones, el ecosistema 
...
y del compromiso compartido de que la tecnología sirva a la dignidad humana, no al revés.\footnote{En la elaboración de este trabajo se utilizaron herramientas de inteligencia artificial como apoyo para la organización y revisión del texto, conforme a los Lineamientos para el uso ético y responsable de la Inteligencia Artificial en el ámbito académico de la UnADM. El análisis, la selección de fuentes y la postura sostenida son de mi autoría.}

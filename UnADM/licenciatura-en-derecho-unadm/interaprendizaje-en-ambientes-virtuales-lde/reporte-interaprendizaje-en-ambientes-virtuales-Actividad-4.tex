...
La \textbf{autogestión} concierne a la organización del tiempo, la constancia y la
capacidad de sostener el propio proceso. La \textbf{comunicación dialógica} atiende a
la calidad de la interacción escrita: no basta con participar, importa si la
participación abre o cierra el intercambio. El \textbf{aprendizaje ubicuo} describe la
posibilidad de aprender en tiempos y lugares diversos gracias a las TICCAD, siempre
que las herramientas se elijan por su función y no se acumulen
\citep{zambranoPilay2020tecnologias}. La \textbf{colaboración} distingue el reparto de
tareas de la construcción conjunta; el estándar de competencia sobre trabajo en
equipo lo formula con claridad al exigir acuerdos explícitos, aportación efectiva y
revisión del resultado colectivo, y no solo cumplimiento individual
\citep{conocer2025ec0554}. Por último, la \textbf{metacognición atenta a la
diversidad} vincula la revisión del propio aprendizaje con el reconocimiento de la
diversidad cultural y lingüística presente en el grupo, dentro del marco de la
educación intercultural \citep{aguadoSleeter2021educacion}. En este trabajo adopto
como criterio de diseño propio examinar, además, si el lenguaje y los ejemplos que
utilizo facilitan la participación de personas con trayectorias distintas.
...
reúne las afirmaciones agrupadas por dimensión con la frecuencia marcada. Para esta
aplicación, cada afirmación se responde con una escala de frecuencia de cinco puntos
--siempre, casi siempre, a veces, casi nunca, nunca--. Estas opciones permiten
organizar la autopercepción por dimensiones y reconocer prácticas declaradas como
sostenidas, intermitentes o poco frecuentes.
...
Leído en conjunto, el registro de la tabla \ref{tab:brujula-interaprendizaje-a4} muestra diez respuestas de frecuencia alta
(``Siempre'' o ``Casi siempre'') y diez de frecuencia intermedia o baja
(``A veces'' o ``Casi nunca''); no se marcó ``Nunca''. El recuento se obtiene de la
frecuencia marcada en cada fila: las respuestas altas corresponden a los ítems 1,
2, 5, 6, 9, 10, 13, 14, 17 y 19, mientras que ``A veces'' o ``Casi nunca'' aparecen
en los ítems 3, 4, 7, 8, 11, 12, 15, 16, 18 y 20. Por tanto, la tabla documenta
estas oportunidades de mejora en la interacción, la revisión conjunta y el ajuste
del lenguaje, sin permitir atribuirlas únicamente a la dependencia de otras personas.

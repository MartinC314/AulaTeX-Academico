  ...
  \noindent\colorbox{unadmGreenDark}{%
    \begin{minipage}[t][10.55cm][t]{0.58\paperwidth}
      ...
      \hspace*{0.75cm}\begin{minipage}{9.7cm}
        {\color{white}\fontsize{24}{29}\selectfont\bfseries Actividad 6: Interaprendizaje en Ambientes Virtuales\par}
        \vspace{0.35cm}
  ...
  \noindent\begin{minipage}[t][10.55cm][t]{\paperwidth}
    ...
    \noindent\colorbox{unadmGreen}{%
      \begin{minipage}[c][0.56cm][c]{\paperwidth}
        \hspace*{0.65cm}{\color{white}\small Interaprendizaje en Ambientes Virtuales - UnADM - \today}
      \end{minipage}%
    }
  \end{minipage}
}
...
\ContentSlide{Objetivo editorial}{
  ...
  \begin{itemize}
    ...
    \item Bibliografia local: \texttt{interaprendizaje-en-ambientes-virtuales.bib}.
  \end{itemize}
}

...
\newcommand{\coursename}{Sistema penal acusatorio y oral}
\newcommand{\coursecode}{LDE-S5B2}
\newcommand{\activitytitle}{Plantilla base de Sistema penal acusatorio y oral}
\newcommand{\activitysubtitle}{Actividad X - Sistema penal acusatorio y oral}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{sistema-penal-acusatorio-y-oral.bib}.

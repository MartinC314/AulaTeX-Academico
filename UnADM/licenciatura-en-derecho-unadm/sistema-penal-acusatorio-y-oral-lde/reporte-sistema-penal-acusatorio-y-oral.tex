...
\def\documenttitle {Plantilla base de Sistema penal acusatorio y oral}
\def\documentsubtitle {Actividad X - Sistema penal acusatorio y oral}
\def\documentsubject {Licenciatura en Derecho}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Sistema penal acusatorio y oral}
\def\coursecode {LDE-S5B2}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Sistema penal acusatorio y oral}
...
\begin{abstractd}
  ...
  \textit{Sistema penal acusatorio y oral} dentro de la Licenciatura en Derecho de la UnADM.
...
\bibliography{sistema-penal-acusatorio-y-oral}

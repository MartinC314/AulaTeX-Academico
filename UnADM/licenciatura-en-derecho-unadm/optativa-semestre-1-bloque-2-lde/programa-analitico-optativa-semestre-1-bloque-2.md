# Programa analitico editorial - Optativa Semestre 1 Bloque 2

## Encuadre institucional

Asignatura de la Licenciatura en Derecho de la UnADM ubicada en semestre
1, bloque 2. Su funcion editorial es orientar
...
en $(@{Name=Optativa Semestre 1 Bloque 2; Block=2; Credits=6; Type=Optativa; Slug=optativa-semestre-1-bloque-2; Semester=1}.Slug).bib.
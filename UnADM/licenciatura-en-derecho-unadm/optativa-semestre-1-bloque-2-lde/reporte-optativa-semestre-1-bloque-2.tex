...
\def\documenttitle {Plantilla base de Optativa Semestre 1 Bloque 2}
\def\documentsubtitle {Actividad X - Optativa Semestre 1 Bloque 2}
\def\documentsubject {Licenciatura en Derecho}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Optativa Semestre 1 Bloque 2}
\def\coursecode {LDE-S1B2}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Optativa Semestre 1 Bloque 2}
...
\begin{abstractd}
  ...
  \textit{Optativa Semestre 1 Bloque 2} dentro de la Licenciatura en Derecho de la UnADM.
...
\bibliography{optativa-semestre-1-bloque-2}

...
\newcommand{\coursename}{Propiedad industrial}
\newcommand{\coursecode}{LDE-S5B1}
\newcommand{\activitytitle}{Plantilla base de Propiedad industrial}
\newcommand{\activitysubtitle}{Actividad X - Propiedad industrial}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{propiedad-industrial.bib}.

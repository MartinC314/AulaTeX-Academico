...
\def\documenttitle {Plantilla base de Propiedad industrial}
\def\documentsubtitle {Actividad X - Propiedad industrial}
\def\documentsubject {Licenciatura en Derecho}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Propiedad industrial}
\def\coursecode {LDE-S5B1}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Propiedad industrial}
...
\begin{abstractd}
  ...
  \textit{Propiedad industrial} dentro de la Licenciatura en Derecho de la UnADM.
...
\bibliography{propiedad-industrial}

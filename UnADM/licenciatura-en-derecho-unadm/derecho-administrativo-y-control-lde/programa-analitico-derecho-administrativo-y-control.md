# Programa analitico editorial - Derecho administrativo y control

## Encuadre institucional

Asignatura de la Licenciatura en Derecho de la UnADM ubicada en semestre
6, bloque 1. Su funcion editorial es orientar
...
en $(@{Name=Derecho administrativo y control; Block=1; Credits=8; Type=Obligatoria; Slug=derecho-administrativo-y-control; Semester=6}.Slug).bib.
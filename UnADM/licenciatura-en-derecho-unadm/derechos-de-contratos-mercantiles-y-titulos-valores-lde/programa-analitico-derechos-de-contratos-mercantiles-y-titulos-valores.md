# Programa analitico editorial - Derechos de contratos mercantiles y titulos valores

## Encuadre institucional

Asignatura de la Licenciatura en Derecho de la UnADM ubicada en semestre
6, bloque 2. Su funcion editorial es orientar
...
en $(@{Name=Derechos de contratos mercantiles y titulos valores; Block=2; Credits=8; Type=Obligatoria; Slug=derechos-de-contratos-mercantiles-y-titulos-valores; Semester=6}.Slug).bib.
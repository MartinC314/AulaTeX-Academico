# Programa analitico editorial - Derechos de la persona y familia

## Encuadre institucional

Asignatura de la Licenciatura en Derecho de la UnADM ubicada en semestre
3, bloque 1. Su funcion editorial es orientar
...
en $(@{Name=Derechos de la persona y familia; Block=1; Credits=8; Type=Obligatoria seriada; Slug=derechos-de-la-persona-y-familia; Semester=3}.Slug).bib.
...
\newcommand{\coursename}{Mecanismos alternativos de resolucion de conflictos}
\newcommand{\coursecode}{LDE-S5B1}
\newcommand{\activitytitle}{Plantilla base de Mecanismos alternativos de resolucion de conflictos}
\newcommand{\activitysubtitle}{Actividad X - Mecanismos alternativos de resolucion de conflictos}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{mecanismos-alternativos-de-resolucion-de-conflictos.bib}.

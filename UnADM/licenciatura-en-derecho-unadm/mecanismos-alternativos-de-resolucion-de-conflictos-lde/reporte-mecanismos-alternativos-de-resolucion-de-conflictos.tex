...
\def\documenttitle {Plantilla base de Mecanismos alternativos de resolucion de conflictos}
\def\documentsubtitle {Actividad X - Mecanismos alternativos de resolucion de conflictos}
\def\documentsubject {Licenciatura en Derecho}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Mecanismos alternativos de resolucion de conflictos}
\def\coursecode {LDE-S5B1}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Mecanismos alternativos de resolucion de conflictos}
...
\begin{abstractd}
  ...
  \textit{Mecanismos alternativos de resolucion de conflictos} dentro de la Licenciatura en Derecho de la UnADM.
...
\bibliography{mecanismos-alternativos-de-resolucion-de-conflictos}

# Programa analitico editorial - Derecho penal especial mexicano

## Encuadre institucional

Asignatura de la Licenciatura en Derecho de la UnADM ubicada en semestre
2, bloque 2. Su funcion editorial es orientar
...
en $(@{Name=Derecho penal especial mexicano; Block=2; Credits=8; Type=Obligatoria; Slug=derecho-penal-especial-mexicano; Semester=2}.Slug).bib.
...
\newcommand{\coursename}{Electiva Semestre 8 Bloque 2}
\newcommand{\coursecode}{LDE-S8B2}
\newcommand{\activitytitle}{Plantilla base de Electiva Semestre 8 Bloque 2}
\newcommand{\activitysubtitle}{Actividad X - Electiva Semestre 8 Bloque 2}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{electiva-semestre-8-bloque-2.bib}.

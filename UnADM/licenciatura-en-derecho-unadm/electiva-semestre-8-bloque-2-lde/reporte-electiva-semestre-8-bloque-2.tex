...
\def\documenttitle {Plantilla base de Electiva Semestre 8 Bloque 2}
\def\documentsubtitle {Actividad X - Electiva Semestre 8 Bloque 2}
\def\documentsubject {Licenciatura en Derecho}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Electiva Semestre 8 Bloque 2}
\def\coursecode {LDE-S8B2}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Electiva Semestre 8 Bloque 2}
...
\begin{abstractd}
  ...
  \textit{Electiva Semestre 8 Bloque 2} dentro de la Licenciatura en Derecho de la UnADM.
...
\bibliography{electiva-semestre-8-bloque-2}

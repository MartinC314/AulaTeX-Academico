...
\def\documenttitle {Plantilla base de Seminario de titulacion III}
\def\documentsubtitle {Actividad X - Seminario de titulacion III}
\def\documentsubject {Licenciatura en Derecho}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Seminario de titulacion III}
\def\coursecode {LDE-S8B2}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Seminario de titulacion III}
...
\begin{abstractd}
  ...
  \textit{Seminario de titulacion III} dentro de la Licenciatura en Derecho de la UnADM.
...
\bibliography{seminario-de-titulacion-iii}

...
\newcommand{\coursename}{Seminario de titulacion III}
\newcommand{\coursecode}{LDE-S8B2}
\newcommand{\activitytitle}{Plantilla base de Seminario de titulacion III}
\newcommand{\activitysubtitle}{Actividad X - Seminario de titulacion III}
...
\begin{frame}{Objetivo y alcance}
  ...
  \end{block}
  \begin{itemize}
    \item Semestre: 8. Bloque: 2.
    \item Tipo: Obligatoria seriada. Creditos: 10.
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{seminario-de-titulacion-iii.bib}.

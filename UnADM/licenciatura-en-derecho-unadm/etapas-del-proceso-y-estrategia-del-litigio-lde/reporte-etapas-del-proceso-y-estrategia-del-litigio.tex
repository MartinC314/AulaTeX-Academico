...
\def\documenttitle {Plantilla base de Etapas del proceso y estrategia del litigio}
\def\documentsubtitle {Actividad X - Etapas del proceso y estrategia del litigio}
\def\documentsubject {Licenciatura en Derecho}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Etapas del proceso y estrategia del litigio}
\def\coursecode {LDE-S5B2}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Etapas del proceso y estrategia del litigio}
...
\begin{abstractd}
  ...
  \textit{Etapas del proceso y estrategia del litigio} dentro de la Licenciatura en Derecho de la UnADM.
...
\bibliography{etapas-del-proceso-y-estrategia-del-litigio}

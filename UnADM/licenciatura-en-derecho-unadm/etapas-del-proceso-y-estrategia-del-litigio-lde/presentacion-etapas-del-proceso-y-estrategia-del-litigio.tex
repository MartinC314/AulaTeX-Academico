...
\newcommand{\coursename}{Etapas del proceso y estrategia del litigio}
\newcommand{\coursecode}{LDE-S5B2}
\newcommand{\activitytitle}{Plantilla base de Etapas del proceso y estrategia del litigio}
\newcommand{\activitysubtitle}{Actividad X - Etapas del proceso y estrategia del litigio}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{etapas-del-proceso-y-estrategia-del-litigio.bib}.

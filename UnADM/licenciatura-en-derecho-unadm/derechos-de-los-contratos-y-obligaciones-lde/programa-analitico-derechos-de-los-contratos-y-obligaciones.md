# Programa analitico editorial - Derechos de los contratos y obligaciones

## Encuadre institucional

Asignatura de la Licenciatura en Derecho de la UnADM ubicada en semestre
4, bloque 1. Su funcion editorial es orientar
...
en $(@{Name=Derechos de los contratos y obligaciones; Block=1; Credits=8; Type=Obligatoria; Slug=derechos-de-los-contratos-y-obligaciones; Semester=4}.Slug).bib.
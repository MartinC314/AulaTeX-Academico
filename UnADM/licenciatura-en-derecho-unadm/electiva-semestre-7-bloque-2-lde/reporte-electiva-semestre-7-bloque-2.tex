...
\def\documenttitle {Plantilla base de Electiva Semestre 7 Bloque 2}
\def\documentsubtitle {Actividad X - Electiva Semestre 7 Bloque 2}
\def\documentsubject {Licenciatura en Derecho}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Electiva Semestre 7 Bloque 2}
\def\coursecode {LDE-S7B2}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Electiva Semestre 7 Bloque 2}
...
\begin{abstractd}
  ...
  \textit{Electiva Semestre 7 Bloque 2} dentro de la Licenciatura en Derecho de la UnADM.
...
\bibliography{electiva-semestre-7-bloque-2}

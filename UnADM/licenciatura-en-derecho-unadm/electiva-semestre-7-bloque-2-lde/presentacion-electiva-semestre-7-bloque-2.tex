...
\newcommand{\coursename}{Electiva Semestre 7 Bloque 2}
\newcommand{\coursecode}{LDE-S7B2}
\newcommand{\activitytitle}{Plantilla base de Electiva Semestre 7 Bloque 2}
\newcommand{\activitysubtitle}{Actividad X - Electiva Semestre 7 Bloque 2}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{electiva-semestre-7-bloque-2.bib}.

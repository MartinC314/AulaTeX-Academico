...
\newcommand{\coursename}{Optativa Semestre 2 Bloque 2}
\newcommand{\coursecode}{LDE-S2B2}
\newcommand{\activitytitle}{Plantilla base de Optativa Semestre 2 Bloque 2}
\newcommand{\activitysubtitle}{Actividad X - Optativa Semestre 2 Bloque 2}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{optativa-semestre-2-bloque-2.bib}.

...
\newcommand{\coursename}{Electiva Semestre 8 Bloque 1}
\newcommand{\coursecode}{LDE-S8B1}
\newcommand{\activitytitle}{Plantilla base de Electiva Semestre 8 Bloque 1}
\newcommand{\activitysubtitle}{Actividad X - Electiva Semestre 8 Bloque 1}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{electiva-semestre-8-bloque-1.bib}.

...
\def\documenttitle {Plantilla base de Electiva Semestre 8 Bloque 1}
\def\documentsubtitle {Actividad X - Electiva Semestre 8 Bloque 1}
\def\documentsubject {Licenciatura en Derecho}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Electiva Semestre 8 Bloque 1}
\def\coursecode {LDE-S8B1}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Electiva Semestre 8 Bloque 1}
...
\begin{abstractd}
  ...
  \textit{Electiva Semestre 8 Bloque 1} dentro de la Licenciatura en Derecho de la UnADM.
...
\bibliography{electiva-semestre-8-bloque-1}

...
\def\documenttitle {Plantilla base de Tecnica legislativa}
\def\documentsubtitle {Actividad X - Tecnica legislativa}
\def\documentsubject {Licenciatura en Derecho}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Tecnica legislativa}
\def\coursecode {LDE-S7B1}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Tecnica legislativa}
...
\begin{abstractd}
  ...
  \textit{Tecnica legislativa} dentro de la Licenciatura en Derecho de la UnADM.
...
\bibliography{tecnica-legislativa}

...
\newcommand{\coursename}{Tecnica legislativa}
\newcommand{\coursecode}{LDE-S7B1}
\newcommand{\activitytitle}{Plantilla base de Tecnica legislativa}
\newcommand{\activitysubtitle}{Actividad X - Tecnica legislativa}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{tecnica-legislativa.bib}.

# Programa analitico editorial - Instrumentos y mecanismos de proteccion de los derechos humanos

## Encuadre institucional

Asignatura de la Licenciatura en Derecho de la UnADM ubicada en semestre
5, bloque 2. Su funcion editorial es orientar
...
en $(@{Name=Instrumentos y mecanismos de proteccion de los derechos humanos; Block=2; Credits=8; Type=Obligatoria; Slug=instrumentos-y-mecanismos-de-proteccion-de-los-derechos-humanos; Semester=5}.Slug).bib.
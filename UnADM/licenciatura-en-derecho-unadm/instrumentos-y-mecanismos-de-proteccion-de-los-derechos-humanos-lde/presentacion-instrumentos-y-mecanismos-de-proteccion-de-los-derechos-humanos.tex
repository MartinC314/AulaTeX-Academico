...
\newcommand{\coursename}{Instrumentos y mecanismos de proteccion de los derechos humanos}
\newcommand{\coursecode}{LDE-S5B2}
\newcommand{\activitytitle}{Plantilla base de Instrumentos y mecanismos de proteccion de los derechos humanos}
\newcommand{\activitysubtitle}{Actividad X - Instrumentos y mecanismos de proteccion de los derechos humanos}
...
\begin{frame}{Fuentes y revision}
  \begin{itemize}
    \item Bibliografia local: \texttt{instrumentos-y-mecanismos-de-proteccion-de-los-derechos-humanos.bib}.

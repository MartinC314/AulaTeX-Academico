...
\def\documenttitle {Plantilla base de Instrumentos y mecanismos de proteccion de los derechos humanos}
\def\documentsubtitle {Actividad X - Instrumentos y mecanismos de proteccion de los derechos humanos}
\def\documentsubject {Licenciatura en Derecho}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Instrumentos y mecanismos de proteccion de los derechos humanos}
\def\coursecode {LDE-S5B2}

\def\universityname {Universidad Abierta y a Distancia de Mexico}
\def\universityfaculty {Licenciatura en Derecho}
\def\universitydepartment {Instrumentos y mecanismos de proteccion de los derechos humanos}
...
\begin{abstractd}
  ...
  \textit{Instrumentos y mecanismos de proteccion de los derechos humanos} dentro de la Licenciatura en Derecho de la UnADM.
...
% - Priorizar cierre de brecha recurrente: conclusion_argumentada (388 nodos).
% - Priorizar cierre de brecha recurrente: citas_insuficientes (328 nodos).
% - Priorizar cierre de brecha recurrente: analisis_propio (301 nodos).
% --- Fin Ciclo A ---
...
\bibliography{instrumentos-y-mecanismos-de-proteccion-de-los-derechos-humanos}

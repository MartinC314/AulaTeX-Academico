...
\def\documentsubtitle {Escuelas éticas clásicas y su aporte al derecho}
...
En este contexto, el análisis comparativo de las principales corrientes éticas permite comprender no solo sus postulados individuales, sino también las tensiones y coincidencias entre ellas. La ética de la virtud, la deontología, el hedonismo, el estoicismo, el epicureísmo y el cinismo representan distintas formas de concebir la moralidad, el bienestar y la libertad \citep{huerta2000etica}. Por ello, el contraste se articula en torno a sus fundamentos morales, fines humanos, criterios de acción y actitudes frente a los bienes externos.

El presente trabajo tiene como propósito desarrollar un cuadro comparativo que facilite la organización, el análisis y la contrastación de estas corrientes; en consecuencia, busca promover una visión integral y crítica de sus aportes al pensamiento ético y a la formación jurídica.

\section{Escuelas éticas clásicas}

El cuadro comparativo examina seis corrientes clásicas: la ética de la virtud, representada por Aristóteles; la ética deontológica, por Kant; el hedonismo; el estoicismo, asociado con Séneca y Epicteto; el epicureísmo, con Epicuro; y el cinismo, con Diógenes. Para hacer explícito el contraste, cada escuela se analiza según cinco criterios:

\begin{itemize}
  \item \textbf{Fundamentos morales:} el principio del que deriva la obligación.
  \item \textbf{Fines humanos:} aquello que la doctrina identifica como vida lograda.
  \item \textbf{Criterios de acción:} la regla práctica que orienta la decisión concreta.
  \item \textbf{Actitud ante los bienes externos:} el lugar que otorga a la riqueza, el placer y el reconocimiento.
  \item \textbf{Aportes a la formación ética del jurista:} su utilidad para el ejercicio profesional del derecho.
\end{itemize}
...
La comparación evidencia que todas las escuelas buscan orientar la acción humana hacia una vida buena, pero difieren en el criterio rector: virtud, deber, placer, autodominio, moderación o autosuficiencia. Por tanto, considero que su valor para la formación ética del profesional del derecho no radica en adoptar una sola propuesta, sino en contrastar sus criterios para deliberar con mayor responsabilidad ante conflictos concretos \citep{huerta2000etica,prieto2009favor}.

\section{Conclusión}

El análisis comparativo de las escuelas éticas clásicas pone de relieve la diversidad de enfoques sobre la moralidad y el bien. Aunque cada corriente propone un criterio distinto para orientar la vida humana, todas contribuyen a examinar la relación entre conducta, responsabilidad y realización personal. En consecuencia, esta pluralidad no debe entenderse como una disyuntiva meramente histórica, sino como un recurso para valorar críticamente las decisiones profesionales. Sostengo que, desde la formación jurídica, la ética adquiere especial relevancia porque ofrece criterios para interpretar normas, asumir responsabilidades y actuar con sentido de justicia; por tanto, su estudio debe vincularse con la deliberación prudente y con la responsabilidad concreta del profesional del derecho \citep{ronquillo2018etica,huerta2000etica}.\footnote{En la elaboración de este trabajo se utilizaron herramientas de inteligencia artificial como apoyo para la organización y revisión del texto, conforme a los Lineamientos para el uso ético y responsable de la Inteligencia Artificial en el ámbito académico de la UnADM. El análisis, la selección de fuentes y la postura sostenida son de mi autoría.}

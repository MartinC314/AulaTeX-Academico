...
En el ámbito jurídico conviene separar tres formas de moral:

\begin{itemize}
  \item La \textbf{moral personal} pertenece a la conciencia individual de cada sujeto.
  \item La \textbf{moral social positiva} refleja las costumbres y los valores efectivamente compartidos por un grupo.
  \item La \textbf{moral ideal o crítica} sirve para preguntar si esas costumbres son justas o si deben cambiar.
\end{itemize}

Esta distinción evita un error común: pensar que toda costumbre social ya es correcta sólo porque muchas personas la aceptan \citep{ronquilloarmasEticaGeneralProfesional2018,singerCompendioEtica1995}.
...
\subsection{Dignidad y derechos humanos como criterios jurídicos}

En México, la relación entre moral y Derecho se concreta en la dignidad humana, la igualdad, el debido proceso, el daño moral, la reparación integral y los derechos humanos. Por tanto, estos elementos no son adornos del discurso jurídico, sino criterios para revisar si una autoridad trata a la persona como sujeto de derechos y no como simple expediente \citep{cndhMarcoNormativo2026}.
...
El mapa se lee desde el centro hacia afuera. En primer lugar, la rama azul separa la moral en tres niveles: personal, social positiva e ideal crítica. Esta distinción es necesaria porque evita confundir la conciencia individual con la costumbre social y, a su vez, permite valorar si ambas responden a un criterio de justicia.

A continuación, la rama verde presenta el Derecho como un sistema formal integrado por norma, obligación, sanción y justicia. Sin embargo, la diferencia no consiste en que el Derecho carezca de valores, sino en que los articula mediante instituciones. En consecuencia, esa estructura le proporciona fuerza vinculante, pero también exige controles que limiten su ejercicio.

Por su parte, la rama naranja resume el cruce entre moral y Derecho. Ambos regulan la conducta; no obstante, el Derecho puede exigir el cumplimiento y establecer sanciones por medio de instituciones. Por tanto, no debe perseguir toda conducta moralmente discutible, sino intervenir dentro de límites compatibles con la dignidad, la igualdad y los derechos humanos. El encuentro entre ambos ocurre cuando una norma se interpreta desde esos principios y no sólo desde su formulación literal \citep{garciaMaynezEtica,cndhMarcoNormativo2026}.

Finalmente, la rama roja integra autores que sostienen el análisis. García Máynez permite distinguir legalidad y moralidad; Sánchez Vázquez ubica la moral como fenómeno social; Villoro conecta valor, poder y legitimidad; y Juliana González refuerza la importancia de la dignidad, la libertad y la responsabilidad \citep{garciaMaynezEtica,sanchezVazquezEtica1969,villoroPoderValor1997,gonzalezEthosDestino1996}.

Desde mi perspectiva, el mapa muestra que el Derecho necesita forma legal, pero también criterio. Por una parte, la forma reduce la arbitrariedad; por otra, el criterio impide que la norma se aplique como si las personas fueran sólo casos, expedientes o números. En consecuencia, razonar jurídicamente significa aplicar una regla atendiendo también a sus efectos sobre la dignidad y la justicia.
...
En ese sentido, el trabajo jurídico no consiste sólo en conocer normas, sino en usarlas con responsabilidad. La legalidad da estructura; la moral crítica ayuda a revisar si esa estructura protege realmente a las personas.\footnote{En la elaboración de este trabajo se utilizaron herramientas de inteligencia artificial como apoyo para la organización y revisión del texto, conforme a los Lineamientos para el uso ético y responsable de la Inteligencia Artificial en el ámbito académico de la UnADM. El análisis, la selección de fuentes y la postura sostenida son de mi autoría.}

...
\begin{titlepage}
  ...
  \begin{center}
    ...
    {\Huge\bfseries Actividad 4 - Garantias Constitucionales\par}
    \vspace{0.35cm}
    {\Large Actividad 4 - Garantias Constitucionales\par}
    \vspace{0.45cm}
    ...
    \begin{tabular}{rl}
      ...
      \textbf{Materia:} & Garantias Constitucionales \\
      \textbf{Semestre/Bloque:} & 2 / 1 \citep{unadmMallaDerecho2024} \\
      \textbf{Tipo/Creditos:} & Obligatoria / 8 \citep{unadmMallaDerecho2024} \\
      \textbf{Fecha:} & \today
    \end{tabular}
    \vfill
...
Esta plantilla materializa la memoria editorial de \textit{Garantias Constitucionales}.

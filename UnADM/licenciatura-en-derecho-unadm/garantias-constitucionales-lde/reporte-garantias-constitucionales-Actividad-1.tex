...
\section{Nociones básicas del derecho constitucional}

Las cinco nociones que estructuran esta intervención no son términos aislados: la Constitución da validez al sistema normativo, del que surgen facultades concretas; el contenido de fondo de los derechos se distingue de las vías para reclamarlos; y la garantía es lo que transforma un derecho reconocido en algo exigible. La intervención publicada que sigue desarrolla cada una de esas nociones —de la supremacía constitucional a la eficacia de las garantías— y las contrasta con la Constitución y la Ley de Amparo \citep{cpeum2026,leyAmparo2026}.
...
El punto que considero más relevante es el último eslabón: un derecho reconocido sin una garantía eficaz corre el riesgo de quedar en una declaración formal. Por eso el análisis de las garantías constitucionales debe centrarse menos en enunciar derechos y más en examinar los mecanismos —como el juicio de amparo— que los hacen efectivos; esa es la brújula que orienta el estudio posterior de la asignatura.\footnote{Para redactar y organizar este documento se utilizó una herramienta de inteligencia artificial con el propósito de ordenar ideas y revisar la redacción; su uso no sustituyó el análisis propio ni la interpretación jurídica, que corresponden al autor.}

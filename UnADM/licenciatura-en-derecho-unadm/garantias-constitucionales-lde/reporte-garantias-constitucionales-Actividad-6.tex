...
\def\documentsubtitle {Evolución jurisprudencial del artículo 133 a la Contradicción de Tesis 293/2011}
...
Esta tesis no se limita a declarar la vinculatoriedad: establece un método de tres pasos para el operador jurídico. Verificar que existan las mismas razones que motivaron el precedente cuando México no fue parte; armonizar la jurisprudencia interamericana con la nacional siempre que sea posible; y, de resultar imposible la armonización, aplicar el criterio más favorable a la persona \citep{scjnTesis2006225}. \textbf{Por consiguiente}, el principio pro persona deja de operar como enunciado programático y adquiere una función operativa concreta dentro del razonamiento judicial.

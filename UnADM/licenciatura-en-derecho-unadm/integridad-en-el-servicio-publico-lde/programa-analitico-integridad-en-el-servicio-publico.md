# Programa analitico editorial - Integridad en el servicio publico

## Encuadre institucional

Asignatura de la Licenciatura en Derecho de la UnADM ubicada en semestre
1, bloque 1. Su funcion editorial es orientar
...
en $(@{Name=Integridad en el servicio publico; Block=1; Credits=8; Type=Obligatoria; Slug=integridad-en-el-servicio-publico; Semester=1}.Slug).bib.
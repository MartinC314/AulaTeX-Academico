...
\providecommand{\itescacoursename}{Desarrollo de Videojuegos}
\providecommand{\itescacoursecode}{ISC-DESARROLLO-DE-VIDEOJUEGOS}
\providecommand{\itescadepartment}{Desarrollo de Videojuegos}
...
\providecommand{\itescatransfercontext}{Desarrollo de Videojuegos, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/desarrollo-de-videojuegos-isc/desarrollo-de-videojuegos}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{desarrollo-de-videojuegos.bib}
...
\def\itescadocumenttitle {Desarrollo de Videojuegos}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Desarrollo de Videojuegos}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Desarrollo de Videojuegos}

...
\providecommand{\itescacoursename}{Tecnologias de Programacion}
\providecommand{\itescacoursecode}{ISC-TECNOLOGIAS-DE-PROGRAMACION}
\providecommand{\itescadepartment}{Tecnologias de Programacion}
...
\providecommand{\itescatransfercontext}{Tecnologias de Programacion, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/tecnologias-de-programacion-isc/tecnologias-de-programacion}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{tecnologias-de-programacion.bib}
...
\def\itescadocumenttitle {Tecnologias de Programacion}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Tecnologias de Programacion}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Tecnologias de Programacion}

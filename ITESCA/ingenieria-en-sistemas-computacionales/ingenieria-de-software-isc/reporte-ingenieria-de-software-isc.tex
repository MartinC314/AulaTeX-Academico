...
\providecommand{\itescacoursename}{Ingenieria de Software}
\providecommand{\itescacoursecode}{ISC-INGENIERIA-DE-SOFTWARE}
\providecommand{\itescadepartment}{Ingenieria de Software}
...
\providecommand{\itescatransfercontext}{Ingenieria de Software, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/ingenieria-de-software-isc/ingenieria-de-software}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{ingenieria-de-software.bib}
...
\def\itescadocumenttitle {Ingenieria de Software}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Ingenieria de Software}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Ingenieria de Software}

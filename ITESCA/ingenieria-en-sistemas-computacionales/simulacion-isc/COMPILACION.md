# Compilacion - Simulacion

Ejecutar desde la raiz del repositorio que contiene la carpeta ITESCA:

```powershell
.\\scripts\\latexmk-build.ps1 .\\ITESCA\\ingenieria-en-sistemas-computacionales\\simulacion-isc\\reporte-simulacion-isc.tex
.\\scripts\\latexmk-build.ps1 .\\ITESCA\\ingenieria-en-sistemas-computacionales\\simulacion-isc\\presentacion-simulacion-isc.tex
```
...
- La bibliografia local de la materia vive en simulacion.bib.

...
\providecommand{\itescacoursename}{Simulacion}
\providecommand{\itescacoursecode}{ISC-SIMULACION}
\providecommand{\itescadepartment}{Simulacion}
...
\providecommand{\itescatransfercontext}{Simulacion, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/simulacion-isc/simulacion}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{simulacion.bib}

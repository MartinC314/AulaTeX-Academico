...
\providecommand{\itescacoursename}{Fundamentos de Diseno Digital}
\providecommand{\itescacoursecode}{ISC-FUNDAMENTOS-DE-DISENO-DIGITAL}
\providecommand{\itescadepartment}{Fundamentos de Diseno Digital}
...
\providecommand{\itescatransfercontext}{Fundamentos de Diseno Digital, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/fundamentos-de-diseno-digital-isc/fundamentos-de-diseno-digital}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{fundamentos-de-diseno-digital.bib}
...
\def\itescadocumenttitle {Fundamentos de Diseno Digital}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Fundamentos de Diseno Digital}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Fundamentos de Diseno Digital}

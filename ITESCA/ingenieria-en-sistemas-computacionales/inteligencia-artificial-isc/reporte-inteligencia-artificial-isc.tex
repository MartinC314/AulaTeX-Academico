...
\providecommand{\itescacoursename}{Inteligencia Artificial}
\providecommand{\itescacoursecode}{ISC-INTELIGENCIA-ARTIFICIAL}
\providecommand{\itescadepartment}{Inteligencia Artificial}
...
\providecommand{\itescatransfercontext}{Inteligencia Artificial, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/inteligencia-artificial-isc/inteligencia-artificial}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{inteligencia-artificial.bib}
...
\def\itescadocumenttitle {Inteligencia Artificial}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Inteligencia Artificial}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Inteligencia Artificial}

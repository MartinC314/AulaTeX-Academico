...
\providecommand{\itescacoursename}{Fundamentos de Base de Datos}
\providecommand{\itescacoursecode}{ISC-FUNDAMENTOS-DE-BASE-DE-DATOS}
\providecommand{\itescadepartment}{Fundamentos de Base de Datos}
...
\providecommand{\itescatransfercontext}{Fundamentos de Base de Datos, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/fundamentos-de-base-de-datos-isc/fundamentos-de-base-de-datos}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{fundamentos-de-base-de-datos.bib}
...
\def\itescadocumenttitle {Fundamentos de Base de Datos}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Fundamentos de Base de Datos}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Fundamentos de Base de Datos}

...
\providecommand{\itescacoursename}{Modelado y Animacion en 3D}
\providecommand{\itescacoursecode}{ISC-MODELADO-Y-ANIMACION-EN-3D}
\providecommand{\itescadepartment}{Modelado y Animacion en 3D}
...
\providecommand{\itescatransfercontext}{Modelado y Animacion en 3D, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/modelado-y-animacion-en-3d-isc/modelado-y-animacion-en-3d}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{modelado-y-animacion-en-3d.bib}
...
\def\itescadocumenttitle {Modelado y Animacion en 3D}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Modelado y Animacion en 3D}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Modelado y Animacion en 3D}

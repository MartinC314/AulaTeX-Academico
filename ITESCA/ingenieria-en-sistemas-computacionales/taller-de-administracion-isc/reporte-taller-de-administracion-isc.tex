...
\providecommand{\itescacoursename}{Taller de Administracion}
\providecommand{\itescacoursecode}{ISC-TALLER-DE-ADMINISTRACION}
\providecommand{\itescadepartment}{Taller de Administracion}
...
\providecommand{\itescatransfercontext}{Taller de Administracion, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/taller-de-administracion-isc/taller-de-administracion}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{taller-de-administracion.bib}
...
\def\itescadocumenttitle {Taller de Administracion}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Taller de Administracion}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Taller de Administracion}

...
\providecommand{\itescacoursename}{Pruebas de Software}
\providecommand{\itescacoursecode}{ISC-PRUEBAS-DE-SOFTWARE}
\providecommand{\itescadepartment}{Pruebas de Software}
...
\providecommand{\itescatransfercontext}{Pruebas de Software, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/pruebas-de-software-isc/pruebas-de-software}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{pruebas-de-software.bib}
...
\def\itescadocumenttitle {Pruebas de Software}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Pruebas de Software}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Pruebas de Software}

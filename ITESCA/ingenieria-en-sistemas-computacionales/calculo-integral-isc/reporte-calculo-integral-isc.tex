...
\providecommand{\itescacoursename}{Calculo Integral}
\providecommand{\itescacoursecode}{ISC-CALCULO-INTEGRAL}
\providecommand{\itescadepartment}{Calculo Integral}
...
\providecommand{\itescatransfercontext}{Calculo Integral, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/calculo-integral-isc/calculo-integral}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{calculo-integral.bib}
...
\def\itescadocumenttitle {Calculo Integral}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Calculo Integral}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Calculo Integral}

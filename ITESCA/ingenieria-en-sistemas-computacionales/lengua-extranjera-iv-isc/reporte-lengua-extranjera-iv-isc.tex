...
\providecommand{\itescacoursename}{Lengua Extranjera IV}
\providecommand{\itescacoursecode}{ISC-LENGUA-EXTRANJERA-IV}
\providecommand{\itescadepartment}{Lengua Extranjera IV}
...
\providecommand{\itescatransfercontext}{Lengua Extranjera IV, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/lengua-extranjera-iv-isc/lengua-extranjera-iv}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{lengua-extranjera-iv.bib}
...
\def\itescadocumenttitle {Lengua Extranjera IV}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Lengua Extranjera IV}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Lengua Extranjera IV}

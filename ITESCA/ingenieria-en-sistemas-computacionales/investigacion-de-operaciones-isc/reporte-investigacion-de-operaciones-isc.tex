...
\providecommand{\itescacoursename}{Investigacion de Operaciones}
\providecommand{\itescacoursecode}{ISC-INVESTIGACION-DE-OPERACIONES}
\providecommand{\itescadepartment}{Investigacion de Operaciones}
...
\providecommand{\itescatransfercontext}{Investigacion de Operaciones, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/investigacion-de-operaciones-isc/investigacion-de-operaciones}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{investigacion-de-operaciones.bib}
...
\def\itescadocumenttitle {Investigacion de Operaciones}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Investigacion de Operaciones}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Investigacion de Operaciones}

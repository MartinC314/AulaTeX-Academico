...
\providecommand{\itescacoursename}{Taller de Base de Datos}
\providecommand{\itescacoursecode}{ISC-TALLER-DE-BASE-DE-DATOS}
\providecommand{\itescadepartment}{Taller de Base de Datos}
...
\providecommand{\itescatransfercontext}{Taller de Base de Datos, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/taller-de-base-de-datos-isc/taller-de-base-de-datos}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{taller-de-base-de-datos.bib}
...
\def\itescadocumenttitle {Taller de Base de Datos}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Taller de Base de Datos}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Taller de Base de Datos}

...
\providecommand{\itescacoursename}{Desarrollo Sustentable}
\providecommand{\itescacoursecode}{ISC-DESARROLLO-SUSTENTABLE}
\providecommand{\itescadepartment}{Desarrollo Sustentable}
...
\providecommand{\itescatransfercontext}{Desarrollo Sustentable, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/desarrollo-sustentable-isc/desarrollo-sustentable}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{desarrollo-sustentable.bib}
...
\def\itescadocumenttitle {Desarrollo Sustentable}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Desarrollo Sustentable}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Desarrollo Sustentable}

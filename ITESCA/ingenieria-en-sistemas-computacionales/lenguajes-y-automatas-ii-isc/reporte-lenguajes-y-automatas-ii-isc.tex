...
\providecommand{\itescacoursename}{Lenguajes y Automatas II}
\providecommand{\itescacoursecode}{ISC-LENGUAJES-Y-AUTOMATAS-II}
\providecommand{\itescadepartment}{Lenguajes y Automatas II}
...
\providecommand{\itescatransfercontext}{Lenguajes y Automatas II, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/lenguajes-y-automatas-ii-isc/lenguajes-y-automatas-ii}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{lenguajes-y-automatas-ii.bib}
...
\def\itescadocumenttitle {Lenguajes y Automatas II}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Lenguajes y Automatas II}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Lenguajes y Automatas II}

...
\providecommand{\itescacoursename}{Taller de Investigacion II}
\providecommand{\itescacoursecode}{ISC-TALLER-DE-INVESTIGACION-II}
\providecommand{\itescadepartment}{Taller de Investigacion II}
...
\providecommand{\itescatransfercontext}{Taller de Investigacion II, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/taller-de-investigacion-ii-isc/taller-de-investigacion-ii}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{taller-de-investigacion-ii.bib}
...
\def\itescadocumenttitle {Taller de Investigacion II}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Taller de Investigacion II}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Taller de Investigacion II}

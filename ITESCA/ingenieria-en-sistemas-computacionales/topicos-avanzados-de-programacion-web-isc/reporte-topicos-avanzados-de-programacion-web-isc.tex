...
\providecommand{\itescacoursename}{Topicos Avanzados de Programacion Web}
\providecommand{\itescacoursecode}{ISC-TOPICOS-AVANZADOS-DE-PROGRAMACION-WEB}
\providecommand{\itescadepartment}{Topicos Avanzados de Programacion Web}
...
\providecommand{\itescatransfercontext}{Topicos Avanzados de Programacion Web, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/topicos-avanzados-de-programacion-web-isc/topicos-avanzados-de-programacion-web}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{topicos-avanzados-de-programacion-web.bib}
...
\def\itescadocumenttitle {Topicos Avanzados de Programacion Web}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Topicos Avanzados de Programacion Web}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Topicos Avanzados de Programacion Web}
\def\itescablockname {especialidad software ISC}

...
\providecommand{\itescacoursename}{Programacion Logica y Funcional}
\providecommand{\itescacoursecode}{ISC-PROGRAMACION-LOGICA-Y-FUNCIONAL}
\providecommand{\itescadepartment}{Programacion Logica y Funcional}
...
\providecommand{\itescatransfercontext}{Programacion Logica y Funcional, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/programacion-logica-y-funcional-isc/programacion-logica-y-funcional}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{programacion-logica-y-funcional.bib}
...
\def\itescadocumenttitle {Programacion Logica y Funcional}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Programacion Logica y Funcional}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Programacion Logica y Funcional}

...
\providecommand{\itescacoursename}{Quimica}
\providecommand{\itescacoursecode}{ISC-QUIMICA}
\providecommand{\itescadepartment}{Quimica}
...
\providecommand{\itescatransfercontext}{Quimica, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/quimica-isc/quimica}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{quimica.bib}

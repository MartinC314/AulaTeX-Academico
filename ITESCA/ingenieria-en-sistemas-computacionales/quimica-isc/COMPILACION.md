...
```powershell
.\\scripts\\latexmk-build.ps1 .\\ITESCA\\ingenieria-en-sistemas-computacionales\\quimica-isc\\reporte-quimica-isc.tex
.\\scripts\\latexmk-build.ps1 .\\ITESCA\\ingenieria-en-sistemas-computacionales\\quimica-isc\\presentacion-quimica-isc.tex
```
...
- La bibliografia local de la materia vive en quimica.bib.

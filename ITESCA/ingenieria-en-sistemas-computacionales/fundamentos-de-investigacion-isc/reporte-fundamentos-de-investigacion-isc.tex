...
\providecommand{\itescacoursename}{Fundamentos de Investigacion}
\providecommand{\itescacoursecode}{ISC-FUNDAMENTOS-DE-INVESTIGACION}
\providecommand{\itescadepartment}{Fundamentos de Investigacion}
...
\providecommand{\itescatransfercontext}{Fundamentos de Investigacion, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/fundamentos-de-investigacion-isc/fundamentos-de-investigacion}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{fundamentos-de-investigacion.bib}
...
\def\itescadocumenttitle {Fundamentos de Investigacion}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Fundamentos de Investigacion}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Fundamentos de Investigacion}

...
\providecommand{\itescacoursename}{Probabilidad y Estadistica}
\providecommand{\itescacoursecode}{ISC-PROBABILIDAD-Y-ESTADISTICA}
\providecommand{\itescadepartment}{Probabilidad y Estadistica}
...
\providecommand{\itescatransfercontext}{Probabilidad y Estadistica, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/probabilidad-y-estadistica-isc/probabilidad-y-estadistica}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{probabilidad-y-estadistica.bib}
...
\def\itescadocumenttitle {Probabilidad y Estadistica}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Probabilidad y Estadistica}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Probabilidad y Estadistica}

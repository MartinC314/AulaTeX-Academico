...
\providecommand{\itescacoursename}{Programacion Web}
\providecommand{\itescacoursecode}{ISC-PROGRAMACION-WEB}
\providecommand{\itescadepartment}{Programacion Web}
...
\providecommand{\itescatransfercontext}{Programacion Web, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/programacion-web-isc/programacion-web}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{programacion-web.bib}
...
\def\itescadocumenttitle {Programacion Web}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Programacion Web}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Programacion Web}

...
\providecommand{\itescacoursename}{Servicio Social}
\providecommand{\itescacoursecode}{ISC-SERVICIO-SOCIAL}
\providecommand{\itescadepartment}{Servicio Social}
...
\providecommand{\itescatransfercontext}{Servicio Social, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/servicio-social-isc/servicio-social}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{servicio-social.bib}
...
\def\itescadocumenttitle {Servicio Social}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Servicio Social}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Servicio Social}

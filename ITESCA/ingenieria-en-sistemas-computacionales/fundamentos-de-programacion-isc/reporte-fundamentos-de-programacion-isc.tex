...
\providecommand{\itescacoursename}{Fundamentos de Programacion}
\providecommand{\itescacoursecode}{ISC-FUNDAMENTOS-DE-PROGRAMACION}
\providecommand{\itescadepartment}{Fundamentos de Programacion}
...
\providecommand{\itescatransfercontext}{Fundamentos de Programacion, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/fundamentos-de-programacion-isc/fundamentos-de-programacion}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{fundamentos-de-programacion.bib}
...
\def\itescadocumenttitle {Fundamentos de Programacion}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Fundamentos de Programacion}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Fundamentos de Programacion}

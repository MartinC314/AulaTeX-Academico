...
\providecommand{\itescacoursename}{Calculo Vectorial}
\providecommand{\itescacoursecode}{ISC-CALCULO-VECTORIAL}
\providecommand{\itescadepartment}{Calculo Vectorial}
...
\providecommand{\itescatransfercontext}{Calculo Vectorial, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/calculo-vectorial-isc/calculo-vectorial}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{calculo-vectorial.bib}
...
\def\itescadocumenttitle {Calculo Vectorial}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Calculo Vectorial}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Calculo Vectorial}

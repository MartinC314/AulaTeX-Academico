...
\providecommand{\itescacoursename}{Algebra Lineal}
\providecommand{\itescacoursecode}{ISC-ALGEBRA-LINEAL}
\providecommand{\itescadepartment}{Algebra Lineal}
...
\providecommand{\itescatransfercontext}{Algebra Lineal, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/algebra-lineal-isc/algebra-lineal}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{algebra-lineal.bib}
...
\def\itescadocumenttitle {Algebra Lineal}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Algebra Lineal}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Algebra Lineal}

...
\providecommand{\itescacoursename}{Conmutacion y Enrutamiento en Redes de Datos}
\providecommand{\itescacoursecode}{ISC-CONMUTACION-Y-ENRUTAMIENTO-EN-REDES-DE-DATOS}
\providecommand{\itescadepartment}{Conmutacion y Enrutamiento en Redes de Datos}
...
\providecommand{\itescatransfercontext}{Conmutacion y Enrutamiento en Redes de Datos, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/conmutacion-y-enrutamiento-en-redes-de-datos-isc/conmutacion-y-enrutamiento-en-redes-de-datos}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{conmutacion-y-enrutamiento-en-redes-de-datos.bib}
...
\def\itescadocumenttitle {Conmutacion y Enrutamiento en Redes de Datos}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Conmutacion y Enrutamiento en Redes de Datos}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Conmutacion y Enrutamiento en Redes de Datos}

...
\providecommand{\itescacoursename}{Gestion de Proyectos de Software}
\providecommand{\itescacoursecode}{ISC-GESTION-DE-PROYECTOS-DE-SOFTWARE}
\providecommand{\itescadepartment}{Gestion de Proyectos de Software}
...
\providecommand{\itescatransfercontext}{Gestion de Proyectos de Software, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/gestion-de-proyectos-de-software-isc/gestion-de-proyectos-de-software}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{gestion-de-proyectos-de-software.bib}
...
\def\itescadocumenttitle {Gestion de Proyectos de Software}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Gestion de Proyectos de Software}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Gestion de Proyectos de Software}

...
\providecommand{\itescacoursename}{Diseno de Interfaz}
\providecommand{\itescacoursecode}{ISC-DISENO-DE-INTERFAZ}
\providecommand{\itescadepartment}{Diseno de Interfaz}
...
\providecommand{\itescatransfercontext}{Diseno de Interfaz, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/diseno-de-interfaz-isc/diseno-de-interfaz}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{diseno-de-interfaz.bib}
...
\def\itescadocumenttitle {Diseno de Interfaz}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Diseno de Interfaz}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Diseno de Interfaz}

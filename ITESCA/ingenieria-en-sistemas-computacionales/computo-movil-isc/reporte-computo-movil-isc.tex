...
\providecommand{\itescacoursename}{Computo Movil}
\providecommand{\itescacoursecode}{ISC-COMPUTO-MOVIL}
\providecommand{\itescadepartment}{Computo Movil}
...
\providecommand{\itescatransfercontext}{Computo Movil, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/computo-movil-isc/computo-movil}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{computo-movil.bib}

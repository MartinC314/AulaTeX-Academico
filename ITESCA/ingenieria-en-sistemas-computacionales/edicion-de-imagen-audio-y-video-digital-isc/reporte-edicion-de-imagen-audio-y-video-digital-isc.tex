...
\providecommand{\itescacoursename}{Edicion de Imagen, Audio y Video Digital}
\providecommand{\itescacoursecode}{ISC-EDICION-DE-IMAGEN-AUDIO-Y-VIDEO-DIGITAL}
\providecommand{\itescadepartment}{Edicion de Imagen, Audio y Video Digital}
...
\providecommand{\itescatransfercontext}{Edicion de Imagen, Audio y Video Digital, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/edicion-de-imagen-audio-y-video-digital-isc/edicion-de-imagen-audio-y-video-digital}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{edicion-de-imagen-audio-y-video-digital.bib}
...
\def\itescadocumenttitle {Edicion de Imagen, Audio y Video Digital}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Edicion de Imagen, Audio y Video Digital}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Edicion de Imagen, Audio y Video Digital}
\def\itescablockname {especialidad produccion multimedia ISC}

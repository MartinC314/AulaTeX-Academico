...
\providecommand{\itescacoursename}{Administracion de Base de Datos}
\providecommand{\itescacoursecode}{ISC-ADMINISTRACION-DE-BASE-DE-DATOS}
\providecommand{\itescadepartment}{Administracion de Base de Datos}
...
\providecommand{\itescatransfercontext}{Administracion de Base de Datos, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/administracion-de-base-de-datos-isc/administracion-de-base-de-datos}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{administracion-de-base-de-datos.bib}
...
\def\itescadocumenttitle {Administracion de Base de Datos}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Administracion de Base de Datos}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Administracion de Base de Datos}

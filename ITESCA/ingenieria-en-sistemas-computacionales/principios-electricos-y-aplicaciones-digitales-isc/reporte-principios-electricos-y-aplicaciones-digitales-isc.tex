...
\providecommand{\itescacoursename}{Principios Electricos y Aplicaciones Digitales}
\providecommand{\itescacoursecode}{ISC-PRINCIPIOS-ELECTRICOS-Y-APLICACIONES-DIGITALES}
\providecommand{\itescadepartment}{Principios Electricos y Aplicaciones Digitales}
...
\providecommand{\itescatransfercontext}{Principios Electricos y Aplicaciones Digitales, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/principios-electricos-y-aplicaciones-digitales-isc/principios-electricos-y-aplicaciones-digitales}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{principios-electricos-y-aplicaciones-digitales.bib}

\providecommand{\itescamethodologycore}{Consigna -> problema -> analisis -> evidencia -> postura -> transferencia}
\providecommand{\itescawritingmodel}{Redaccion estrategica, critica y argumentativa inspirada en Redaccion en Contextos Virtuales, Filosofia del Derecho y Etica y Moral Juridica}
\providecommand{\itescadidactictechniques}{Cuadro comparativo, mapa conceptual, estudio de caso, matriz de decision, ensayo critico, linea de tiempo, portafolio reflexivo y proyecto integrador}

\def\itescadocumenttitle {Principios Electricos y Aplicaciones Digitales}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Principios Electricos y Aplicaciones Digitales}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Principios Electricos y Aplicaciones Digitales}

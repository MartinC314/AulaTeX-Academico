...
\providecommand{\itescacoursename}{Fundamentos de Telecomunicaciones}
\providecommand{\itescacoursecode}{ISC-FUNDAMENTOS-DE-TELECOMUNICACIONES}
\providecommand{\itescadepartment}{Fundamentos de Telecomunicaciones}
...
\providecommand{\itescatransfercontext}{Fundamentos de Telecomunicaciones, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/fundamentos-de-telecomunicaciones-isc/fundamentos-de-telecomunicaciones}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{fundamentos-de-telecomunicaciones.bib}
...
\def\itescadocumenttitle {Fundamentos de Telecomunicaciones}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Fundamentos de Telecomunicaciones}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Fundamentos de Telecomunicaciones}

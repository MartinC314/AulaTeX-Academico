...
\providecommand{\itescacoursename}{Sistemas Operativos}
\providecommand{\itescacoursecode}{ISC-SISTEMAS-OPERATIVOS}
\providecommand{\itescadepartment}{Sistemas Operativos}
...
\providecommand{\itescatransfercontext}{Sistemas Operativos, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/sistemas-operativos-isc/sistemas-operativos}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{sistemas-operativos.bib}
...
\def\itescadocumenttitle {Sistemas Operativos}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Sistemas Operativos}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Sistemas Operativos}

...
\providecommand{\itescacoursename}{Administracion de Redes}
\providecommand{\itescacoursecode}{ISC-ADMINISTRACION-DE-REDES}
\providecommand{\itescadepartment}{Administracion de Redes}
...
\providecommand{\itescatransfercontext}{Administracion de Redes, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/administracion-de-redes-isc/administracion-de-redes}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{administracion-de-redes.bib}
...
\def\itescadocumenttitle {Administracion de Redes}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Administracion de Redes}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Administracion de Redes}

...
\providecommand{\itescacoursename}{Taller de Etica}
\providecommand{\itescacoursecode}{ISC-TALLER-DE-ETICA}
\providecommand{\itescadepartment}{Taller de Etica}
...
\providecommand{\itescatransfercontext}{Taller de Etica, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/taller-de-etica-isc/taller-de-etica}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{taller-de-etica.bib}
...
\def\itescadocumenttitle {Taller de Etica}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Taller de Etica}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Taller de Etica}

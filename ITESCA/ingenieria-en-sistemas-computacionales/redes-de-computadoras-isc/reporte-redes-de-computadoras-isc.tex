...
\providecommand{\itescacoursename}{Redes de Computadoras}
\providecommand{\itescacoursecode}{ISC-REDES-DE-COMPUTADORAS}
\providecommand{\itescadepartment}{Redes de Computadoras}
...
\providecommand{\itescatransfercontext}{Redes de Computadoras, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/redes-de-computadoras-isc/redes-de-computadoras}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{redes-de-computadoras.bib}
...
\def\itescadocumenttitle {Redes de Computadoras}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Redes de Computadoras}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Redes de Computadoras}

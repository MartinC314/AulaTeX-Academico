...
\providecommand{\itescacoursename}{Calculo Diferencial}
\providecommand{\itescacoursecode}{ISC-CALCULO-DIFERENCIAL}
\providecommand{\itescadepartment}{Calculo Diferencial}
...
\providecommand{\itescatransfercontext}{Calculo Diferencial, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/calculo-diferencial-isc/calculo-diferencial}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{calculo-diferencial.bib}
...
\def\itescadocumenttitle {Calculo Diferencial}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Calculo Diferencial}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Calculo Diferencial}

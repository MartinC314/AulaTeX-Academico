...
\providecommand{\itescacoursename}{Metodos Numericos}
\providecommand{\itescacoursecode}{ISC-METODOS-NUMERICOS}
\providecommand{\itescadepartment}{Metodos Numericos}
...
\providecommand{\itescatransfercontext}{Metodos Numericos, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/metodos-numericos-isc/metodos-numericos}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{metodos-numericos.bib}
...
\def\itescadocumenttitle {Metodos Numericos}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Metodos Numericos}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Metodos Numericos}

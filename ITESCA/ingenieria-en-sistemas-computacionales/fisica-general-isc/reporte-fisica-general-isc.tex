...
\providecommand{\itescacoursename}{Fisica General}
\providecommand{\itescacoursecode}{ISC-FISICA-GENERAL}
\providecommand{\itescadepartment}{Fisica General}
...
\providecommand{\itescatransfercontext}{Fisica General, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/fisica-general-isc/fisica-general}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{fisica-general.bib}
...
\def\itescadocumenttitle {Fisica General}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Fisica General}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Fisica General}

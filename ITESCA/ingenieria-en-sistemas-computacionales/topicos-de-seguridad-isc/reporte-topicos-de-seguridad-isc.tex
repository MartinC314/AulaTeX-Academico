...
\providecommand{\itescacoursename}{Topicos de Seguridad}
\providecommand{\itescacoursecode}{ISC-TOPICOS-DE-SEGURIDAD}
\providecommand{\itescadepartment}{Topicos de Seguridad}
...
\providecommand{\itescatransfercontext}{Topicos de Seguridad, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/topicos-de-seguridad-isc/topicos-de-seguridad}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{topicos-de-seguridad.bib}
...
\def\itescadocumenttitle {Topicos de Seguridad}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Topicos de Seguridad}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Topicos de Seguridad}

...
\providecommand{\itescacoursename}{Contabilidad Financiera}
\providecommand{\itescacoursecode}{ISC-CONTABILIDAD-FINANCIERA}
\providecommand{\itescadepartment}{Contabilidad Financiera}
...
\providecommand{\itescatransfercontext}{Contabilidad Financiera, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/contabilidad-financiera-isc/contabilidad-financiera}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{contabilidad-financiera.bib}
...
\def\itescadocumenttitle {Contabilidad Financiera}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Contabilidad Financiera}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Contabilidad Financiera}

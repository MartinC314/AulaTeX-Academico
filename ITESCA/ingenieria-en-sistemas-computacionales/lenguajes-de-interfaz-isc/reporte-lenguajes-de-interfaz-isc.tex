...
\providecommand{\itescacoursename}{Lenguajes de Interfaz}
\providecommand{\itescacoursecode}{ISC-LENGUAJES-DE-INTERFAZ}
\providecommand{\itescadepartment}{Lenguajes de Interfaz}
...
\providecommand{\itescatransfercontext}{Lenguajes de Interfaz, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/lenguajes-de-interfaz-isc/lenguajes-de-interfaz}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{lenguajes-de-interfaz.bib}
...
\def\itescadocumenttitle {Lenguajes de Interfaz}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Lenguajes de Interfaz}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Lenguajes de Interfaz}

...
\providecommand{\itescacoursename}{Matematicas Discretas}
\providecommand{\itescacoursecode}{ISC-MATEMATICAS-DISCRETAS}
\providecommand{\itescadepartment}{Matematicas Discretas}
...
\providecommand{\itescatransfercontext}{Matematicas Discretas, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/matematicas-discretas-isc/matematicas-discretas}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{matematicas-discretas.bib}
...
\def\itescadocumenttitle {Matematicas Discretas}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Matematicas Discretas}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Matematicas Discretas}

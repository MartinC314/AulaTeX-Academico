...
\providecommand{\itescacoursename}{Residencia Profesional}
\providecommand{\itescacoursecode}{ISC-RESIDENCIA-PROFESIONAL}
\providecommand{\itescadepartment}{Residencia Profesional}
...
\providecommand{\itescatransfercontext}{Residencia Profesional, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/residencia-profesional-isc/residencia-profesional}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{residencia-profesional.bib}
...
\def\itescadocumenttitle {Residencia Profesional}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Residencia Profesional}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Residencia Profesional}

...
\providecommand{\itescacoursename}{Topicos Avanzados de Programacion}
\providecommand{\itescacoursecode}{ISC-TOPICOS-AVANZADOS-DE-PROGRAMACION}
\providecommand{\itescadepartment}{Topicos Avanzados de Programacion}
...
\providecommand{\itescatransfercontext}{Topicos Avanzados de Programacion, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/topicos-avanzados-de-programacion-isc/topicos-avanzados-de-programacion}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{topicos-avanzados-de-programacion.bib}
...
\def\itescadocumenttitle {Topicos Avanzados de Programacion}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Topicos Avanzados de Programacion}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Topicos Avanzados de Programacion}

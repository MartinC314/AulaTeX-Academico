...
\providecommand{\itescacoursename}{Sistemas Programables}
\providecommand{\itescacoursecode}{ISC-SISTEMAS-PROGRAMABLES}
\providecommand{\itescadepartment}{Sistemas Programables}
...
\providecommand{\itescatransfercontext}{Sistemas Programables, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/sistemas-programables-isc/sistemas-programables}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{sistemas-programables.bib}
...
\def\itescadocumenttitle {Sistemas Programables}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Sistemas Programables}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Sistemas Programables}

...
\providecommand{\itescacoursename}{Lengua Extranjera II}
\providecommand{\itescacoursecode}{ISC-LENGUA-EXTRANJERA-II}
\providecommand{\itescadepartment}{Lengua Extranjera II}
...
\providecommand{\itescatransfercontext}{Lengua Extranjera II, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/lengua-extranjera-ii-isc/lengua-extranjera-ii}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{lengua-extranjera-ii.bib}
...
\def\itescadocumenttitle {Lengua Extranjera II}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Lengua Extranjera II}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Lengua Extranjera II}

...
\providecommand{\itescacoursename}{Fundamentos de Ingenieria de Software}
\providecommand{\itescacoursecode}{ISC-FUNDAMENTOS-DE-INGENIERIA-DE-SOFTWARE}
\providecommand{\itescadepartment}{Fundamentos de Ingenieria de Software}
...
\providecommand{\itescatransfercontext}{Fundamentos de Ingenieria de Software, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/fundamentos-de-ingenieria-de-software-isc/fundamentos-de-ingenieria-de-software}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{fundamentos-de-ingenieria-de-software.bib}
...
\def\itescadocumenttitle {Fundamentos de Ingenieria de Software}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Fundamentos de Ingenieria de Software}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Fundamentos de Ingenieria de Software}

...
\providecommand{\itescacoursename}{Diseno Multimedia Interactivo}
\providecommand{\itescacoursecode}{ISC-DISENO-MULTIMEDIA-INTERACTIVO}
\providecommand{\itescadepartment}{Diseno Multimedia Interactivo}
...
\providecommand{\itescatransfercontext}{Diseno Multimedia Interactivo, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/diseno-multimedia-interactivo-isc/diseno-multimedia-interactivo}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{diseno-multimedia-interactivo.bib}
...
\def\itescadocumenttitle {Diseno Multimedia Interactivo}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Diseno Multimedia Interactivo}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Diseno Multimedia Interactivo}

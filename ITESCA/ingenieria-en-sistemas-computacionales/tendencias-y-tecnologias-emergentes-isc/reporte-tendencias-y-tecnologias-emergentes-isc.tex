...
\providecommand{\itescacoursename}{Tendencias y Tecnologias Emergentes}
\providecommand{\itescacoursecode}{ISC-TENDENCIAS-Y-TECNOLOGIAS-EMERGENTES}
\providecommand{\itescadepartment}{Tendencias y Tecnologias Emergentes}
...
\providecommand{\itescatransfercontext}{Tendencias y Tecnologias Emergentes, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/tendencias-y-tecnologias-emergentes-isc/tendencias-y-tecnologias-emergentes}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{tendencias-y-tecnologias-emergentes.bib}
...
\def\itescadocumenttitle {Tendencias y Tecnologias Emergentes}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Tendencias y Tecnologias Emergentes}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Tendencias y Tecnologias Emergentes}

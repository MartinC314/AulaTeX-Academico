...
\providecommand{\itescacoursename}{Actividades Complementarias}
\providecommand{\itescacoursecode}{ISC-ACTIVIDADES-COMPLEMENTARIAS}
\providecommand{\itescadepartment}{Actividades Complementarias}
...
\providecommand{\itescatransfercontext}{Actividades Complementarias, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/actividades-complementarias-isc/actividades-complementarias}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{actividades-complementarias.bib}
...
\def\itescadocumenttitle {Actividades Complementarias}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Actividades Complementarias}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Actividades Complementarias}

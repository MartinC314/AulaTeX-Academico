...
\providecommand{\itescacoursename}{Cultura Empresarial}
\providecommand{\itescacoursecode}{ISC-CULTURA-EMPRESARIAL}
\providecommand{\itescadepartment}{Cultura Empresarial}
...
\providecommand{\itescatransfercontext}{Cultura Empresarial, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/cultura-empresarial-isc/cultura-empresarial}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{cultura-empresarial.bib}
...
\def\itescadocumenttitle {Cultura Empresarial}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Cultura Empresarial}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Cultura Empresarial}

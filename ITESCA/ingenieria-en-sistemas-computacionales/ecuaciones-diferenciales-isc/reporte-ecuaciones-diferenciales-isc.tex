...
\providecommand{\itescacoursename}{Ecuaciones Diferenciales}
\providecommand{\itescacoursecode}{ISC-ECUACIONES-DIFERENCIALES}
\providecommand{\itescadepartment}{Ecuaciones Diferenciales}
...
\providecommand{\itescatransfercontext}{Ecuaciones Diferenciales, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/ecuaciones-diferenciales-isc/ecuaciones-diferenciales}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{ecuaciones-diferenciales.bib}
...
\def\itescadocumenttitle {Ecuaciones Diferenciales}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Ecuaciones Diferenciales}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Ecuaciones Diferenciales}

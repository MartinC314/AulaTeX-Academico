...
\providecommand{\itescacoursename}{Interfaces Web y Dispositivos Moviles}
\providecommand{\itescacoursecode}{ISC-INTERFACES-WEB-Y-DISPOSITIVOS-MOVILES}
\providecommand{\itescadepartment}{Interfaces Web y Dispositivos Moviles}
...
\providecommand{\itescatransfercontext}{Interfaces Web y Dispositivos Moviles, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/interfaces-web-y-dispositivos-moviles-isc/interfaces-web-y-dispositivos-moviles}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{interfaces-web-y-dispositivos-moviles.bib}
...
\def\itescadocumenttitle {Interfaces Web y Dispositivos Moviles}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Interfaces Web y Dispositivos Moviles}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Interfaces Web y Dispositivos Moviles}

...
\providecommand{\itescacoursename}{Lengua Extranjera III}
\providecommand{\itescacoursecode}{ISC-LENGUA-EXTRANJERA-III}
\providecommand{\itescadepartment}{Lengua Extranjera III}
...
\providecommand{\itescatransfercontext}{Lengua Extranjera III, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/lengua-extranjera-iii-isc/lengua-extranjera-iii}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{lengua-extranjera-iii.bib}
...
\def\itescadocumenttitle {Lengua Extranjera III}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Lengua Extranjera III}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Lengua Extranjera III}

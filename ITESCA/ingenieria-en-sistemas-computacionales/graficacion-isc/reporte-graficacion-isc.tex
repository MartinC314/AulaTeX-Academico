...
\providecommand{\itescacoursename}{Graficacion}
\providecommand{\itescacoursecode}{ISC-GRAFICACION}
\providecommand{\itescadepartment}{Graficacion}
...
\providecommand{\itescatransfercontext}{Graficacion, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/graficacion-isc/graficacion}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{graficacion.bib}

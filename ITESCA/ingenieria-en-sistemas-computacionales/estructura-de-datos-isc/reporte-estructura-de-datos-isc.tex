...
\providecommand{\itescacoursename}{Estructura de Datos}
\providecommand{\itescacoursecode}{ISC-ESTRUCTURA-DE-DATOS}
\providecommand{\itescadepartment}{Estructura de Datos}
...
\providecommand{\itescatransfercontext}{Estructura de Datos, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-isc,ITESCA/ingenieria-en-sistemas-computacionales/estructura-de-datos-isc/estructura-de-datos}
\providecommand{\itescageneralbib}{bibliografia-itesca-isc.bib}
\providecommand{\itescacoursebib}{estructura-de-datos.bib}
...
\def\itescadocumenttitle {Estructura de Datos}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Estructura de Datos}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Estructura de Datos}

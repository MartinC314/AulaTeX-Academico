...
\providecommand{\itescacoursename}{Desarrollo de las Organizaciones Sustentables}
\providecommand{\itescacoursecode}{MGA-DESARROLLO-DE-LAS-ORGANIZACIONES-SUSTENTABLES}
\providecommand{\itescadepartment}{Desarrollo de las Organizaciones Sustentables}
...
\providecommand{\itescatransfercontext}{Desarrollo de las Organizaciones Sustentables, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-mga,ITESCA/maestria-en-gestion-administrativa/desarrollo-de-las-organizaciones-sustentables-mga/desarrollo-de-las-organizaciones-sustentables}
\providecommand{\itescageneralbib}{bibliografia-itesca-mga.bib}
\providecommand{\itescacoursebib}{desarrollo-de-las-organizaciones-sustentables.bib}
...
\def\itescadocumenttitle {Desarrollo de las Organizaciones Sustentables}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Desarrollo de las Organizaciones Sustentables}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Desarrollo de las Organizaciones Sustentables}

...
\providecommand{\itescacoursename}{Administracion de la Micro, Pequena y Medianas Empresas}
\providecommand{\itescacoursecode}{MGA-ADMINISTRACION-DE-LA-MICRO-PEQUENA-Y-MEDIANAS-EMPRESAS}
\providecommand{\itescadepartment}{Administracion de la Micro, Pequena y Medianas Empresas}
...
\providecommand{\itescatransfercontext}{Administracion de la Micro, Pequena y Medianas Empresas, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-mga,ITESCA/maestria-en-gestion-administrativa/administracion-de-la-micro-pequena-y-medianas-empresas-mga/administracion-de-la-micro-pequena-y-medianas-empresas}
\providecommand{\itescageneralbib}{bibliografia-itesca-mga.bib}
\providecommand{\itescacoursebib}{administracion-de-la-micro-pequena-y-medianas-empresas.bib}
...
\def\itescadocumenttitle {Administracion de la Micro, Pequena y Medianas Empresas}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Administracion de la Micro, Pequena y Medianas Empresas}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Administracion de la Micro, Pequena y Medianas Empresas}
...
\clearpage
\nocite{itescaSitioWeb,itescaMGAOferta,inegiMIPYMES2025,economiaMIPYMESMX}

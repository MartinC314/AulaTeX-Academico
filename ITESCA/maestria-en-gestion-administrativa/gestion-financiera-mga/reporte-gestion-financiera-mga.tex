...
\providecommand{\itescacoursename}{Gestion Financiera}
\providecommand{\itescacoursecode}{MGA-GESTION-FINANCIERA}
\providecommand{\itescadepartment}{Gestion Financiera}
...
\providecommand{\itescatransfercontext}{Gestion Financiera, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-mga,ITESCA/maestria-en-gestion-administrativa/gestion-financiera-mga/gestion-financiera}
\providecommand{\itescageneralbib}{bibliografia-itesca-mga.bib}
\providecommand{\itescacoursebib}{gestion-financiera.bib}
...
\def\itescadocumenttitle {Gestion Financiera}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Gestion Financiera}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Gestion Financiera}

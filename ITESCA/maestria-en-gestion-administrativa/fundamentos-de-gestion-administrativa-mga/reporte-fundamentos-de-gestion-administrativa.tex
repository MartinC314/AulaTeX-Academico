...
\begin{titlepage}
  ...
  \begin{center}
    ...
    {\Huge\bfseries Plantilla base de Fundamentos de Gestion Administrativa\par}
    \vspace{0.35cm}
    {\Large Plantilla de reporte - Fundamentos de Gestion Administrativa\par}
    \vspace{0.45cm}
...
\section{Encuadre institucional y administrativo}
La materia se trabaja desde el programa academico del ITESCA. La bibliografia
local debe sostener el analisis con fuentes institucionales y academicas
verificables \citep{itescaProgramaFundamentosGestion,robbinsCoulter2018Administracion}.

  ...
  \noindent\colorbox{unadmGreenDark}{%
    \begin{minipage}[t][10.55cm][t]{0.58\paperwidth}
      ...
      \hspace*{0.75cm}\begin{minipage}{9.7cm}
        {\color{white}\fontsize{24}{29}\selectfont\bfseries Actividad 3: Fundamentos de Gestion Administrativa\par}
        \vspace{0.35cm}
  ...
  \noindent\begin{minipage}[t][10.55cm][t]{\paperwidth}
    ...
    \noindent\colorbox{unadmGreen}{%
      \begin{minipage}[c][0.56cm][c]{\paperwidth}
        \hspace*{0.65cm}{\color{white}\small Fundamentos de Gestion Administrativa - UnADM - \today}
      \end{minipage}%
    }
  \end{minipage}
}
...
\ContentSlide{Objetivo editorial}{
  ...
  \begin{itemize}
    ...
    \item Bibliografia local: \texttt{fundamentos-de-gestion-administrativa.bib}.
  \end{itemize}
}

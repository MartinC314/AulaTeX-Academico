...
\begin{center}\begin{tikzpicture}[node distance=1.1cm]
\node[draw,rounded corners,fill=itescaSilver!35,minimum width=2.5cm,minimum height=1cm] (in) {\textbf{Entradas}\\recursos, personas, información};
\node[draw=itescaRedDark,very thick,circle,fill=itescaRed!8,right=of in,minimum size=2.65cm] (org) {\textbf{Sistema}\\organización};
\node[draw,rounded corners,fill=itescaSilver!35,minimum width=2.5cm,minimum height=1cm,right=of org] (out) {\textbf{Salidas}\\bienes, servicios, resultados};

...
\providecommand{\itescacoursename}{Fundamentos de Gestion Administrativa}
\providecommand{\itescacoursecode}{MGA-FUNDAMENTOS-DE-GESTION-ADMINISTRATIVA}
\providecommand{\itescadepartment}{Fundamentos de Gestion Administrativa}
...
\providecommand{\itescatransfercontext}{Fundamentos de Gestion Administrativa, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-mga,ITESCA/maestria-en-gestion-administrativa/fundamentos-de-gestion-administrativa-mga/fundamentos-de-gestion-administrativa}
\providecommand{\itescageneralbib}{bibliografia-itesca-mga.bib}
\providecommand{\itescacoursebib}{fundamentos-de-gestion-administrativa.bib}
...
\def\itescadocumenttitle {Fundamentos de Gestion Administrativa}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Fundamentos de Gestion Administrativa}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Fundamentos de Gestion Administrativa}

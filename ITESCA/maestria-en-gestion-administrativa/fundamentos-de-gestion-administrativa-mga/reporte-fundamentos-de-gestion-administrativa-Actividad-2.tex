...
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}[
 root/.style={rounded corners,draw=itescaRedDark,fill=itescaRedDark,text=white,font=\bfseries,align=center,text width=5cm,minimum height=1.2cm},
 ...
 concept/.style={rounded corners,draw=itescaCharcoal!65,fill=white,font=\scriptsize,align=center,text width=3.5cm,minimum height=1cm},

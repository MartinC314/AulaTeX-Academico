...
\providecommand{\itescacoursename}{Plan de Negocios}
\providecommand{\itescacoursecode}{MGA-PLAN-DE-NEGOCIOS}
\providecommand{\itescadepartment}{Plan de Negocios}
...
\providecommand{\itescatransfercontext}{Plan de Negocios, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-mga,ITESCA/maestria-en-gestion-administrativa/plan-de-negocios-mga/plan-de-negocios}
\providecommand{\itescageneralbib}{bibliografia-itesca-mga.bib}
\providecommand{\itescacoursebib}{plan-de-negocios.bib}
...
\def\itescadocumenttitle {Plan de Negocios}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Plan de Negocios}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Plan de Negocios}

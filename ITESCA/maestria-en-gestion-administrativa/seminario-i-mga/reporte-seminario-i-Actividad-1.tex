...
% Identidad de portada idéntica a la plantilla maestra de Seminario I.
...
\begin{apareferences}
  \item Instituto Tecnológico Superior de Cajeme. (2026a). \emph{Maestría en Gestión Administrativa}. \url{https://www.itesca.edu.mx/modulos/oferta/posgrado/mgad.php}

  \item Instituto Tecnológico Superior de Cajeme. (2026b). \emph{Normatividad y documentos institucionales}. \url{https://www.itesca.edu.mx/modulos/itesca/documentacion.php}

  \item Tecnológico Nacional de México. (2023). \emph{Lineamientos para la operación de los estudios de posgrado en el Tecnológico Nacional de México}. \url{https://www.itesca.edu.mx/docs/LINEAMIENTOS_OPERACION_POSGRADO_TECNM_2023.pdf}
\end{apareferences}

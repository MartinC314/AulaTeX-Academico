...
\providecommand{\itescacoursename}{Tecnologias de Informacion para los Negocios}
\providecommand{\itescacoursecode}{MGA-TECNOLOGIAS-DE-INFORMACION-PARA-LOS-NEGOCIOS}
\providecommand{\itescadepartment}{Tecnologias de Informacion para los Negocios}
...
\providecommand{\itescatransfercontext}{Tecnologias de Informacion para los Negocios, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-mga,ITESCA/maestria-en-gestion-administrativa/tecnologias-de-informacion-para-los-negocios-mga/tecnologias-de-informacion-para-los-negocios}
\providecommand{\itescageneralbib}{bibliografia-itesca-mga.bib}
\providecommand{\itescacoursebib}{tecnologias-de-informacion-para-los-negocios.bib}
...
\def\itescadocumenttitle {Tecnologias de Informacion para los Negocios}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Tecnologias de Informacion para los Negocios}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Tecnologias de Informacion para los Negocios}
\def\itescablockname {LGAC gestion economica y financiera de las organizaciones}

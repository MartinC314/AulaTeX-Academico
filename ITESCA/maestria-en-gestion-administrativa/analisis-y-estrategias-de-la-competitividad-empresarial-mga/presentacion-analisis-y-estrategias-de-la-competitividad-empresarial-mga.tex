...
\providecommand{\itescamethodologycore}{Diagnostico, evidencia, decision y mejora}
\providecommand{\itescadidactictechniques}{Estudio de caso, debate, matriz de decision y proyecto integrador}

\def\itescaactivitytitle {Analisis y Estrategias de la Competitividad Empresarial}
...
\def\itescareporttemplatefile {reporte-analisis-y-estrategias-de-la-competitividad-empresarial-mga.tex}

...
\providecommand{\itescacoursename}{Analisis y Estrategias de la Competitividad Empresarial}
\providecommand{\itescacoursecode}{MGA-ANALISIS-Y-ESTRATEGIAS-DE-LA-COMPETITIVIDAD-EMPRESARIAL}
\providecommand{\itescadepartment}{Analisis y Estrategias de la Competitividad Empresarial}
...
\providecommand{\itescatransfercontext}{Analisis y Estrategias de la Competitividad Empresarial, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-mga,ITESCA/maestria-en-gestion-administrativa/analisis-y-estrategias-de-la-competitividad-empresarial-mga/analisis-y-estrategias-de-la-competitividad-empresarial}
\providecommand{\itescageneralbib}{bibliografia-itesca-mga.bib}
\providecommand{\itescacoursebib}{analisis-y-estrategias-de-la-competitividad-empresarial.bib}
...
\def\itescadocumenttitle {Analisis y Estrategias de la Competitividad Empresarial}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Analisis y Estrategias de la Competitividad Empresarial}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Analisis y Estrategias de la Competitividad Empresarial}
\def\itescablockname {LGAC gestion e innovacion de las organizaciones}
...
\clearpage
\nocite{itescaSitioWeb,itescaMGAOferta,inegiCensosEconomicos2024,economiaMIPYMESMX,economiaDataMexico,diputadosLeyCompetitividadMIPYME}

...
\providecommand{\itescacoursename}{Economia Circular}
\providecommand{\itescacoursecode}{MGA-ECONOMIA-CIRCULAR}
\providecommand{\itescadepartment}{Economia Circular}
...
\providecommand{\itescatransfercontext}{Economia Circular, contexto profesional y aplicacion disciplinar}
\providecommand{\itescalocation}{Cajeme, Sonora}
\providecommand{\itescalocationname}{Cajeme, Sonora}
\providecommand{\itescabibliography}{bibliografia-itesca-mga,ITESCA/maestria-en-gestion-administrativa/economia-circular-mga/economia-circular}
\providecommand{\itescageneralbib}{bibliografia-itesca-mga.bib}
\providecommand{\itescacoursebib}{economia-circular.bib}
...
\def\itescadocumenttitle {Economia Circular}
\def\itescadocumentsubtitle {Contenedor base de materia}
\def\itescadocumentsubject {Economia Circular}
\def\itescaactivityname {Punto de entrada canonico de materia}
\def\itescasessionname {Economia Circular}

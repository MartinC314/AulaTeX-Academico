...
\def\documenttitle {Calculo Integral}
\def\documentsubtitle {Actividad 1 - calculo-integral-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Calculo Integral}
\def\coursecode {IMTC}
...
\bibliography{calculo-integral-imtc}

...
\def\documentsubtitle {Reporte integral - introduccion-a-la-ciencia-de-datos-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia introduccion a la ciencia de datos.
\end{abstractd}

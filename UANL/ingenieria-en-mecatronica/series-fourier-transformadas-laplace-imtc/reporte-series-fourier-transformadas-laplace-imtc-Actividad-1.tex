...
\def\documenttitle {Series Fourier Transformadas Laplace}
\def\documentsubtitle {Actividad 1 - series-fourier-transformadas-laplace-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Series Fourier Transformadas Laplace}
\def\coursecode {IMTC}
...
\bibliography{series-fourier-transformadas-laplace-imtc}

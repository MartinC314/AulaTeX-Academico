...
\def\documentsubtitle {Reporte integral - series-fourier-transformadas-laplace-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia series fourier transformadas laplace.
\end{abstractd}

...
\def\documenttitle {Diseno De Mecanismos De Precision}
\def\documentsubtitle {Actividad 1 - diseno-de-mecanismos-de-precision-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Diseno De Mecanismos De Precision}
\def\coursecode {IMTC}
...
\bibliography{diseno-de-mecanismos-de-precision-imtc}

...
\def\documentsubtitle {Reporte integral - diseno-de-mecanismos-de-precision-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia diseno de mecanismos de precision.
\end{abstractd}

...
\def\documenttitle {Laboratorio De Electronica Digital}
\def\documentsubtitle {Actividad 1 - laboratorio-de-electronica-digital-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Electronica Digital}
\def\coursecode {IMTC}
...
\bibliography{laboratorio-de-electronica-digital-imtc}

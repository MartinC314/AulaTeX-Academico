...
\def\documentsubtitle {Reporte integral - laboratorio-de-electronica-digital-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de electronica digital.
\end{abstractd}

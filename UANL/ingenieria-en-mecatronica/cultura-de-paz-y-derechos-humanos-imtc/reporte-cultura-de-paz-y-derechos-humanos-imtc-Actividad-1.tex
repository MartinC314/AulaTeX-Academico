...
\def\documenttitle {Cultura De Paz Y Derechos Humanos}
\def\documentsubtitle {Actividad 1 - cultura-de-paz-y-derechos-humanos-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Cultura De Paz Y Derechos Humanos}
\def\coursecode {IMTC}
...
\bibliography{cultura-de-paz-y-derechos-humanos-imtc}

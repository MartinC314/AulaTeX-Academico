...
\def\documenttitle {Robotica Industrial}
\def\documentsubtitle {Actividad 1 - robotica-industrial-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Robotica Industrial}
\def\coursecode {IMTC}
...
\bibliography{robotica-industrial-imtc}

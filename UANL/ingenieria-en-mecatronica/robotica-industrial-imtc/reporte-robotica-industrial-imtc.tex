...
\def\documentsubtitle {Reporte integral - robotica-industrial-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia robotica industrial.
\end{abstractd}

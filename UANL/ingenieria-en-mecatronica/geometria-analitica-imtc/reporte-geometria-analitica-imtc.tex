...
\def\documentsubtitle {Reporte integral - geometria-analitica-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia geometria analitica.
\end{abstractd}

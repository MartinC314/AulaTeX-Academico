...
\def\documenttitle {Geometria Analitica}
\def\documentsubtitle {Actividad 1 - geometria-analitica-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Geometria Analitica}
\def\coursecode {IMTC}
...
\bibliography{geometria-analitica-imtc}

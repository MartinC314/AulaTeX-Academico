...
\def\documenttitle {Etica Transp Cultura Legalidad}
\def\documentsubtitle {Actividad 1 - etica-transp-cultura-legalidad-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Etica Transp Cultura Legalidad}
\def\coursecode {IMTC}
...
\bibliography{etica-transp-cultura-legalidad-imtc}

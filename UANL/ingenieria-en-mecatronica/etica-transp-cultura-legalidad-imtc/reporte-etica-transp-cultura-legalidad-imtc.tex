...
\def\documentsubtitle {Reporte integral - etica-transp-cultura-legalidad-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia etica transp cultura legalidad.
\end{abstractd}

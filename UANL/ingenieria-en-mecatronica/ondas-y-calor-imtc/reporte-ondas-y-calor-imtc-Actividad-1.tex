...
\def\documenttitle {Ondas Y Calor}
\def\documentsubtitle {Actividad 1 - ondas-y-calor-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Ondas Y Calor}
\def\coursecode {IMTC}
...
\bibliography{ondas-y-calor-imtc}

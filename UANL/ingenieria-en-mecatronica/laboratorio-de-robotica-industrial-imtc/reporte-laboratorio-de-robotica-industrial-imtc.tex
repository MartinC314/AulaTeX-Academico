...
\def\documentsubtitle {Reporte integral - laboratorio-de-robotica-industrial-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de robotica industrial.
\end{abstractd}

...
\def\documenttitle {Laboratorio De Robotica Industrial}
\def\documentsubtitle {Actividad 1 - laboratorio-de-robotica-industrial-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Robotica Industrial}
\def\coursecode {IMTC}
...
\bibliography{laboratorio-de-robotica-industrial-imtc}

...
\def\documentsubtitle {Reporte integral - procesos-de-manufactura-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia procesos de manufactura.
\end{abstractd}

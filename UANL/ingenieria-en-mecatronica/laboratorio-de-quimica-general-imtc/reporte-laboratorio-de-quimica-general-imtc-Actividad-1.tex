...
\def\documenttitle {Laboratorio De Quimica General}
\def\documentsubtitle {Actividad 1 - laboratorio-de-quimica-general-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Quimica General}
\def\coursecode {IMTC}
...
\bibliography{laboratorio-de-quimica-general-imtc}

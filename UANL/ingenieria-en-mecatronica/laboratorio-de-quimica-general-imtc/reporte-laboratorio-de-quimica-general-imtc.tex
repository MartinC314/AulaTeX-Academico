...
\def\documentsubtitle {Reporte integral - laboratorio-de-quimica-general-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de quimica general.
\end{abstractd}

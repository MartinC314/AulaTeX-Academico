...
\def\documentsubtitle {Reporte integral - electronica-analogica-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia electronica analogica.
\end{abstractd}

...
\def\documenttitle {Electronica Analogica}
\def\documentsubtitle {Actividad 1 - electronica-analogica-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Electronica Analogica}
\def\coursecode {IMTC}
...
\bibliography{electronica-analogica-imtc}

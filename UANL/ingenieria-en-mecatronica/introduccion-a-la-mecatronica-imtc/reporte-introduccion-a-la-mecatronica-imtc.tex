...
\def\documentsubtitle {Reporte integral - introduccion-a-la-mecatronica-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia introduccion a la mecatronica.
\end{abstractd}

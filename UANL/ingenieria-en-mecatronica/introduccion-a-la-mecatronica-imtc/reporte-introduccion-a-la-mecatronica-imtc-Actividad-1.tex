...
\def\documenttitle {Introduccion A La Mecatronica}
\def\documentsubtitle {Actividad 1 - introduccion-a-la-mecatronica-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Introduccion A La Mecatronica}
\def\coursecode {IMTC}
...
\bibliography{introduccion-a-la-mecatronica-imtc}

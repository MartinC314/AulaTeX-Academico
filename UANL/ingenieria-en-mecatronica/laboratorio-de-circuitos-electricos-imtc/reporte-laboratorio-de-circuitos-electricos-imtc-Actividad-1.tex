...
\def\documenttitle {Laboratorio De Circuitos Electricos}
\def\documentsubtitle {Actividad 1 - laboratorio-de-circuitos-electricos-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Circuitos Electricos}
\def\coursecode {IMTC}
...
\bibliography{laboratorio-de-circuitos-electricos-imtc}

...
\def\documentsubtitle {Reporte integral - laboratorio-de-circuitos-electricos-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de circuitos electricos.
\end{abstractd}

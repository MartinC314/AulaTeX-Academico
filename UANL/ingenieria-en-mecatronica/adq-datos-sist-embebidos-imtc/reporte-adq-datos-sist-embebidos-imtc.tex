...
\def\documentsubtitle {Reporte integral - adq-datos-sist-embebidos-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia adq datos sist embebidos.
\end{abstractd}

...
\def\documenttitle {Adq Datos Sist Embebidos}
\def\documentsubtitle {Actividad 1 - adq-datos-sist-embebidos-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Adq Datos Sist Embebidos}
\def\coursecode {IMTC}
...
\bibliography{adq-datos-sist-embebidos-imtc}

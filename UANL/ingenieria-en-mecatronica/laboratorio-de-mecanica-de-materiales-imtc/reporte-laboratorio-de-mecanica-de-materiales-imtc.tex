...
\def\documenttitle {Laboratorio De Mecanica De Materiales}
\def\documentsubtitle {Reporte integral - laboratorio-de-mecanica-de-materiales-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Mecanica De Materiales}
\def\coursecode {IMTC}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de mecanica de materiales.
\end{abstractd}
...
\bibliography{laboratorio-de-mecanica-de-materiales-imtc}

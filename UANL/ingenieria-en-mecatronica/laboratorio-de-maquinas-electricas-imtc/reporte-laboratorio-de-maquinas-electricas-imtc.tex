...
\def\documentsubtitle {Reporte integral - laboratorio-de-maquinas-electricas-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de maquinas electricas.
\end{abstractd}

...
\def\documenttitle {Laboratorio De Maquinas Electricas}
\def\documentsubtitle {Actividad 1 - laboratorio-de-maquinas-electricas-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Maquinas Electricas}
\def\coursecode {IMTC}
...
\bibliography{laboratorio-de-maquinas-electricas-imtc}

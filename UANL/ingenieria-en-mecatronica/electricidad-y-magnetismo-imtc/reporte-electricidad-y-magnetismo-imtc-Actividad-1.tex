...
\def\documenttitle {Electricidad Y Magnetismo}
\def\documentsubtitle {Actividad 1 - electricidad-y-magnetismo-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Electricidad Y Magnetismo}
\def\coursecode {IMTC}
...
\bibliography{electricidad-y-magnetismo-imtc}

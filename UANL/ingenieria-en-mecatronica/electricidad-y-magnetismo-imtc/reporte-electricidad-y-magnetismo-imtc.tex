...
\def\documentsubtitle {Reporte integral - electricidad-y-magnetismo-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia electricidad y magnetismo.
\end{abstractd}

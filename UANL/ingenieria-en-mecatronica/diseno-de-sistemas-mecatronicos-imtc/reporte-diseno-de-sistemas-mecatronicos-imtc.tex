...
\def\documenttitle {Diseno De Sistemas Mecatronicos}
\def\documentsubtitle {Reporte integral - diseno-de-sistemas-mecatronicos-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Diseno De Sistemas Mecatronicos}
\def\coursecode {IMTC}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia diseno de sistemas mecatronicos.
\end{abstractd}
...
\bibliography{diseno-de-sistemas-mecatronicos-imtc}

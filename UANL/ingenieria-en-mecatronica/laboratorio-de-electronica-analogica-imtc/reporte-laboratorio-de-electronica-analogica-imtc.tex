...
\def\documentsubtitle {Reporte integral - laboratorio-de-electronica-analogica-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de electronica analogica.
\end{abstractd}

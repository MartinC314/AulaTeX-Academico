...
\def\documenttitle {Laboratorio De Electronica Analogica}
\def\documentsubtitle {Actividad 1 - laboratorio-de-electronica-analogica-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Electronica Analogica}
\def\coursecode {IMTC}
...
\bibliography{laboratorio-de-electronica-analogica-imtc}

...
\def\documenttitle {Seminario Para El Desempeno Profesional}
\def\documentsubtitle {Actividad 1 - seminario-para-el-desempeno-profesional-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Seminario Para El Desempeno Profesional}
\def\coursecode {IMTC}
...
\bibliography{seminario-para-el-desempeno-profesional-imtc}
...
% Brechas locales atendidas por Ciclo A: tesis, analisis_propio, conclusion_argumentada, bibliografia_insuficiente, citas_insuficientes

...
\def\documentsubtitle {Reporte integral - seminario-para-el-desempeno-profesional-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia seminario para el desempeno profesional.
\end{abstractd}

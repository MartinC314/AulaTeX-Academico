...
\def\documenttitle {Prototipados Rapidos}
\def\documentsubtitle {Actividad 1 - prototipados-rapidos-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Prototipados Rapidos}
\def\coursecode {IMTC}
...
\bibliography{prototipados-rapidos-imtc}

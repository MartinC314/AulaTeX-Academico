...
\def\documentsubtitle {Reporte integral - prototipados-rapidos-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia prototipados rapidos.
\end{abstractd}

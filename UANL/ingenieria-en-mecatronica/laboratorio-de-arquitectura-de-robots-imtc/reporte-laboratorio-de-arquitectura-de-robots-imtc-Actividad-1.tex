...
\def\documenttitle {Laboratorio De Arquitectura De Robots}
\def\documentsubtitle {Actividad 1 - laboratorio-de-arquitectura-de-robots-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Arquitectura De Robots}
\def\coursecode {IMTC}
...
\bibliography{laboratorio-de-arquitectura-de-robots-imtc}

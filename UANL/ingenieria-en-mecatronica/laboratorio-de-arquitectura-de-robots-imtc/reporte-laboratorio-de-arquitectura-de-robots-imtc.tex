...
\def\documentsubtitle {Reporte integral - laboratorio-de-arquitectura-de-robots-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de arquitectura de robots.
\end{abstractd}

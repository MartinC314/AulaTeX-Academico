...
\def\documenttitle {Ciencia De Los Materiales}
\def\documentsubtitle {Actividad 1 - ciencia-de-los-materiales-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Ciencia De Los Materiales}
\def\coursecode {IMTC}
...
\bibliography{ciencia-de-los-materiales-imtc}

...
\def\documentsubtitle {Reporte integral - lab-diseno-ing-computadora-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia lab diseno ing computadora.
\end{abstractd}

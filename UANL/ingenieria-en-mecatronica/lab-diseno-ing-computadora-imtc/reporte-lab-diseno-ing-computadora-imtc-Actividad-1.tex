...
\def\documenttitle {Lab Diseno Ing Computadora}
\def\documentsubtitle {Actividad 1 - lab-diseno-ing-computadora-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Lab Diseno Ing Computadora}
\def\coursecode {IMTC}
...
\bibliography{lab-diseno-ing-computadora-imtc}

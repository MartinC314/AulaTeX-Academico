...
\def\documenttitle {Dibujo Para Ingenieria}
\def\documentsubtitle {Actividad 1 - dibujo-para-ingenieria-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Dibujo Para Ingenieria}
\def\coursecode {IMTC}
...
\bibliography{dibujo-para-ingenieria-imtc}

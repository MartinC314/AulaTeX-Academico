...
\def\documentsubtitle {Reporte integral - dibujo-para-ingenieria-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia dibujo para ingenieria.
\end{abstractd}

...
\def\documentsubtitle {Reporte integral - termodinamica-basica-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia termodinamica basica.
\end{abstractd}

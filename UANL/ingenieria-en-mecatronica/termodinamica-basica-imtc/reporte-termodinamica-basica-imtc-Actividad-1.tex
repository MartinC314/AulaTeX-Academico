...
\def\documenttitle {Termodinamica Basica}
\def\documentsubtitle {Actividad 1 - termodinamica-basica-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Termodinamica Basica}
\def\coursecode {IMTC}
...
\bibliography{termodinamica-basica-imtc}

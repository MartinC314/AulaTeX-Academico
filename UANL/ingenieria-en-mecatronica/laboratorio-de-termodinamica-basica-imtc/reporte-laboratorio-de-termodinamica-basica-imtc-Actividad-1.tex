...
\def\documenttitle {Laboratorio De Termodinamica Basica}
\def\documentsubtitle {Actividad 1 - laboratorio-de-termodinamica-basica-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Termodinamica Basica}
\def\coursecode {IMTC}
...
\bibliography{laboratorio-de-termodinamica-basica-imtc}

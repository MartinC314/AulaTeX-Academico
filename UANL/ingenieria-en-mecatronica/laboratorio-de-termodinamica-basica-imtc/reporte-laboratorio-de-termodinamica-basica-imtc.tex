...
\def\documentsubtitle {Reporte integral - laboratorio-de-termodinamica-basica-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de termodinamica basica.
\end{abstractd}

...
\def\documenttitle {Liderazgo Emprendimiento E Innovacion}
\def\documentsubtitle {Actividad 1 - liderazgo-emprendimiento-e-innovacion-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Liderazgo Emprendimiento E Innovacion}
\def\coursecode {IMTC}
...
\bibliography{liderazgo-emprendimiento-e-innovacion-imtc}

...
\def\documentsubtitle {Reporte integral - liderazgo-emprendimiento-e-innovacion-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia liderazgo emprendimiento e innovacion.
\end{abstractd}

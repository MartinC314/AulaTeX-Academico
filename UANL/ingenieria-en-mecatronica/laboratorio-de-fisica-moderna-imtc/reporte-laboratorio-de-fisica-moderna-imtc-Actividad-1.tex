...
\def\documenttitle {Laboratorio De Fisica Moderna}
\def\documentsubtitle {Actividad 1 - laboratorio-de-fisica-moderna-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Fisica Moderna}
\def\coursecode {IMTC}
...
\bibliography{laboratorio-de-fisica-moderna-imtc}

...
\def\documentsubtitle {Reporte integral - laboratorio-de-fisica-moderna-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de fisica moderna.
\end{abstractd}

...
\def\documenttitle {Laboratorio De Sensores Y Actuadores}
\def\documentsubtitle {Actividad 1 - laboratorio-de-sensores-y-actuadores-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Sensores Y Actuadores}
\def\coursecode {IMTC}
...
\bibliography{laboratorio-de-sensores-y-actuadores-imtc}

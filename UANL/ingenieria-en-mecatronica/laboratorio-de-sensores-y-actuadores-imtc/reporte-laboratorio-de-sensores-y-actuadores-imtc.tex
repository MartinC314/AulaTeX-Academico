...
\def\documentsubtitle {Reporte integral - laboratorio-de-sensores-y-actuadores-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de sensores y actuadores.
\end{abstractd}

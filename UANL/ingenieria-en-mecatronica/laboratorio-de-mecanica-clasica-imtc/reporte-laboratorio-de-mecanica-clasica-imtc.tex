...
\def\documentsubtitle {Reporte integral - laboratorio-de-mecanica-clasica-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de mecanica clasica.
\end{abstractd}

...
\def\documentsubtitle {Reporte integral - algebra-para-ingenieria-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia algebra para ingenieria.
\end{abstractd}

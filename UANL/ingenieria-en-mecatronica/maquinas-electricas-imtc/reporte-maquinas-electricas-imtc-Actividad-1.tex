...
\def\documenttitle {Maquinas Electricas}
\def\documentsubtitle {Actividad 1 - maquinas-electricas-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Maquinas Electricas}
\def\coursecode {IMTC}
...
\bibliography{maquinas-electricas-imtc}

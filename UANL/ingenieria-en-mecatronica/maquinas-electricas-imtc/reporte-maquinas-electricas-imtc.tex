...
\def\documentsubtitle {Reporte integral - maquinas-electricas-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia maquinas electricas.
\end{abstractd}

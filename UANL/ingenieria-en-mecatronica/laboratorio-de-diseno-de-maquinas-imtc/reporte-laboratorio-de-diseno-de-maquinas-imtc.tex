...
\def\documentsubtitle {Reporte integral - laboratorio-de-diseno-de-maquinas-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de diseno de maquinas.
\end{abstractd}

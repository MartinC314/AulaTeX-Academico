...
\def\documenttitle {Laboratorio De Diseno De Maquinas}
\def\documentsubtitle {Actividad 1 - laboratorio-de-diseno-de-maquinas-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Diseno De Maquinas}
\def\coursecode {IMTC}
...
\bibliography{laboratorio-de-diseno-de-maquinas-imtc}

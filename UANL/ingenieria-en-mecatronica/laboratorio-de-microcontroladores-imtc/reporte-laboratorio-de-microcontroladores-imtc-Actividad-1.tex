...
\def\documenttitle {Laboratorio De Microcontroladores}
\def\documentsubtitle {Actividad 1 - laboratorio-de-microcontroladores-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Microcontroladores}
\def\coursecode {IMTC}
...
\bibliography{laboratorio-de-microcontroladores-imtc}

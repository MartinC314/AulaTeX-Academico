...
\def\documentsubtitle {Reporte integral - laboratorio-de-microcontroladores-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de microcontroladores.
\end{abstractd}

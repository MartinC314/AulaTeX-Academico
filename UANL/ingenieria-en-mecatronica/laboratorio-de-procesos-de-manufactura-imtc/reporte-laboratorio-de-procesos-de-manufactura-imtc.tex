...
\def\documentsubtitle {Reporte integral - laboratorio-de-procesos-de-manufactura-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de procesos de manufactura.
\end{abstractd}

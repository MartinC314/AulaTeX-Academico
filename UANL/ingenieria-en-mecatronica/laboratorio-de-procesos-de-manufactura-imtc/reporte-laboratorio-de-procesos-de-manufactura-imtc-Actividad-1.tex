...
\def\documenttitle {Laboratorio De Procesos De Manufactura}
\def\documentsubtitle {Actividad 1 - laboratorio-de-procesos-de-manufactura-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Procesos De Manufactura}
\def\coursecode {IMTC}
...
\bibliography{laboratorio-de-procesos-de-manufactura-imtc}

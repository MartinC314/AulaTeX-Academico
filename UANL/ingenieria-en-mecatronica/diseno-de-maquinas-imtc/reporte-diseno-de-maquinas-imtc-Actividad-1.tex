...
\def\documenttitle {Diseno De Maquinas}
\def\documentsubtitle {Actividad 1 - diseno-de-maquinas-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Diseno De Maquinas}
\def\coursecode {IMTC}
...
\bibliography{diseno-de-maquinas-imtc}

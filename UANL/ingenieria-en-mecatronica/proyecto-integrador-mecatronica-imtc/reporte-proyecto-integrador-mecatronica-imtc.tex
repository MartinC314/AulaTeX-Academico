...
\def\documentsubtitle {Reporte integral - proyecto-integrador-mecatronica-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia proyecto integrador mecatronica.
\end{abstractd}

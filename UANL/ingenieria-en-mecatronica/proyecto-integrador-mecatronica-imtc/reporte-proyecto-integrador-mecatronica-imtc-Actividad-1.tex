...
\def\documenttitle {Proyecto Integrador Mecatronica}
\def\documentsubtitle {Actividad 1 - proyecto-integrador-mecatronica-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Proyecto Integrador Mecatronica}
\def\coursecode {IMTC}
...
\bibliography{proyecto-integrador-mecatronica-imtc}

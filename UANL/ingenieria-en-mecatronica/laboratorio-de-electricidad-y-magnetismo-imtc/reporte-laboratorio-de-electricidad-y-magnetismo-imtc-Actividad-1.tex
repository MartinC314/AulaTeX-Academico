...
\def\documenttitle {Laboratorio De Electricidad Y Magnetismo}
\def\documentsubtitle {Actividad 1 - laboratorio-de-electricidad-y-magnetismo-imtc}
\def\documentsubject {Ingenieria en Mecatronica}
\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Laboratorio De Electricidad Y Magnetismo}
\def\coursecode {IMTC}
...
\bibliography{laboratorio-de-electricidad-y-magnetismo-imtc}

...
\def\documentsubtitle {Reporte integral - laboratorio-de-electricidad-y-magnetismo-imtc}
...
\begin{abstractd}
\textbf{Objetivo:} Documentar el avance academico y tecnico de la materia laboratorio de electricidad y magnetismo.
\end{abstractd}

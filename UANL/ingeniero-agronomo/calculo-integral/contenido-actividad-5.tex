...
\textbf{Paso 1. Identificar la sustitución.} El radical contiene la expresión lineal
$4x+1$. Se toma
\[
 u=4x+1,\qquad du=4\,dx,\qquad dx=\frac{du}{4},\qquad x=\frac{u-1}{4}.
\]
La última igualdad se obtiene al despejar $x$ de $u=4x+1$.

\textbf{Paso 2. Transformar toda la integral.} Como $\sqrt{4x+1}=u^{1/2}$,
\begin{align*}
 \int x\sqrt{4x+1}\,dx
 &=\int \frac{u-1}{4}u^{1/2}\frac{du}{4}\\
 &=\frac1{16}\int(u-1)u^{1/2}\,du\\
 &=\frac1{16}\int\left(u^{3/2}-u^{1/2}\right)du\\
 &=\frac1{16}\left(\frac25u^{5/2}-\frac23u^{3/2}\right)+C\\
 &=\frac{u^{5/2}}{40}-\frac{u^{3/2}}{24}+C.
\end{align*}
Aquí se utilizó $\int u^n\,du=u^{n+1}/(n+1)+C$ en cada término.

\textbf{Paso 3. Regresar a la variable original.} Al sustituir $u=4x+1$ y
factorizar la potencia común $(4x+1)^{3/2}$,
\begin{align*}
 \frac{(4x+1)^{5/2}}{40}-\frac{(4x+1)^{3/2}}{24}+C
 &=(4x+1)^{3/2}\left(\frac{4x+1}{40}-\frac1{24}\right)+C\\
 &=(4x+1)^{3/2}\left(\frac{3(4x+1)-5}{120}\right)+C\\
 &=(4x+1)^{3/2}\left(\frac{12x-2}{120}\right)+C\\
...
\[
 ...
 =\frac{(6x-1)(4x+1)^{3/2}}{60}+C}.
\]
\textbf{Paso 4. Verificar por derivación.} Se aplica la regla del producto y la
regla de la cadena:
\begin{align*}
 \frac{d}{dx}\left[\frac{(6x-1)(4x+1)^{3/2}}{60}\right]
 &=\frac1{60}\left[6(4x+1)^{3/2}
 +(6x-1)\frac32(4x+1)^{1/2}(4)\right]\\
 &=\frac{(4x+1)^{1/2}}{60}\bigl[6(4x+1)+6(6x-1)\bigr]\\
 &=\frac{60x(4x+1)^{1/2}}{60}
 =x\sqrt{4x+1}.
\end{align*}
\end{activitybox}

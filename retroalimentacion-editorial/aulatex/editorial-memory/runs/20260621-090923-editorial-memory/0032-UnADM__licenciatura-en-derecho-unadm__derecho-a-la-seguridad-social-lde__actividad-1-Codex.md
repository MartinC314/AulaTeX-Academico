{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Asegurar trazabilidad entre pregunta, fuentes, analisis y conclusion.",
      "Conservar identidad institucional sin perder ajuste a consigna local."
    ],
    "style_markers": [
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "Da base juridica al derecho y orienta su interpretacion."
        },
        {
          "source": "Ley del Seguro Social",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Define mecanismos, prestaciones y operacion del regimen."
        },
        {
        ...
        },
        {
          ...
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Permite analizar avances, retrocesos y obligaciones estatales."
        }
      ],
      "evidence": [
    ...
    "reinforcement_log": [
      "Ciclo 32: deduplicacion integral de reglas repetidas.",
      "Ciclo 32: mantenimiento de control JSON y normalizacion como puerta de calidad.",
      "Ciclo 32: transferencia lateral limitada a patrones reutilizables.",
      "Ciclo 32: sin incorporacion de bibliografia exclusiva del nodo hermano."
    ]
  }
}
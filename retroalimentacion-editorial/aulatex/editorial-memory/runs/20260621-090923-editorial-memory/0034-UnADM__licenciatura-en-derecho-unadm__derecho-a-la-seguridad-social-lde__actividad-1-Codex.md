{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Asegurar calidad tecnica, argumentativa y documental en LaTeX."
    ],
    "style_markers": [
      ...
      "Consistencia entre consigna, desarrollo y conclusion."
    ],
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "Define el fundamento juridico del derecho en el programa analitico local."
        },
        {
          "source": "Ley del Seguro Social",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Concreta prestaciones y mecanismos del regimen aplicable."
        },
        {
        ...
        },
        {
          ...
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Orienta el analisis de avances, retrocesos y obligaciones estatales."
        }
      ],
      "evidence": [
    ...
    "reinforcement_log": [
      "Ciclo 34: deduplicacion integral aplicada en reglas e identidad.",
      "Ciclo 34: se retienen reglas utiles previas sin eliminacion regresiva.",
      "Ciclo 34: se evita transferencia de contenido tematico exclusivo del nodo hermano.",
      "Ciclo 34: se refuerza control de calidad JSON y normalizacion previa a propagacion.",
      "Ciclo 34: se consolidan patrones argumentativos transversales reutilizables."
    ]
  }
}
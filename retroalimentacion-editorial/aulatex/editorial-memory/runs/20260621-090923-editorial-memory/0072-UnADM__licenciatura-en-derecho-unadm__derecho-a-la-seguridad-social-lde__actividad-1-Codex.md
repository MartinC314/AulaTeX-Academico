{
  ...
  "editorial_dna": {
    ...
    "essence": [
      "Producto jurídico verificable con problema, fundamento, análisis, evidencia, postura y cierre.",
      "Rigor metodológico con trazabilidad de fuentes.",
      "Transferencia profesional del cierre argumentativo."
    ],
    "reason_for_being": [
      "Convertir consignas semanales en entregables jurídicos evaluables y consistentes.",
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "Define fundamento superior del derecho y su exigibilidad."
        },
        {
          "source": "Ley del Seguro Social",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Operationaliza prestaciones y régimen aplicable."
        },
        {
        ...
        },
        {
          ...
          "kind": "supports",
          "justification": "Sirve para evaluar inclusión real y barreras."
        },
        {
          "source": "Progresividad",
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Permite medir avances y detectar retrocesos."
        }
      ],
      "evidence": [
        "README local: estructura canónica y control editorial.",
        "Programa analítico local: propósito y ejes de trabajo.",
        "derecho-a-la-seguridad-social.bib: base verificable de fuentes normativas e institucionales."
      ]
    },
    "reinforcement_log": [
      "Ciclo 72: deduplicación completa de reglas repetidas en destino.",
      "Ciclo 72: se conservan todas las reglas útiles previas sin eliminación regresiva.",
      "Ciclo 72: se refuerza transferencia lateral de patrones, no de contenido temático exclusivo.",
      "Ciclo 72: se mantiene compresión lossless y control estricto de parseabilidad JSON."
    ]
  }
}
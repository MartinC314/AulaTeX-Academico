{
  ...
  "editorial_dna": {
    ...
    "essence": [
      "Producto jurídico verificable con trazabilidad argumentativa.",
      "Problema real con fundamento normativo y análisis propio.",
      "Uso de evidencia verificable y cierre profesional aplicable."
    ],
    "reason_for_being": [
      "Transformar cada consigna en un producto jurídico verificable.",
      "Asegurar consistencia entre identidad institucional, estructura y calidad técnica.",
      "Permitir propagación recursiva sin pérdida editorial."
    ],
    "style_markers": [
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "Define base de validez y exigibilidad del derecho."
        },
        {
          "source": "Ley del Seguro Social",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Operationaliza prestaciones y régimen para población asegurada."
        },
        {
        ...
        },
        {
          ...
          "kind": "supports",
          "justification": "Permite evaluar alcance real y barreras de entrada."
        },
        {
          "source": "Progresividad",
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Permite medir avances, retrocesos y deberes estatales."
        }
      ],
      "evidence": [
        "README local: estructura canónica y control editorial.",
        "Programa analítico local: propósito y ejes oficiales.",
        "derecho-a-la-seguridad-social.bib: base verificable local.",
        "Regla persistente: no propagar JSON inválido o salida no estructurada."
      ]
    },
    "reinforcement_log": [
      "Ciclo 26: deduplicación completa de reglas repetidas sin pérdida semántica.",
      "Ciclo 26: preservada transferencia lateral de patrones, sin copiar contenido temático exclusivo del nodo origen.",
      "Ciclo 26: reforzados compuertas de calidad para propagación recursiva segura."
    ]
  }
}
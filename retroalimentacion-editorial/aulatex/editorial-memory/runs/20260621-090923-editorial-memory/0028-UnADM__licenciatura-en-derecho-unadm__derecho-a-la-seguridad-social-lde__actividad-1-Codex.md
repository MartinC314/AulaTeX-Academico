{
  ...
  "editorial_dna": {
    ...
    "essence": [
      ...
      "Evidencia trazable en fuentes.",
      "Cierre profesional transferible."
    ],
    "reason_for_being": [
      "Transformar cada consigna en producto juridico verificable con identidad UnADM.",
      "Garantizar calidad editorial reproducible en actividades y formatos."
    ],
    "style_markers": [
      ...
      "Conclusion juridica no meramente descriptiva."
    ],
    ...
    "knowledge_graph": {
      ...
      "relations": [
        ...
        },
        {
          ...
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Operativiza prestaciones y cobertura del regimen."
        },
        {
          "source": "Ley del ISSSTE",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Regula derechos de personas servidoras publicas."
        },
        {
          "source": "Universalidad",
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Sirve para evaluar alcance real del derecho."
        },
        {
    ...
    "reinforcement_log": [
      "Ciclo 28: deduplicacion completa de reglas repetidas.",
      "Ciclo 28: se eliminaron relaciones con tipo invalido no permitido por esquema.",
      "Ciclo 28: se reforzo transferencia lateral por patrones, sin copiar contenido exclusivo del nodo hermano.",
      "Ciclo 28: se mantuvo enfoque lossless por union de reglas utiles verificadas."
    ]
  }
}
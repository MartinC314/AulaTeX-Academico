{
  ...
  "editorial_dna": {
    ...
    "essence": [
      "Problema jurídico o social de seguridad social.",
      "Fundamento constitucional y legal aplicable.",
      "Análisis propio con postura razonada.",
    ...
    "reason_for_being": [
      ...
      "Asegurar trazabilidad entre consigna, desarrollo, fuentes y conclusión.",
      "Evitar deriva descriptiva y reforzar argumentación jurídica."
    ],
    "style_markers": [
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "Define el fundamento primario del derecho."
        },
        {
          "source": "Ley del Seguro Social",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Concreta prestaciones y mecanismos del régimen general."
        },
        {
        ...
        },
        {
          ...
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Permite analizar avances y retrocesos normativos."
        }
      ],
      "evidence": [
        ...
        "Regla persistente: bloqueo por JSON inválido o salida no estructurada."
      ]
    },
    "reinforcement_log": [
      "Ciclo 47: deduplicación integral de reglas repetidas.",
      "Ciclo 47: conservación de reglas útiles previas sin regresión.",
      "Ciclo 47: refuerzo lateral de patrones argumentativos transferibles.",
      "Ciclo 47: sin transferencia de contenido temático exclusivo del nodo hermano."
    ]
  }
}
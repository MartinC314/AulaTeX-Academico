{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Asegurar calidad formal, trazabilidad de fuentes y utilidad profesional del cierre."
    ],
    "style_markers": [
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "Define base de validez y alcance del derecho."
        },
        {
          "source": "Ley del Seguro Social",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Operativiza cobertura y prestaciones del regimen aplicable."
        },
        {
          "source": "Ley del ISSSTE",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Regula proteccion social de trabajadores del Estado."
        },
        {
          "source": "Universalidad",
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Sirve para evaluar barreras y alcance real del derecho."
        },
        {
    ...
    "reinforcement_log": [
      "Ciclo 69: deduplicacion completa de reglas repetidas.",
      "Ciclo 69: se eliminaron patrones no permitidos de copia tematica entre hermanos.",
      "Ciclo 69: se mantuvo transferencia lateral solo de patrones reutilizables.",
      "Ciclo 69: se reforzaron compuertas de calidad y marcado de supuestos."
    ]
  }
}
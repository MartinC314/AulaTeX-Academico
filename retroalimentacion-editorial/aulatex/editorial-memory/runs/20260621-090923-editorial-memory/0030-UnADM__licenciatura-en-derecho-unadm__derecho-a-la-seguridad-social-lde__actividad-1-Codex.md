{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      "Transformar cada consigna en un producto juridico verificable con estructura y evidencia.",
      "Asegurar consistencia institucional y calidad tecnica en entregables LaTeX."
    ],
    "style_markers": [
      ...
      "Conclusion no meramente descriptiva."
    ],
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "Define base juridica del derecho en la materia."
        },
        {
          "source": "Ley del Seguro Social",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Operativiza prestaciones y regimen aplicable."
        },
        {
        ...
        },
        {
          ...
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Permite evaluar avances y no regresividad."
        },
        {
          "source": "Consigna de Actividad 1",
          "target": "Calidad editorial verificable",
          "kind": "depends_on",
          "justification": "El formato y profundidad dependen de la instruccion local."
        }
      ],
      "evidence": [
    ...
    "reinforcement_log": [
      ...
      "Se mantuvieron reglas validas previas sin eliminar utilidades.",
      "Se removio transferencia de contenido tematico exclusivo del nodo hermano.",
      "Se reforzo analogia controlada para propagacion lateral recursiva.",
      "Se mantuvieron supuestos abiertos cuando falta consigna local completa."
    ]
  }
}
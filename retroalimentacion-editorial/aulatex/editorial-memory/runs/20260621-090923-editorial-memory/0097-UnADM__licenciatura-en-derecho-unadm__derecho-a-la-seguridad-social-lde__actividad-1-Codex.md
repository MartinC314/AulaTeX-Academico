{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Asegurar trazabilidad entre consigna, fuentes, analisis y conclusion.",
      "Conservar identidad institucional sin perder adaptacion local."
    ],
    "style_markers": [
    ...
    "knowledge_graph": {
      ...
      "relations": [
        ...
        },
        {
          ...
          "kind": "supports",
          "justification": "Sirve para evaluar alcance real y barreras."
        },
        {
    ...
    "reinforcement_log": [
      "Ciclo 97: deduplicacion integral aplicada sin perdida de reglas utiles.",
      "Ciclo 97: se reforzaron compuertas de calidad y normalizacion JSON.",
      "Ciclo 97: se mantuvo transferencia lateral sin copiar contenido exclusivo del origen."
    ]
  }
}
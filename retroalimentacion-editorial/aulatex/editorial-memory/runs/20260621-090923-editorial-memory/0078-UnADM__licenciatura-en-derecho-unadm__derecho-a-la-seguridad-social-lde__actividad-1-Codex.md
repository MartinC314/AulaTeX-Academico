{
  ...
  "editorial_dna": {
    ...
    "essence": [
      ...
      "Evidencia trazable y pertinente.",
      "Cierre profesional transferible a practica juridica."
    ],
    "reason_for_being": [
      "Transformar cada consigna en producto juridico verificable.",
      "Asegurar consistencia entre identidad institucional, metodo y evidencia.",
      "Evitar deriva descriptiva mediante argumentacion y control de calidad."
    ],
    "style_markers": [
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "Provee base juridica primaria del derecho."
        },
        {
          "source": "Ley del Seguro Social",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Define mecanismos de proteccion y prestaciones."
        },
        {
        ...
        },
        {
          ...
          "target": "Conclusion juridica operativa",
          "kind": "depends_on",
          "justification": "La conclusion valida depende de evidencia, estructura y coherencia."
        }
      ],
      "evidence": [
        ...
        "Regla persistente: bloqueo por JSON invalido o salida no estructurada."
      ]
    },
    "reinforcement_log": [
      "Ciclo 78: deduplicacion integral de reglas repetidas en destino.",
      "Ciclo 78: se refuerza transferencia lateral de patrones, sin copiar contenido exclusivo del origen.",
      "Ciclo 78: se conserva ADN institucional y se mejora trazabilidad de supuestos.",
      "Ciclo 78: se mantienen compuertas de calidad y consistencia bib/tex."
    ]
  }
}
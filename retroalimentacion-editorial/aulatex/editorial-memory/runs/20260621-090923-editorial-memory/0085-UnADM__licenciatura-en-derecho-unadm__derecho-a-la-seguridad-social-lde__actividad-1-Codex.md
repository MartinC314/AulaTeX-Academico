{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Conectar norma, contexto y argumentación con utilidad profesional.",
      "Asegurar trazabilidad entre consigna, fuentes y conclusión."
    ],
    "style_markers": [
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "Define base jurídica primaria del derecho."
        },
        {
          "source": "Ley del Seguro Social",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Operativiza prestaciones y mecanismos del régimen."
        },
        {
          "source": "Ley del ISSSTE",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Regula cobertura de trabajadores del Estado."
        },
        {
        ...
        },
        {
          ...
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Permite medir avances y retrocesos estatales."
        },
        {
          "source": "Consigna de Actividad 1",
          "target": "Estructura del producto",
          "kind": "depends_on",
          "justification": "El formato final depende de instrucción local. [Supuesto]"
        }
      ],
      "evidence": [
        "README local: estructura canónica y control editorial.",
        "Programa analítico local: propósito y ejes de trabajo.",
        "derecho-a-la-seguridad-social.bib: base bibliográfica verificable.",
        "Regla persistente: no propagar sin JSON parseable y estructura mínima."
      ]
    },
    "reinforcement_log": [
      "Ciclo 85: deduplicación integral de reglas repetidas.",
      "Ciclo 85: se conserva ADN institucional y patrón argumentativo transversal.",
      "Ciclo 85: se evita transferencia de contenido temático exclusivo de nodo hermano.",
      "Ciclo 85: se agrega dependencia explícita de consigna local para formato final. [Supuesto]"
    ]
  }
}
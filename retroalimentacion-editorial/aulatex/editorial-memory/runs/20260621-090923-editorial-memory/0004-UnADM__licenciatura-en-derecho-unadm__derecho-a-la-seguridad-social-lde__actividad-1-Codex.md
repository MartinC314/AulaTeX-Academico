{
  ...
  "editorial_dna": {
    ...
    "essence": [
      "Problema juridico o social con impacto en seguridad social.",
      "Fundamento constitucional, legal y doctrinal pertinente.",
    ...
    "reason_for_being": [
      ...
      "Asegurar coherencia entre consigna, desarrollo, evidencia y conclusion.",
      "Preservar identidad institucional sin perder especificidad local."
    ],
    "style_markers": [
    ...
    "knowledge_graph": {
      ...
      "relations": [
        ...
        },
        {
          ...
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Operativiza cobertura y prestaciones del regimen correspondiente."
        },
        {
          "source": "Ley del ISSSTE",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Regula seguridad social para personas servidoras publicas."
        },
        {
        ...
        },
        {
          ...
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Permite medir avances y evitar retrocesos injustificados."
        }
      ],
      "evidence": [
    ...
    "reinforcement_log": [
      "Ciclo 4: deduplicacion completa de reglas repetidas.",
      "Ciclo 4: se mantiene transferencia lateral sin arrastre tematico exclusivo del nodo origen.",
      "Ciclo 4: se refuerzan puertas de calidad JSON y consistencia cita-bibliografia.",
      "Ciclo 4: se conserva ADN argumentativo comun UnADM con adaptacion local verificable."
    ]
  }
}
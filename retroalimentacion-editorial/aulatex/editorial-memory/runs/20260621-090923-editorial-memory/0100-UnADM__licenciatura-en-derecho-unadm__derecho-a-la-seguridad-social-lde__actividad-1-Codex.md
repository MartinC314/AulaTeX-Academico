{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      "Transformar cada consigna en un producto juridico verificable y evaluable.",
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "El programa analitico local fija el fundamento constitucional como eje."
        },
        {
          "source": "Ley del Seguro Social",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "La ley operacionaliza prestaciones y cobertura del regimen."
        },
        {
          "source": "Ley del ISSSTE",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "La ley regula seguridad social de trabajadores del Estado."
        },
        {
        ...
        },
        {
          ...
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Permite valorar avances y retrocesos en proteccion."
        }
      ],
      "evidence": [
    ...
    "reinforcement_log": [
      ...
      "Se conservaron reglas institucionales y de calidad heredadas como patrones reutilizables.",
      "Se excluyo transferencia de contenido tematico exclusivo del nodo hermano.",
      "Se reforzo control de supuestos para datos no visibles en consigna.",
      "Se mantuvo compatibilidad recursiva para propagacion lateral futura."
    ]
  }
}
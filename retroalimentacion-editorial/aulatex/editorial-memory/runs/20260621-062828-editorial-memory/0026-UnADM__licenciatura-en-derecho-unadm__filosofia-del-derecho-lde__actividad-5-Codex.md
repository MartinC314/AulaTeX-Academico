{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Asegurar trazabilidad entre consigna, evidencia, análisis y conclusión jurídica.",
      "Sostener continuidad editorial entre actividades sin copiar contenido específico."
    ],
    "style_markers": [
      "Encuadre breve al inicio.",
      "Secciones funcionales.",
      "Inferencia jurídica explícita.",
      "Supuestos marcados.",
      "Cierre transferible a práctica profesional."
    ],
    ...
    "knowledge_graph": {
      ...
      "evidence": [
        ...
        "Historial: incidentes de salida no parseable exigen gate estructural."
      ]
    },
    "reinforcement_log": [
      "Se deduplicaron reglas repetidas por forma y acento sin pérdida de contenido normativo.",
      "Se preservaron reglas útiles previas y se reforzó validación JSON como puerta obligatoria.",
      "Se acotó transferencia lateral a patrones reutilizables conforme instrucción.",

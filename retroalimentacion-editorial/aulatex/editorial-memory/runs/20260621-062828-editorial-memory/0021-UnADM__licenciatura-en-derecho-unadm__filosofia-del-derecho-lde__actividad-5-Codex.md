{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      "Convertir planeación semanal en productos académicos con estructura jurídica sólida.",
      "Asegurar continuidad editorial entre actividades sin perder especificidad local.",
      "Sostener calidad técnica, argumentativa y de citación en cada entrega."
    ],
    "style_markers": [
      "Encuadre breve al inicio.",
      "Secciones funcionales y explícitas.",
      "Inferencia jurídica visible entre evidencia y conclusión.",
      "Supuestos etiquetados cuando faltan datos.",
    ...
    "reinforcement_log": [
      "Se eliminó duplicidad semántica en reglas repetidas.",
      "Se preservaron reglas útiles del origen y del destino sin recorte funcional.",
      "Se reforzó separación entre patrones transferibles y contenido no transferible entre hermanos.",
      "Se mantuvo etiqueta de supuestos ante falta de consigna local.",
      "Se consolidó control de calidad técnico-editorial para ciclo 21."
    ]
  }
}
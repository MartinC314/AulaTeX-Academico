{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Convertir consignas en entregables alineados a criterios UnADM y práctica profesional."
    ],
    "style_markers": [
      "Declarar objetivo al inicio.",
      "Usar secciones explícitas y trazables.",
      "Sostener cada afirmación con fuente o marca de supuesto.",
      "Cerrar con conclusión jurídica aplicable."
    ],
    "argumentative_patterns": [
      "Problema inicial -> conceptos clave -> marco normativo/doctrinal -> análisis propio -> conclusión.",
      "Descripción breve -> contraste de fuentes -> postura personal razonada.",
      "Consistencia entre pregunta guía, desarrollo y cierre."
    ],
    "knowledge_graph": {
      "concepts": [
      ...
      "relations": [
        {
          ...
          "kind": "depends_on",
          "justification": "El encuadre del problema activa el análisis en la estructura editorial."
        },
        {
          "source": "Conceptos, normas y doctrina",
          "target": "Postura argumentada del estudiante",
          "kind": "supports",
          "justification": "La postura debe sustentarse con marco conceptual y fuentes verificables."
        },
        {
          "source": "Hermenéutica e interpretación jurídica",
          "target": "Argumentación jurídica",
          "kind": "develops",
          "justification": "Las fuentes SCJN y doctrinales fortalecen el razonamiento jurídico."
        },
        {
          "source": "Conclusión jurídica",
          "target": "Práctica profesional",
          "kind": "supports",
          "justification": "La conclusión debe ser transferible al ejercicio del Derecho."
        }
      ],
      "evidence": [
        ...
        "filosofia-del-derecho-clean.bib: evidencia de que corresponde a Semana 7 [supuesto confirmado por encabezado del archivo]."
      ]
    },
    "reinforcement_log": [
      "Ciclo 58: deduplicación integral aplicada sin eliminar reglas útiles.",
      "Ciclo 58: se preserva ADN editorial completo y TEX reconstruible.",
      "Ciclo 58: se refuerza la distinción entre bibliografía base y bibliografía específica de actividad.",
      "Ciclo 58: se mantiene política de supuestos explícitos por falta de consigna textual."
    ]
  }
}
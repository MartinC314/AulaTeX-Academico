{
  ...
  "editorial_dna": {
    ...
    "essence": [
      ...
      "Normalizacion previa a propagacion."
    ],
    "reason_for_being": [
      "Convertir planeacion semanal en productos academicos trazables.",
      "Asegurar consistencia institucional y rigor juridico.",
      "Permitir propagacion segura entre nodos sin perdida de reglas."
    ],
    "style_markers": [
    ...
    "reinforcement_log": [
      "Ciclo 7: se refuerza transferencia por analogia controlada entre hermanos.",
      "Ciclo 7: se depuran duplicados semanticos sin recorte de reglas utiles.",
      "Ciclo 7: se mantiene provisionalidad de fuentes no verificadas.",
      "Ciclo 7: se evita migrar bibliografia exclusiva de actividad-1."
    ]
  }
}
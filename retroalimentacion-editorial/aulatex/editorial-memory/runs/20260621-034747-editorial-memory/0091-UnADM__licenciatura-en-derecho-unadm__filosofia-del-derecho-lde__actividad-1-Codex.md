{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Conservar trazabilidad entre consigna, evidencia, argumentación y cierre jurídico aplicable."
    ],
    "style_markers": [
      "Objetivo explícito al inicio.",
      "Secciones con jerarquía estable.",
      "Citas verificables y consistentes con .bib.",
      "Supuestos etiquetados cuando falten datos."
    ],
    "argumentative_patterns": [
      "Problematizar primero, definir conceptos después.",
      "Vincular marco normativo con doctrina y caso.",
      "Distinguir descripción de toma de postura.",
      ...
      "relations": [
        {
          ...
          "kind": "develops",
          "justification": "La secuencia editorial exige pasar de planteamiento del problema a análisis propio."
        },
        {
          "source": "Conceptos, normas y doctrina",
          "target": "Postura argumentada",
          "kind": "supports",
          "justification": "La postura debe sostenerse con marco conceptual y evidencia verificable."
        },
        {
          "source": "Consigna de Actividad 1",
          "target": "Tipo de artefacto",
          "kind": "depends_on",
          "justification": "El formato final se alinea a la planeación semanal."
        },
        {
          "source": "Conclusión jurídica",
          "target": "Práctica profesional",
          "kind": "develops",
          "justification": "El cierre debe ser transferible al ejercicio jurídico."
        }
      ],
      "evidence": [
    ...
    "reinforcement_log": [
      "Ciclo 91: deduplicación completa de reglas semánticamente equivalentes.",
      "Ciclo 91: preservación de ADN editorial sin recorte de capacidad reconstructiva.",
      "Ciclo 91: refuerzo de trazabilidad consigna-producto-citas-conclusión.",
      "Ciclo 91: se mantiene supuesto explícito sobre ausencia de consigna textual."
    ]
  }
}
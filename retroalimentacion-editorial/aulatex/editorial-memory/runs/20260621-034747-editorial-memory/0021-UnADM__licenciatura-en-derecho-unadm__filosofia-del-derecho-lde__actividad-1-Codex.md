{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Conservar coherencia entre consigna, desarrollo, citas y conclusión."
    ],
    "style_markers": [
      "Inicio con encuadre del problema.",
      "Desarrollo por secciones jurídicas explícitas.",
      "Cierre con criterio propio y aplicabilidad profesional.",
      "Marca explícita de supuestos cuando falte dato verificable."
    ],
    "argumentative_patterns": [
      "Problema -> conceptos -> marco normativo/doctrinal -> análisis propio -> conclusión jurídica.",
      "Afirmación -> evidencia verificable -> interpretación -> postura del estudiante.",
      "Consigna semanal -> tipo de producto -> validación de cumplimiento."
    ],
    "knowledge_graph": {
      "concepts": [
      ...
      "relations": [
        ...
        },
        {
          ...
          "kind": "depends_on",
          "justification": "La estructura editorial exige partir de un problema para argumentar."
        },
        {
          "source": "Marco normativo/doctrinal",
          "target": "Conclusión jurídica transferible",
          "kind": "supports",
          "justification": "La conclusión debe derivar de evidencia y fundamento jurídico."
        },
        {
          "source": "Hermenéutica e interpretación jurídica",
          "target": "Argumentación jurídica",
          "kind": "supports",
          "justification": "Fuentes locales de SCJN y UNAM refuerzan este puente conceptual."
        }
      ],
      "evidence": [
        ...
        "filosofia-del-derecho.bib y filosofia-del-derecho-clean.bib (con alcance diferenciado)."
      ]
    },
    "reinforcement_log": [
      "Ciclo 21: deduplicación semántica y preservación total de reglas útiles.",
      "Ciclo 21: se mantiene la restricción de JSON parseable como puerta de calidad.",
      "Ciclo 21: se refuerza separación entre bibliografía de Actividad 1 y Semana 7 como supuesto verificable.",
      "Ciclo 21: se conserva ADN argumentativo y trazabilidad a fuentes locales."
    ]
  }
}
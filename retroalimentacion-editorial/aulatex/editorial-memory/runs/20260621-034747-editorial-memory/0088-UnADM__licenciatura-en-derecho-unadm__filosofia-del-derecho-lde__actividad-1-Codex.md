{
  ...
  "editorial_dna": {
    ...
    "style_markers": [
      ...
      "Sostener afirmaciones con citas verificables y consistentes con .bib."
    ],
    "argumentative_patterns": [
      "Problema inicial breve -> marco conceptual y normativo -> análisis propio -> conclusión jurídica.",
      "De lo descriptivo a lo crítico con postura personal explícita.",
      ...
      "relations": [
        {
          ...
          "kind": "depends_on",
          "justification": "El análisis se activa por una pregunta o conflicto inicial."
        },
        {
          "source": "Marco normativo/doctrinal",
          "target": "Conclusión jurídica",
          "kind": "supports",
          "justification": "La conclusión válida exige fundamento normativo y doctrinal."
        },
        {
          "source": "Hermenéutica e interpretación jurídica",
          "target": "Argumentación jurídica",
          "kind": "develops",
          "justification": "La interpretación fortalece la justificación de premisas y cierre."
        },
        {
          "source": "Derecho y moral",
          "target": "Justicia",
          "kind": "contrasts",
          "justification": "El eje filosófico distingue validez jurídica y juicio moral."
        }
      ],
      "evidence": [
    ...
    "reinforcement_log": [
      "Se deduplicaron reglas redundantes con variantes ortográficas sin pérdida semántica.",
      "Se preservó el estado provisional de fuentes heredadas no verificadas.",
      "Se mantuvo compatibilidad con TEX reconstruible y claves BibTeX existentes.",
      "Se reforzó separación entre bibliografía base de asignatura y bibliografía específica de actividad.",
      "Se mantuvo el ADN argumentativo institucional del nodo en modo canonización-local."
    ]
  }
}
{
  ...
  "editorial_dna": {
    ...
    "essence": [
      ...
      "Estructura argumentativa trazable.",
    ...
    "reason_for_being": [
      ...
      "Garantizar coherencia entre problema, fuentes, analisis y cierre.",
      "Sostener calidad editorial reutilizable entre actividades hermanas."
    ],
    "style_markers": [
    ...
    "knowledge_graph": {
      ...
      "relations": [
        ...
        },
        {
          ...
          "target": "Actividad 2",
          "kind": "develops",
          "justification": "Son patrones reutilizables por analogia controlada."
        }
      ],
      "evidence": [
    ...
    "reinforcement_log": [
      "Ciclo 4: se refuerzan patrones compartidos entre actividades hermanas.",
      "Se deduplican reglas repetidas y se preserva contenido valido sin recorte.",
      "Se retiran transferencias no reutilizables de actividad-1 a nivel de contenido especifico.",

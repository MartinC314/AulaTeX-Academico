{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Estandarizar calidad argumentativa y trazabilidad de evidencia en Actividad 1."
    ],
    "style_markers": [
      "Apertura con encuadre del problema.",
      "Desarrollo con conceptos y marco normativo/doctrinal.",
      "Postura personal explícita.",
      "Cierre con conclusión jurídica aplicable."
    ],
    "argumentative_patterns": [
      "Problema inicial -> conceptos clave -> evidencia -> análisis propio -> conclusión jurídica.",
      "Cada afirmación sustantiva se acompaña de cita o marca de supuesto.",
      "La conclusión responde la pregunta guía y no introduce tesis nuevas."
    ],
    "knowledge_graph": {
      "concepts": [
      ...
      "relations": [
        ...
        },
        {
          ...
          "kind": "depends_on",
          "justification": "El patrón editorial exige fundamentar postura con nociones previas."
        },
        {
        ...
        },
        {
          ...
          "kind": "supports",
          "justification": "La interpretación sustenta la justificación de tesis."
        }
      ],
      "evidence": [
        ...
        "filosofia-del-derecho-clean.bib: marcado como Semana 7, no canónico para Actividad 1."
      ]
    },
    "reinforcement_log": [
      "Ciclo 25: deduplicación integral sin pérdida de reglas útiles.",
      "Ciclo 25: se preserva ADN editorial y estructura argumentativa base.",
      "Ciclo 25: se refuerza distinción entre bibliografía de actividad y bibliografía de Semana 7.",
      "Ciclo 25: se mantiene control estricto de JSON parseable como puerta de calidad."
    ]
  }
}
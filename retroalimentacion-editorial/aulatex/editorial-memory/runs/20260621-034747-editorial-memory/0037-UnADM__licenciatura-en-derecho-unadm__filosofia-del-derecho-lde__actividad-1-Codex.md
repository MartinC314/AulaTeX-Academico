{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Asegurar entregables útiles para práctica profesional y evaluación institucional."
    ],
    "style_markers": [
      "Apertura con encuadre del problema.",
      "Desarrollo por secciones funcionales.",
      "Uso explícito de fuentes y citas.",
      "Cierre con tesis jurídica aplicable.",
      "Marcado explícito de supuestos cuando falte dato."
    ],
    "argumentative_patterns": [
      "Planteamiento del problema -> marco conceptual/normativo -> análisis propio -> conclusión jurídica.",
      ...
      "relations": [
        {
          ...
          "kind": "develops",
          "justification": "El programa analítico exige convertir el problema en argumento propio."
        },
        {
          "source": "Marco normativo/doctrinal",
          "target": "Conclusión jurídica transferible",
          "kind": "supports",
          "justification": "La conclusión debe estar fundada en normas y doctrina citadas."
        },
        {
          "source": "Hermenéutica e interpretación jurídica",
          "target": "Argumentación jurídica",
          "kind": "depends_on",
          "justification": "La interpretación de textos jurídicos sostiene la calidad del argumento."
        },
        {
          "source": "Derecho y moral",
          "target": "Justicia",
          "kind": "contrasts",
          "justification": "El análisis filosófico compara validez formal y contenido ético."
        }
      ],
      "evidence": [
        "README.md: identidad institucional y pauta editorial.",
        "programa-analitico-filosofia-del-derecho.md: propósito, ejes y flujo de trabajo.",
    ...
    "reinforcement_log": [
      "Ciclo 37: deduplicación integral aplicada sin recorte semántico.",
      "Ciclo 37: normalizadas variantes ortográficas y de acentuación en reglas equivalentes.",
      "Ciclo 37: preservada trazabilidad de fuentes locales y estado de supuestos.",
      "Ciclo 37: reforzada relación entre ejes editoriales y patrón argumentativo.",
      "Ciclo 37: mantenida compatibilidad con TEX primario reconstruible."
    ]
  }
}
{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Asegurar trazabilidad entre consigna, desarrollo, evidencia y conclusion."
    ],
    "style_markers": [
    ...
    "reinforcement_log": [
      "Ciclo 70: se deduplican reglas repetidas sin perdida semantica.",
      "Ciclo 70: se preservan reglas utiles previas y se eliminan duplicados literales.",
      "Ciclo 70: se evita copiar contenido exclusivo de actividad-1; se transfieren solo patrones.",
      "Ciclo 70: se mantienen supuestos explicitados cuando falta evidencia local."
    ]
  }
}
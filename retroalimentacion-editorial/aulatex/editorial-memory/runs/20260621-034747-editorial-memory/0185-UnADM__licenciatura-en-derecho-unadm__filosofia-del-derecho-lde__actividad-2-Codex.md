{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Sostener calidad editorial estable entre actividades hermanas sin perder contexto local."
    ],
    "style_markers": [
    ...
    "knowledge_graph": {
      ...
      "evidence": [
        "README exige identidad UnADM, citas verificables y conclusion juridica propia.",
    ...
    "reinforcement_log": [
      "Ciclo 85: deduplicacion lossless aplicada sin recorte de reglas utiles.",
      "Ciclo 85: reforzada separacion entre patrones transferibles y contenido exclusivo de actividad-1.",
      "Ciclo 85: mantenida normalizacion obligatoria para herencias no estructuradas."
    ]
  }
}
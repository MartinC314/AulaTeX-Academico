{
  ...
  "editorial_dna": {
    ...
    "essence": [
      ...
      "Conceptos y marco juridico pertinentes.",
    ...
    "reason_for_being": [
      ...
      "Asegurar trazabilidad entre afirmacion, fuente y conclusion.",
    ...
    "knowledge_graph": {
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "Define tono, finalidad y criterios de cierre."
        },
        {
      ...
      "evidence": [
        "README fija identidad UnADM, integridad y cierre juridico.",
        "Programa analitico define proposito y ejes de trabajo.",
        "Regla historica valida: bloquear propagacion sin JSON parseable."
      ]
    },
    "reinforcement_log": [
      "Ciclo 81: deduplicacion completa de reglas repetidas.",
      "Ciclo 81: preservada regla de normalizacion previa a propagacion.",
      "Ciclo 81: reforzada separacion entre patrones transferibles y contenido especifico de hermano.",
      "Ciclo 81: mantenido caracter provisional de fuentes no verificadas."
    ]
  }
}
{
  ...
  "editorial_dna": {
    ...
    "style_markers": [
      "Enfoque por problema jurídico.",
      "Separación explícita entre marco conceptual y postura propia.",
      "Cierre con implicación profesional.",
      "Marcado explícito de supuestos cuando falte dato en consigna."
    ],
    "argumentative_patterns": [
      "Problema inicial breve.",
      "Definición de conceptos clave.",
      "Vinculación con norma o doctrina.",
    ...
    "knowledge_graph": {
      ...
      "relations": [
        ...
        },
        {
          ...
          "target": "Justicia",
          "kind": "depends_on",
          "justification": "La argumentación jurídica conecta validez normativa y justificación material."
        },
        {
          "source": "Hermenéutica e interpretación jurídica",
          "target": "Análisis propio y postura académica",
          "kind": "supports",
          "justification": "La interpretación fundamenta la toma de postura jurídica."
        },
        {
          "source": "Constitución y leyes generales vigentes",
          "target": "Conclusión jurídica transferible",
          "kind": "supports",
          "justification": "El cierre debe sostenerse en marco normativo verificable."
        }
      ],
      "evidence": [
    ...
    "reinforcement_log": [
      "Ciclo 8: deduplicación semántica y ortográfica completada sin eliminar reglas útiles.",
      "Ciclo 8: se preserva compatibilidad con TEX reconstruible y claves BibTeX existentes.",
      "Ciclo 8: se refuerza distinción entre bibliografía base de asignatura y bibliografía específica de actividad.",
      "Ciclo 8: se mantiene bloqueo de propagación ante salidas no JSON parseables."
    ]
  }
}
{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Asegurar trazabilidad entre consigna, desarrollo, citas y conclusión."
    ],
    "style_markers": [
      "Abrir con encuadre del problema.",
      "Delimitar objetivo y ruta argumentativa.",
      "Usar secciones explícitas y cierre jurídico aplicable.",
      "Marcar supuestos cuando falte dato en consigna."
    ],
    "argumentative_patterns": [
      "Problema -> conceptos y marco -> análisis propio -> conclusión.",
      "Afirmación -> evidencia verificable -> interpretación jurídica.",
      "Descripción mínima y valoración crítica explícita."
    ],
    "knowledge_graph": {
      "concepts": [
      ...
      "relations": [
        ...
        },
        {
          ...
          "kind": "supports",
          "justification": "Aporta base normativa primaria verificable."
        }
      ],
      "evidence": [
        ...
        "filosofia-del-derecho-clean.bib: evidencia de enfoque Semana 7 (supuesto explícito para no mezclar con Actividad 1)."
      ]
    },
    "reinforcement_log": [
      "Se deduplicaron variantes ortográficas y acentuales sin pérdida semántica.",
      "Se preservaron reglas útiles previas y se compactaron por unión.",
      "Se reforzó la separación entre bibliografía base y bibliografía por actividad.",
      "Se mantuvo la regla de bloqueo por JSON no parseable como compuerta crítica.",
      "Se conservaron supuestos explícitos donde no hay consigna textual verificable."
    ]
  }
}
{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Convertir consigna en entrega verificable sin perder identidad UnADM.",
      "Preservar trazabilidad entre TEX, citas y reglas editoriales."
    ],
    "style_markers": [
      "Encuadre inicial breve del problema.",
      "Seccionado estable: conceptos, marco, análisis, cierre.",
    ...
    "argumentative_patterns": [
      ...
      "Afirmación -> evidencia verificable -> interpretación -> postura propia.",
      "Coherencia estricta entre pregunta guía, desarrollo y cierre."
    ],
    "knowledge_graph": {
      "concepts": [
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "El problema delimita el enfoque argumentativo de la actividad."
        },
        {
        ...
        },
        {
          ...
          "kind": "develops",
          "justification": "La interpretación sustenta la lectura crítica de casos y normas."
        },
        {
          "source": "Derecho y moral",
          "target": "Justicia",
          "kind": "contrasts",
          "justification": "La tensión entre validez jurídica y valor moral fortalece el juicio crítico."
        }
      ],
      "evidence": [
        "README.md: ubicación curricular, pauta editorial e identidad institucional.",
        ...
        "filosofia-del-derecho-clean.bib: fuente temática de Semana 7, no canónica para Actividad 1."
      ]
    },
    "reinforcement_log": [
      "Ciclo 32: deduplicación semántica aplicada sin pérdida de reglas útiles.",
      "Ciclo 32: se preserva ADN editorial completo y TEX reconstruible.",
      "Ciclo 32: se refuerza distinción entre bibliografía base y específica de actividad.",
      "Ciclo 32: se mantiene bloqueo por JSON inválido como compuerta crítica de calidad."
    ]
  }
}
  ...
  "editorial_dna": {
    ...
    "knowledge_graph": {
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "Define tono, finalidad y marco comun."
        },
        {
      ...
      "evidence": [
        ...
        "Transferencia lateral aplicada sin copiar contenido exclusivo del hermano."
      ]
    },
    "reinforcement_log": [
      "Ciclo 29: refuerzo lateral por analogia controlada aplicado.",
      "Se conservaron reglas validas previas sin recorte.",
      "Se eliminaron duplicados semanticos manteniendo cobertura total.",
      "Se preservo caracter provisional de fuentes heredadas no verificadas."
    ]
  }
}
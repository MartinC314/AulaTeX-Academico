{
  ...
  "editorial_dna": {
    ...
    "essence": [
      "Producto juridico verificable con trazabilidad de fuentes.",
      "Secuencia fija: problema, fundamento, analisis, evidencia, postura y cierre.",
      "Transferencia lateral por patrones, no por copia tematica."
    ],
    "reason_for_being": [
      "Convertir cada consigna en entrega academica valida, verificable y profesional.",
      "Sostener continuidad editorial entre actividades sin perder contexto local.",
      "Evitar regresiones de calidad en propagacion recursiva."
    ],
    "style_markers": [
    ...
    "knowledge_graph": {
      "concepts": [
        ...
        "Consistencia editorial y control de calidad"
      ],
      "citations": [
        "unadmSitioWeb",
      ...
      "relations": [
        ...
        },
        {
          ...
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Operacionaliza prestaciones y mecanismos del regimen correspondiente."
        },
        {
          "source": "Ley del ISSSTE",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Regula cobertura del sector publico."
        },
        {
          "source": "Universalidad",
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Sirve para evaluar alcance real y exclusion."
        },
        {
          "source": "Progresividad",
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Permite medir avances, retrocesos y obligaciones estatales."
        },
        {
          "source": "Consistencia editorial y control de calidad",
          "target": "Producto juridico verificable",
          "kind": "depends_on",
          "justification": "La validez formal depende de estructura, citas y JSON correcto."
        }
      ],
      "evidence": [
        "README local: estructura canonica y control editorial.",
        "Programa analitico local: proposito y ejes de trabajo.",
        "derecho-a-la-seguridad-social.bib: base de fuentes verificables.",
        "Regla persistente: bloquear propagacion con JSON invalido."
      ]
    },
    "reinforcement_log": [
      "Se deduplicaron reglas repetidas manteniendo cobertura funcional completa.",
      "Se reforzo la frontera lateral: transferir patrones, no contenido exclusivo del hermano.",
      "Se conservaron puertas de calidad como nucleo no negociable.",
      "Se mantuvo compatibilidad con artefactos reporte/presentacion del nodo destino.",
      "Se registraron supuestos abiertos por falta de consigna completa."
    ]
  }
}
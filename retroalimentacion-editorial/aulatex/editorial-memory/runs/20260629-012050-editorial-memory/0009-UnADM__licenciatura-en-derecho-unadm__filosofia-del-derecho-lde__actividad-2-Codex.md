{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Asegurar fundamento juridico y claridad argumentativa.",
      "Conservar continuidad editorial entre actividades hermanas sin contaminar contenido."
    ],
    "style_markers": [
    ...
    "argumentative_patterns": [
      ...
      "Consigna local -> adecuacion del formato -> control de calidad final."
    ],
    "knowledge_graph": {
      "concepts": [
      ...
      "relations": [
        ...
        },
        {
          ...
          "target": "Actividad 2",
          "kind": "develops",
          "justification": "Son patrones recurrentes reutilizables entre hermanos."
        }
      ],
      "evidence": [
        "README fija identidad, integridad academica y conclusion juridica.",
        "Programa analitico fija proposito y ejes de trabajo transferibles.",
        "Regla vigente: bloquear propagacion sin JSON parseable.",
        "Regla vigente: union-dedupe lossless sin recorte."
      ]
    },
    "reinforcement_log": [
      "Ciclo 1: se transfieren patrones de actividad-1 a actividad-2 por analogia controlada.",
      "Ciclo 1: se evita copiar contenido especifico de actividad-1.",
      "Ciclo 1: se refuerza gate de JSON parseable y normalizacion previa.",
      "Ciclo 1: se conserva caracter provisional de fuentes no verificadas localmente."
    ]
  }
}
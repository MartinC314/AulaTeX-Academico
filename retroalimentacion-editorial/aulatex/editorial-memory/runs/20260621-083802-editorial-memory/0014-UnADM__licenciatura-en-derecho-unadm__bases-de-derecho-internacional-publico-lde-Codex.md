{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Garantizar trazabilidad editorial y consistencia tecnica antes de cualquier propagacion."
    ],
    "style_markers": [
    ...
    "knowledge_graph": {
      ...
      "relations": [
        ...
        },
        {
          ...
          "kind": "depends_on",
          "justification": "Sin correspondencia de claves no hay verificacion academica completa."
        },
        {
          "source": "Identidad institucional UnADM",
          "target": "Estructura argumentativa juridica",
          "kind": "develops",
          "justification": "La identidad institucional fija tono, formato y rigor del desarrollo."
        }
      ],
      "evidence": [
    ...
    "reinforcement_log": [
      "Ciclo 14: se refuerza transferencia transversal de abstracciones estables sin contenido tematico ajeno.",
      "Ciclo 14: se mantiene regla dura de bloqueo por JSON no parseable.",
      "Ciclo 14: se conserva estrategia conservadora y sin regresion de reglas utiles previas.",
      "Ciclo 14: se agregan incidencias tecnicas locales verificables (Slug sin expandir y tabular truncado) como pendientes de saneamiento."
    ]
  }
}
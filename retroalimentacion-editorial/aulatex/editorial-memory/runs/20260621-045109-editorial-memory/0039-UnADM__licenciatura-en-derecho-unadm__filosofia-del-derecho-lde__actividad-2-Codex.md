{
  ...
  "editorial_dna": {
    ...
    "knowledge_graph": {
      ...
      "evidence": [
        "README define identidad UnADM e integridad academica.",
        "Programa analitico fija proposito y ejes de trabajo.",
        "Regla persistente: bloquear propagacion sin JSON parseable.",
        "Transferencia entre hermanos limitada a patrones, no a contenido especifico."
      ]
    },
    "reinforcement_log": [
      "Ciclo 39: se refuerza herencia lateral controlada desde actividad-1.",
      "Ciclo 39: se deduplican reglas repetidas sin perdida semantica.",
      "Ciclo 39: se mantiene caracter provisional de datos no verificados.",
      "Ciclo 39: se preserva gate de JSON parseable como condicion de propagacion."
    ]
  }
}
{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Mantener continuidad editorial entre actividades sin copiar contenido especifico."
    ],
    "style_markers": [
    ...
    "knowledge_graph": {
      ...
      "evidence": [
        ...
        "Transferencia de hermano aplicada sin copiar contenido exclusivo."
      ]
    },
    "reinforcement_log": [
      "Ciclo 67: se refuerza transferencia lateral por analogia controlada.",
      "Ciclo 67: se deduplican reglas repetidas manteniendo cobertura total.",
      "Ciclo 67: se conserva provisionalidad de fuentes heredadas no verificadas.",
      "Ciclo 67: se mantiene compresion lossless por union-dedupe."
    ]
  }
}
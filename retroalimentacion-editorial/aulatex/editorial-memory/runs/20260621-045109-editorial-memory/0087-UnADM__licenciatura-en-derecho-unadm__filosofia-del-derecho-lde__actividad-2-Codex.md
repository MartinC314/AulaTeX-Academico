{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Garantizar calidad editorial consistente entre actividades hermanas.",
      "Preservar memoria institucional sin perdida semantica."
    ],
    "style_markers": [
    ...
    "reinforcement_log": [
      "Ciclo 87: refuerzo lateral aplicado con analogia controlada.",
      "Se deduplican reglas repetidas y se preserva cobertura util.",
      "Se excluye transferencia de conclusiones y bibliografia exclusiva de actividad-1.",
      "Se mantienen supuestos explicitos donde faltan datos locales."
    ]
  }
}
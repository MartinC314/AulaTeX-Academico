{
  "summary": [
    "Se consolida refuerzo lateral ciclo 2 con transferencia solo de patrones reutilizables.",
    ...
    "Se aplica compresión lossless por deduplicación, sin recorte de reglas útiles previas."
  ],
  "identity_rules": [
  ...
  "activity_rules": [
    ...
    "No asumir fuentes de otras semanas sin validación local de pertinencia."
  ],
  "quality_gates": [
  ...
  "editorial_dna": {
    ...
    "essence": [
      "Problema jurídico o social claramente delimitado.",
      "Fundamento normativo y doctrinal verificable.",
      "Análisis propio con postura argumentada.",
      "Evidencia trazable en fuentes y citas.",
      "Cierre profesional transferible a práctica jurídica."
    ],
    "reason_for_being": [
      "Convertir cada consigna en producto jurídico verificable.",
      "Mantener coherencia entre identidad institucional, rigor técnico y utilidad profesional.",
      "Evitar regresiones editoriales entre nodos laterales."
    ],
    "style_markers": [
      "Objetivo puntual al inicio.",
      "Secciones claras y trazables.",
      "Marcado explícito de supuestos.",
      "Conclusión no descriptiva y jurídicamente accionable."
    ],
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "Define fundamento superior del derecho."
        },
        {
          "source": "Ley del Seguro Social",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "Operativiza cobertura y prestaciones del régimen."
        },
        {
        ...
        },
        {
          ...
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Permite valorar avances y posibles retrocesos."
        },
        {
          "source": "Consigna de Actividad 1",
          "target": "Producto académico final",
          "kind": "depends_on",
          "justification": "Define formato, profundidad y evidencias exigidas."
        }
      ],
      "evidence": [
        "README local: estructura canónica y control editorial.",
        "Programa analítico local: propósito y ejes de trabajo.",
        "derecho-a-la-seguridad-social.bib: base verificable de fuentes.",
        "Supuesto explícito de falta de consigna completa para Actividad 1."
      ]
    },
    "reinforcement_log": [
      "Ciclo 2: deduplicación completa de reglas repetidas en identidad, estructura, actividad y calidad.",
      "Ciclo 2: se preservan todas las reglas útiles previas sin eliminación regresiva.",
      "Ciclo 2: se refuerza transferencia lateral solo de patrones reutilizables, sin contenido temático exclusivo del origen.",
      "Ciclo 2: se corrige el grafo a tipos de relación permitidos y se elimina ruido de cohesión no editorial."
    ]
  }
}
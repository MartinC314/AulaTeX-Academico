{
  "summary": [
    ...
    "Se mantiene normalización estructurada obligatoria antes de cualquier propagación recursiva.",
    "Se fija compresión lossless por unión y deduplicación, sin recorte de reglas útiles.",
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Conservar continuidad editorial institucional sin perder precisión local.",
      "Permitir propagación recursiva segura mediante estructura normalizada."
    ],
    "style_markers": [
      "Objetivo puntual al inicio.",
      "Secciones claras y trazables.",
      "Marcado explícito de supuestos.",
      "Conclusión jurídica no meramente descriptiva."
    ],
    ...
    "knowledge_graph": {
      ...
      "relations": [
        ...
        },
        {
          ...
          "kind": "supports",
          "justification": "Permite evaluar inclusión y barreras reales."
        },
        {
          "source": "Progresividad",
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Permite valorar avances y evitar retrocesos."
        }
      ],
      "evidence": [
        ...
        "Regla persistente de bloqueo por JSON inválido."
      ]
    },
    "reinforcement_log": [
      "Ciclo 13: deduplicación integral aplicada sin eliminar reglas útiles.",
      "Ciclo 13: se mantiene transferencia lateral controlada solo de patrones reutilizables.",
      "Ciclo 13: se preserva normalización estructurada como puerta obligatoria de propagación."
    ]
  }
}
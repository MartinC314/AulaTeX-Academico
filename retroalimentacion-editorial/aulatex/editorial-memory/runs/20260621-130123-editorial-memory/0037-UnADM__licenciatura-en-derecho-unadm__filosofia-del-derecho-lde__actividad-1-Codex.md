{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Asegurar trazabilidad editorial entre consigna, argumentación y cierre profesional."
    ],
    "style_markers": [
      "Enunciados directos y verificables.",
      "Uso explícito de supuestos cuando falte evidencia local.",
    ...
    "argumentative_patterns": [
      ...
      "Anclar análisis en marco normativo o doctrinal.",
      "Contrastar fuentes y sostener postura propia.",
      "Concluir con implicación jurídica concreta."
    ],
    "knowledge_graph": {
      "concepts": [
      ...
      "relations": [
        ...
        },
        {
          ...
          "kind": "supports",
          "justification": "La conclusión requiere sustento normativo y doctrinal verificable."
        },
        {
        ...
        },
        {
          ...
          "kind": "develops",
          "justification": "Eje conceptual central de la asignatura."
        }
      ],
      "evidence": [
        "README.md: identidad UnADM, ubicación curricular y pauta editorial.",
        "programa-analitico-filosofia-del-derecho.md: propósito, ejes y regla de bibliografía por actividad.",
        "reporte-filosofia-del-derecho-Actividad-1.tex: fuente reconstruible local con 79 bloques."
      ]
    },
    "reinforcement_log": [
      "Ciclo 10: deduplicación integral aplicada sin pérdida semántica.",
      "Ciclo 10: se conserva ADN editorial completo y TEX reconstruible.",
      "Ciclo 10: se refuerza control de supuestos y verificación local de fuentes.",
      "Ciclo 10: se mantiene separación entre bibliografía base y bibliografía específica de actividad."
    ]
  }
}
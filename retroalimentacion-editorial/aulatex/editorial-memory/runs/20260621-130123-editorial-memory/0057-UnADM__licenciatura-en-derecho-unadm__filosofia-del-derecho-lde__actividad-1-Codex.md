{
  ...
  "editorial_dna": {
    ...
    "reason_for_being": [
      ...
      "Garantizar consistencia entre consigna, desarrollo argumentativo y cierre jurídico.",
      "Preservar memoria editorial reconstruible y verificable."
    ],
    "style_markers": [
      "Encuadre inicial breve y preciso.",
      "Secciones explícitas y ordenadas.",
      "Uso de citas verificables en cada afirmación sustantiva.",
    ...
    "argumentative_patterns": [
      ...
      "Contrastar fuentes y sostener postura personal fundada.",
      "Evitar descripción plana sin toma de posición."
    ],
    "knowledge_graph": {
      "concepts": [
      ...
      "relations": [
        ...
        },
        {
          ...
          "kind": "supports",
          "justification": "Las fuentes SCJN y UNAM sostienen técnicas de justificación jurídica."
        },
        {
          "source": "Constitución y leyes generales",
          "target": "Conclusión jurídica transferible",
          "kind": "depends_on",
          "justification": "La conclusión exige anclaje normativo verificable."
        },
        {
          "source": "Derecho y moral",
          "target": "Postura argumentada del estudiante",
          "kind": "supports",
          "justification": "El eje filosófico exige criterio propio más allá del resumen."
        }
      ],
      "evidence": [
        ...
        "filosofia-del-derecho-clean.bib identificado como Semana 7 [Supuesto aplicado a Actividad 1]."
      ]
    },
    "reinforcement_log": [
      "Ciclo 15: deduplicación ortográfica y semántica aplicada sin eliminar reglas útiles.",
      "Ciclo 15: se mantuvo integridad del ADN editorial y patrón argumentativo central.",
      "Ciclo 15: se reforzó control de supuestos por ausencia de consigna textual local.",
      "Ciclo 15: se preservó compatibilidad LaTeX/BibTeX y trazabilidad de claves."
    ]
  }
}
{
  "summary": [
    ...
    "Se preservan reglas utiles vigentes del destino y se deduplican sin recorte.",
    "Se corrige el estado de contingencia: el origen si aporta JSON parseable y reglas verificables.",
  ...
  "identity_rules": [
    ...
    "Marcar como [Supuesto] todo dato no visible en la consigna puntual.",
  ...
  "propagation_hints": [
    ...
    "Transferir entre nodos laterales solo patrones generales, no conclusiones ni redaccion literal.",
    "Si falta consigna textual local, mantener estructura base y abrir preguntas en lugar de inventar.",
    "Conservar historial de incidencias de parseo por ciclo como trazabilidad operativa."
  ],
  "open_questions": [
    ...
    "Confirmar si hay fuentes obligatorias de la semana no reflejadas en el .bib actual.",
    "Definir criterio canonico unico para fusionar claves bibliograficas duplicadas existentes."
  ],
  "editorial_dna": {
    "identity": {
      "tone": [
    ...
    "reason_for_being": [
      ...
      "Asegurar continuidad editorial entre actividades y asignaturas afines sin perder identidad local."
    ],
    "style_markers": [
    ...
    "knowledge_graph": {
      ...
      "relations": [
        ...
        },
        {
          ...
          "kind": "depends_on",
          "justification": "La postura argumentada valida requiere fuentes comprobables."
        },
        {
        ...
        },
        {
          ...
          "target": "Moral",
          "kind": "contrasts",
          "justification": "Eje transversal esperable de la asignatura destino. [Supuesto]"
        }
      ],
      "evidence": [
        "README de Etica y Moral juridica: identidad, ubicacion curricular y pauta editorial.",
        "Programa analitico: proposito y ejes de trabajo comunes.",
        "etica-y-moral-juridica.bib: fuentes base y duplicados detectables.",
        "Memoria origen parseable: reglas de estructura, calidad y argumentacion transferibles."
      ]
    },
    "reinforcement_log": [
      "Ciclo 16: se elimina supuesto de ausencia de origen parseable y se sustituye por transferencia verificada.",
      "Ciclo 16: se refuerzan reglas nucleares compartidas sin copiar contenido especifico de Filosofia del Derecho.",
      "Ciclo 16: se mantiene deduplicacion lossless y trazabilidad de decisiones editoriales."
    ]
  }
}
{
  "summary": [
    "Se consolida refuerzo lateral desde Filosofía del Derecho hacia Derecho a la Seguridad Social con transferencia de patrones reutilizables.",
  ...
  "editorial_dna": {
    ...
    "essence": [
      "Resolver consignas con trazabilidad jurídica verificable.",
      "Integrar fundamento normativo, análisis propio y evidencia.",
      "Conectar teoría con implicación profesional concreta."
    ],
    "reason_for_being": [
      "Transformar cada consigna en un producto jurídico verificable: problema, fundamento, análisis, evidencia, postura y cierre profesional."
    ],
    "style_markers": [
      ...
      "relations": [
        {
          ...
          "kind": "supports",
          "justification": "El programa analítico local fija el fundamento constitucional como eje."
        },
        {
          "source": "Ley del Seguro Social",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "La ley concreta prestaciones y mecanismos institucionales."
        },
        {
          "source": "Ley del ISSSTE",
          "target": "Derecho a la seguridad social",
          "kind": "develops",
          "justification": "La ley regula la cobertura de personas servidoras públicas."
        },
        {
        ...
        },
        {
          ...
          "target": "Acceso, cobertura y justiciabilidad",
          "kind": "supports",
          "justification": "Permite valorar avances y retrocesos en garantía del derecho."
        }
      ],
      "evidence": [
        ...
        "Regla institucional: bloqueo de propagación sin JSON parseable."
      ]
    },
    "reinforcement_log": [
      "Ciclo 5: deduplicación de reglas repetidas y conservación de reglas válidas previas.",
      "Ciclo 5: refuerzo lateral limitado a patrones reutilizables, sin transferencia temática exclusiva.",
      "Ciclo 5: se mantiene normalización estructurada obligatoria antes de propagación recursiva."
    ]
  }
}
...
% Presentación visual del reporte de lectura
...
La vigencia de esta discusión reside en una tensión decisiva: el acceso creciente a información no garantiza comprensión, autonomía ni participación responsable. Cuando la enseñanza conserva una lógica uniforme y reproductiva, limita la capacidad de interpretar evidencias, relacionar saberes y actuar ante situaciones nuevas; por ello, currículo, pedagogía y evaluación deben responder de manera articulada a la complejidad contemporánea.

La reforma educativa no debe comenzar por la herramienta, sino por el tipo de actividad intelectual y social que se desea producir. La tecnología puede ampliar la participación, la personalización y el acceso; sin embargo, solo genera valor educativo cuando se articula con propósitos formativos, mediación docente y evaluación congruente.

\section{De la transmisión al aprendizaje para la complejidad}

\subsection{Lectura crítica de la propuesta de Scott}

\begin{reportelecturabox}
\begin{spacing}{1.25}
...
\medskip\noindent\textbf{De la transmisión a la formación para la complejidad.}\enspace
...
\medskip\noindent\textbf{Fuerzas que impulsan el cambio.}\enspace
...
\medskip\noindent\textbf{Transformación del papel docente y de la experiencia escolar.}\enspace
...
\medskip\noindent\textbf{Tecnología: medio y no finalidad.}\enspace
...
\medskip\noindent\textbf{Implicaciones para currículo y evaluación.}\enspace
...
\pagestyle{empty}
\begin{landscape}
\subsection{Relaciones que configuran la transformación educativa}
\begin{figure}[ht]
\centering
...
\caption{Transformación del aprendizaje en el siglo XXI. Elaboración propia a partir de \citet{scott2015futuro}, con la técnica de \citet{lopez2022mapa}.}
...
\subsection{Alcances pedagógicos y aplicación matemática}

% ==============================================================================
% PLANTILLA MAESTRA GENERAL - IIIEPE / MAEM
% ==============================================================================
% Uso:
...
% ==============================================================================
\def\documenttitle {Actividad 1 - Fundamentos para la ensenanza y el aprendizaje I}
\def\documentsubtitle {Actividad 1 - Fundamentos para la ensenanza y el aprendizaje I}
\def\documentsubject {Actividad 1}

\def\documentauthor {Mtro. Martin Jonathan de la Cruz Munoz}
\def\coursename {Fundamentos para la ensenanza y el aprendizaje I}
\def\coursecode {MAEM}
...
\def\universitydepartment {Fundamentos para la ensenanza y el aprendizaje I}
...
% ==============================================================================
\begin{abstractd}
	\textbf{Objetivo:} \textit{Refuerzo Ciclo A: Redactar el objetivo con verbo academico: analizar, identificar, aplicar, comparar, explicar, evaluar, interpretar, argumentar, disenar o proponer. Debe coincidir con la consigna del EVA/posgrado.}
...
\textit{Refuerzo Ciclo A: Plantear el tema con una afirmacion propia y academica, vinculada con la unidad de aprendizaje y la practica docente.}

\textit{Refuerzo Ciclo A: Explicar el problema que atiende la actividad: aprendizaje, ensenanza, evaluacion, contenido matematico, diseno didactico, contexto escolar o formacion profesional.}

\textit{Refuerzo Ciclo A: Cerrar con la postura inicial o criterio de lectura que guiara el trabajo.}
...
\subsection{Base academica del plan}

La plantilla puede utilizarse en las unidades del primer tetramestre y en
actividades posteriores de la maestria. Como criterio general, cada informe debe
relacionar la actividad con alguno de estos ejes: fundamentos de ensenanza y
aprendizaje, temas matematicos escolares, pedagogia de las matematicas,
ambientes de aprendizaje, evaluacion formativa, innovacion didactica o
propuestas de mejora para la ensenanza de las matematicas.
...
\textit{Refuerzo Ciclo A: Presentar el contexto de la actividad y transformar la consigna en problema de analisis didactico, matematico, pedagogico o profesional.}

\subsection{Marco conceptual}

\textit{Refuerzo Ciclo A: Explicar los conceptos centrales con fuentes. No acumular definiciones: cada concepto debe mostrar funcion, limite, ejemplo de aula o consecuencia para el aprendizaje.}

\subsection{Nivel cognitivo aplicado}

\textit{Refuerzo Ciclo A: Explicar brevemente que operacion cognitiva exige la actividad: comparar, diagnosticar, clasificar, interpretar, argumentar, evaluar, disenar o crear. Relacionar esa operacion con el producto solicitado.}

\subsection{Producto solicitado}

\textit{Refuerzo Ciclo A: Insertar aqui el producto de la actividad: informe, ensayo, matriz, secuencia didactica, cuadro, infografia, mapa, analisis de lectura, propuesta de intervencion o recurso matematico. Si es visual, realizarlo en LaTeX/TikZ siempre que sea posible.}

\subsection{Tecnica o estrategia didactica aplicada}

\textit{Refuerzo Ciclo A: Cuando la actividad indique una tecnica didactica, explicar aqui como se uso. Ejemplo: "La tecnica seleccionada organiza la informacion mediante criterios visibles, jerarquia y cierre reflexivo; por ello, el producto no solo presenta datos, sino que demuestra analisis y comprension".}
...
\textit{Refuerzo Ciclo A: Explicar que muestra el producto, que criterio se sostiene y que aprendizaje se obtiene. Esta parte evita que el documento sea solo una recopilacion. Usar la secuencia: hallazgo -> interpretacion -> consecuencia -> postura.}

\subsection{Aplicacion a la practica docente}

\textit{Refuerzo Ciclo A: Explicar como el analisis o producto puede transferirse a la ensenanza de las matematicas: grupo, contenido, dificultad, estrategia, evidencia de aprendizaje y mejora esperada.}
...
\textit{Refuerzo Ciclo A: Redactar una postura academica y moderada. Relacionar el tema con la unidad de aprendizaje, la formacion docente, la ensenanza de las matematicas, la vida profesional o el problema analizado. Formula recomendada: "Considero que...", "La razon es...", "La consecuencia de esto es...".}
...
% Brechas locales atendidas por Ciclo A: conclusion_argumentada, bibliografia_insuficiente, citas_insuficientes, pendientes_editoriales
...
\textit{Refuerzo Ciclo A: Cerrar con sintesis, aprendizaje y postura final.}
...
% Ejemplo: \bibliography{IIIEPE,PFM01}
\nocite{iiiepeMAEM,iiiepeSitio}
...
La mejora editorial se vincula con la memoria documental disponible mediante las referencias \citep{iiiepeMAEM}. Estas citas deben revisarse en una etapa disciplinar fina para sustituir o complementar fuentes genéricas por literatura específica del tema.

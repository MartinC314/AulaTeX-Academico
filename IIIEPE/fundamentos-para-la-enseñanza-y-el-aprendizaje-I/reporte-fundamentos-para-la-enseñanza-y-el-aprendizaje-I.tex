...
% ==============================================================================
\def\documenttitle {Plantilla de fundamentos para la ensenanza y el aprendizaje I}
\def\documentsubtitle {Actividad X - Fundamentos para la ensenanza y el aprendizaje I}
\def\documentsubject {Informe academico IIIEPE}
...
% ==============================================================================
\begin{abstractd}
	\textbf{Objetivo:} \pendiente{Redactar el objetivo con verbo academico: analizar, identificar, aplicar, comparar, explicar, evaluar, interpretar, argumentar, disenar o proponer. Debe coincidir con la consigna del EVA/posgrado.}
...
\pendiente{Plantear el tema con una afirmacion propia y academica, vinculada con la unidad de aprendizaje y la practica docente.}

\pendiente{Explicar el problema que atiende la actividad: aprendizaje, ensenanza, evaluacion, contenido matematico, diseno didactico, contexto escolar o formacion profesional.}
...
\pendiente{Presentar el contexto de la actividad y transformar la consigna en problema de analisis didactico, matematico, pedagogico o profesional.}

\subsection{Marco conceptual}

\pendiente{Explicar los conceptos centrales con fuentes. No acumular definiciones: cada concepto debe mostrar funcion, limite, ejemplo de aula o consecuencia para el aprendizaje.}

\subsection{Nivel cognitivo aplicado}

\pendiente{Explicar brevemente que operacion cognitiva exige la actividad: comparar, diagnosticar, clasificar, interpretar, argumentar, evaluar, disenar o crear. Relacionar esa operacion con el producto solicitado.}

\subsection{Producto solicitado}

\pendiente{Insertar aqui el producto de la actividad: informe, ensayo, matriz, secuencia didactica, cuadro, infografia, mapa, analisis de lectura, propuesta de intervencion o recurso matematico. Si es visual, realizarlo en LaTeX/TikZ siempre que sea posible.}

\subsection{Tecnica o estrategia didactica aplicada}

\pendiente{Cuando la actividad indique una tecnica didactica, explicar aqui como se uso. Ejemplo: "La tecnica seleccionada organiza la informacion mediante criterios visibles, jerarquia y cierre reflexivo; por ello, el producto no solo presenta datos, sino que demuestra analisis y comprension".}
...
\pendiente{Explicar como el analisis o producto puede transferirse a la ensenanza de las matematicas: grupo, contenido, dificultad, estrategia, evidencia de aprendizaje y mejora esperada.}
...
\pendiente{Redactar una postura academica y moderada. Relacionar el tema con la unidad de aprendizaje, la formacion docente, la ensenanza de las matematicas, la vida profesional o el problema analizado. Formula recomendada: "Considero que...", "La razon es...", "La consecuencia de esto es...".}

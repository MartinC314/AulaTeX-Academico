            ...
            actions.append(
                self._action(
                    ...
                    [
                        ...
                        str(activity_number),
                        "--query",
                        f"{Path(directory).name} actividad {activity_number} bibliografia planeacion contenidos fuentes primarias",
                        "--query",
                        f"{Path(directory).name} actividad {activity_number} fuentes institucionales legislacion doctrina",
                        "--iterations",
                        "2",

...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--tfhub-model", default=env_str("TFHUB_MODEL", DEFAULT_TFHUB_MODEL), help="URL/ruta del modelo TensorFlow Hub.")
    ...
    parser.add_argument("--probar-tfhub", action="store_true", help="Carga el modelo TFHub de prueba y sale.")

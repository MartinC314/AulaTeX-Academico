% ==============================================================================
% ACTIVIDAD SEMANA 4 - FILOSOFIA DEL DERECHO / UnADM
...
\def\documentsubject {Actividad 3 - Filosofía del Derecho}
...
Es la manifestación de voluntad realizada con intención de producir consecuencias reconocidas por el Derecho. No basta con que una persona quiera algo; esa voluntad debe exteriorizarse dentro de una forma o supuesto previsto por la norma. En términos prácticos, el acto jurídico convierte una decisión humana en un hecho jurídicamente relevante, como sucede con el matrimonio, el contrato, el testamento o el reconocimiento de una obligación \citep{garciaMaynez2002,poderJudicialGto2007}.

\item[\textbf{Capacidad jurídica.}]
Es la aptitud que tiene una persona para ser titular de derechos y obligaciones y, en su caso, ejercerlos por sí misma. Su función es determinar quién puede participar válidamente en relaciones jurídicas. Esta noción es clave porque el sistema jurídico no solo reconoce derechos en abstracto, sino que necesita identificar a los sujetos capaces de ejercerlos, exigirlos o cumplirlos \citep{garciaMaynez2002,poderJudicialGto2007}.

\item[\textbf{Coacción.}]
Es el uso institucional de la fuerza o de medios compulsivos para hacer cumplir el Derecho cuando la conducta voluntaria no se realiza. No debe confundirse con la sanción: la sanción es la consecuencia jurídica prevista; la coacción es el medio de imposición. Su importancia está en que muestra el componente operativo del Estado, aunque también exige límites constitucionales para no convertirse en arbitrariedad \citep{poderJudicialGto2007,garciaMaynez2002}.

\item[\textbf{Coercibilidad.}]
Es la posibilidad de que una norma jurídica sea impuesta aun contra la voluntad del obligado. Esta característica distingue a las normas jurídicas de las normas morales, porque la moral exige convicción interna, mientras que el Derecho puede reclamar cumplimiento externo mediante órganos estatales. La coercibilidad no significa abuso de fuerza; significa respaldo institucional para asegurar la eficacia mínima del orden jurídico \citep{garciaMaynez2002,launDerechoMoral2021}.

\item[\textbf{Consecuencia jurídica.}]
Es el efecto previsto por la norma cuando se realiza un supuesto jurídico. Puede consistir en crear, modificar, transmitir o extinguir derechos y obligaciones. Su utilidad está en conectar hechos con resultados normativos: si ocurre determinado hecho o acto, el sistema produce una respuesta jurídica. Sin esta conexión, la norma sería una declaración sin capacidad real de ordenar conductas \citep{garciaMaynez2002,poderJudicialGto2007}.

\item[\textbf{Deber jurídico.}]
Es la conducta exigida a un sujeto por una norma jurídica, cuyo incumplimiento puede generar una consecuencia normativa. A diferencia del deber moral, el deber jurídico puede ser exigido por otra persona o por una autoridad. Su función es ordenar responsabilidades concretas: dar, hacer, no hacer o tolerar algo dentro de una relación reconocida por el Derecho \citep{garciaMaynez2002,poderJudicialGto2007}.

\item[\textbf{Derecho.}]
Es un sistema de normas, principios, instituciones y procedimientos que regula la conducta externa de las personas en sociedad, atribuye facultades, impone deberes y busca condiciones de convivencia con seguridad, igualdad y justicia. No lo entiendo solo como ley escrita: también funciona como lenguaje institucional para resolver conflictos, controlar poder y proteger bienes jurídicos relevantes \citep{poderJudicialGto2007,rojas-gonzalezFilosofiaDerecho2018}.

\item[\textbf{Derecho objetivo.}]
Es el conjunto de normas jurídicas vigentes que integran el ordenamiento de una comunidad. Su función es ofrecer reglas generales de conducta: permite saber qué está permitido, ordenado o prohibido. En términos de sistema, el derecho objetivo es la arquitectura normativa sobre la cual se apoyan derechos subjetivos, obligaciones, sanciones y procedimientos \citep{garciaMaynez2002,poderJudicialGto2007}.

\item[\textbf{Derecho subjetivo.}]
Es la facultad reconocida por el orden jurídico a una persona para exigir una conducta, realizar un acto o reclamar protección frente a una afectación. Su importancia está en que traduce el derecho objetivo en poder jurídico concreto. Si el derecho objetivo es la regla general, el derecho subjetivo es la posibilidad de usar esa regla para defender una posición propia \citep{garciaMaynez2002,poderJudicialGto2007}.

\item[\textbf{Eficacia.}]
Es el grado en que una norma jurídica se cumple, se aplica o produce efectos reales en la vida social. Una norma puede ser válida formalmente y, aun así, ser poco eficaz si no se obedece, no se ejecuta o no transforma las prácticas que pretende regular. Para mí, este concepto es clave porque obliga a distinguir el Derecho en el papel del Derecho en funcionamiento \citep{garciaMaynez2002,launDerechoMoral2021}.

\item[\textbf{Hecho jurídico.}]
Es un acontecimiento natural o humano que produce consecuencias de Derecho, aunque no siempre exista intención de generarlas. Su valor conceptual está en ampliar la mirada: no todo efecto jurídico nace de una voluntad dirigida a crear derechos u obligaciones; también pueden producirlo el nacimiento, la muerte, el transcurso del tiempo, un daño o un acontecimiento involuntario \citep{garciaMaynez2002,poderJudicialGto2007}.

\item[\textbf{Jurisprudencia.}]
Es el criterio obligatorio o relevante que emiten los tribunales competentes al interpretar la Constitución, la ley o los principios jurídicos en casos concretos. Su función no se reduce a resolver un expediente: orienta decisiones posteriores y da estabilidad interpretativa al sistema. En México, los criterios de la Suprema Corte pueden transformar la forma en que se entiende una institución jurídica \citep{garciaMaynez2002,scjnMatrimonio2015}.

\item[\textbf{Moral.}]
Es un sistema de normas, valores y juicios internos o sociales que orientan la conducta desde la conciencia, la aprobación o la desaprobación colectiva. A diferencia del Derecho, la moral no opera principalmente por coacción estatal, sino por convicción, responsabilidad o presión social. Su relación con el Derecho es inevitable, pero no automática: puede inspirarlo, criticarlo o revelar sus límites \citep{launDerechoMoral2021,garciaMaynez2002}.

\item[\textbf{Norma jurídica.}]
Es una regla de conducta creada o reconocida por el sistema jurídico, que atribuye derechos, impone deberes y prevé consecuencias en caso de cumplimiento o incumplimiento. Su estructura permite ordenar la vida social porque vincula supuesto, conducta y consecuencia. La norma jurídica no solo describe lo que ocurre; prescribe lo que debe hacerse dentro de un marco institucional \citep{garciaMaynez2002,poderJudicialGto2007}.

\item[\textbf{Obligación.}]
Es el vínculo jurídico por el cual una persona, llamada deudor o sujeto pasivo, debe realizar una prestación de dar, hacer o no hacer frente a otra persona que puede exigirla. La obligación muestra que el Derecho trabaja con relaciones, no con sujetos aislados. Cada deber relevante suele tener una contraparte: alguien facultado para reclamar su cumplimiento \citep{poderJudicialGto2007,garciaMaynez2002}.

\item[\textbf{Persona jurídica.}]
Es todo ente reconocido por el Derecho como capaz de tener derechos y obligaciones. Puede tratarse de una persona física o de una persona moral. Este concepto es básico porque el sistema jurídico necesita identificar quién puede ser titular de una facultad, asumir una deuda, reclamar protección o responder por una conducta \citep{garciaMaynez2002,poderJudicialGto2007}.

\item[\textbf{Relación jurídica.}]
Es el vínculo regulado por el Derecho entre dos o más sujetos, en el cual se conectan facultades, deberes y consecuencias. Su importancia está en que permite observar el Derecho como red de posiciones: sujeto activo, sujeto pasivo, objeto y norma aplicable. Sin relación jurídica, los conceptos de derecho subjetivo y deber jurídico quedarían aislados \citep{poderJudicialGto2007,garciaMaynez2002}.

\item[\textbf{Sanción.}]
Es la consecuencia desfavorable prevista por el orden jurídico ante el incumplimiento de una norma o la realización de una conducta antijurídica. Su función no es únicamente castigar; también comunica que el sistema toma en serio ciertos bienes jurídicos. Una sanción sin fundamento puede ser abuso, pero una norma sin consecuencia puede perder capacidad de dirección \citep{garciaMaynez2002,poderJudicialGto2007}.

\item[\textbf{Sistema jurídico.}]
Es el conjunto ordenado de normas, principios, instituciones, procedimientos y criterios interpretativos que operan de manera articulada dentro de una comunidad política. Este concepto evita ver la ley como piezas sueltas. Una norma sobre matrimonio, por ejemplo, no puede analizarse de forma aislada: debe ubicarse frente a Constitución, derechos humanos, jurisprudencia, igualdad y no discriminación \citep{rojas-gonzalezFilosofiaDerecho2018,garciaMaynez2002}.

\item[\textbf{Validez.}]
Es la cualidad de una norma o acto que ha sido creado conforme a los criterios formales y materiales exigidos por el sistema jurídico. Una norma puede tener origen legislativo y, aun así, perder validez constitucional si contradice derechos fundamentales. Este concepto es decisivo porque muestra que el Derecho no solo pregunta quién emitió la regla, sino si esa regla respeta los límites superiores del ordenamiento \citep{garciaMaynez2002,scjnMatrimonio2015}.
...
% Se usa el alias tecnico unificado en la carpeta de referencias.

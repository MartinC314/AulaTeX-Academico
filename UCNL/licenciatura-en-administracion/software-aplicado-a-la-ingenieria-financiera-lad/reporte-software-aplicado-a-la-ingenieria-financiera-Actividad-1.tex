...
% \def\documentsubtitle {Actividad 1 - Software aplicado a la ingenieria financiera}
% \def\documentsubject {Actividad 1}
% ==============================================================================
\def\documenttitle {Actividad 1 - Software aplicado a la ingenieria financiera}
\def\documentsubtitle {Actividad 1 - Software aplicado a la ingenieria financiera}
\def\documentsubject {Actividad 1}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Software aplicado a la ingenieria financiera}
\def\coursecode {SOF-IIF}

\def\universityname {Universidad Ciudadana de Nuevo Leon}
\def\universityfaculty {Programa academico UCNL}
\def\universitydepartment {Software aplicado a la ingenieria financiera}
...
\bibliography{software-aplicado-a-la-ingenieria-financiera}

...
\title{Presentacion - Derecho civil}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{derecho-civil.bib}
    \item Curso: Derecho civil
    \item Actividades: \texttt{reporte-derecho-civil-Actividad-N.tex}
  \end{itemize}
\end{frame}

...
\title{Presentacion - Estrategias de promocion}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{estrategias-de-promocion.bib}
    \item Curso: Estrategias de promocion
    \item Actividades: \texttt{reporte-estrategias-de-promocion-Actividad-N.tex}
  \end{itemize}
\end{frame}

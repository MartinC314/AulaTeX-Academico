...
\title{Presentacion - Practicas profesionales}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{practicas-profesionales.bib}
    \item Curso: Practicas profesionales
    \item Actividades: \texttt{reporte-practicas-profesionales-Actividad-N.tex}
  \end{itemize}
\end{frame}

...
\title{Presentacion - Administracion de ventas}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{administracion-de-ventas.bib}
    \item Curso: Administracion de ventas
    \item Actividades: \texttt{reporte-administracion-de-ventas-Actividad-N.tex}
  \end{itemize}
\end{frame}

...
\title{Presentacion - Desarrollo sustentable}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{desarrollo-sustentable.bib}
    \item Curso: Desarrollo sustentable
    \item Actividades: \texttt{reporte-desarrollo-sustentable-Actividad-N.tex}
  \end{itemize}
\end{frame}

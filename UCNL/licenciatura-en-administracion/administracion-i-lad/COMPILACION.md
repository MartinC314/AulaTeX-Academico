# Compilacion - Administracion I

Ejecutar siempre desde la raiz del proyecto:

```powershell
.\scripts\latexmk-build.ps1 .\UCNL\administracion-I\reporte-administracion-I.tex
.\scripts\latexmk-build.ps1 .\UCNL\administracion-I\reporte-administracion-I-Actividad-1.tex
.\scripts\latexmk-build.ps1 .\UCNL\administracion-I\presentacion-administracion.tex
```
...
- El `.bib` no se pasa al script. Los reportes deben declarar `\bibliography{administracion-I}`.
- BibTeX busca `administracion-I.bib` con `BIBINPUTS`.
...
- Toda clave citada debe existir en `administracion-I.bib`.

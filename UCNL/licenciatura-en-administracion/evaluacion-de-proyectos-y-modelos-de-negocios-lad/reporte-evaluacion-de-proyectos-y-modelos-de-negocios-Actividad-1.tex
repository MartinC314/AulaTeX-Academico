...
% \def\documentsubtitle {Actividad 1 - Evaluacion de proyectos y modelos de negocios}
% \def\documentsubject {Actividad 1}
% ==============================================================================
\def\documenttitle {Actividad 1 - Evaluacion de proyectos y modelos de negocios}
\def\documentsubtitle {Actividad 1 - Evaluacion de proyectos y modelos de negocios}
\def\documentsubject {Actividad 1}

\def\documentauthor {Martin Jonathan de la Cruz}
\def\coursename {Evaluacion de proyectos y modelos de negocios}
\def\coursecode {EVA-PMN}

\def\universityname {Universidad Ciudadana de Nuevo Leon}
\def\universityfaculty {Programa academico UCNL}
\def\universitydepartment {Evaluacion de proyectos y modelos de negocios}
...
\bibliography{evaluacion-de-proyectos-y-modelos-de-negocios}

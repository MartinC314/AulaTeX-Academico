...
\title{Presentacion - Diseno organizacional}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{diseno-organizacional.bib}
    \item Curso: Diseno organizacional
    \item Actividades: \texttt{reporte-diseno-organizacional-Actividad-N.tex}
  \end{itemize}
\end{frame}

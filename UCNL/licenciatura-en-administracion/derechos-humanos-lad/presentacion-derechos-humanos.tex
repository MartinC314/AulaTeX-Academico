...
\title{Presentacion - Derechos humanos}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{derechos-humanos.bib}
    \item Curso: Derechos humanos
    \item Actividades: \texttt{reporte-derechos-humanos-Actividad-N.tex}
  \end{itemize}
\end{frame}

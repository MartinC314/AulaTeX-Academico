...
\title{Presentacion - Administracion de calidad}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{administracion-de-calidad.bib}
    \item Curso: Administracion de calidad
    \item Actividades: \texttt{reporte-administracion-de-calidad-Actividad-N.tex}
  \end{itemize}
\end{frame}

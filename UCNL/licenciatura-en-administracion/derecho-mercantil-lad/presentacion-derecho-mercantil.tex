...
\title{Presentacion - Derecho mercantil}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{derecho-mercantil.bib}
    \item Curso: Derecho mercantil
    \item Actividades: \texttt{reporte-derecho-mercantil-Actividad-N.tex}
  \end{itemize}
\end{frame}

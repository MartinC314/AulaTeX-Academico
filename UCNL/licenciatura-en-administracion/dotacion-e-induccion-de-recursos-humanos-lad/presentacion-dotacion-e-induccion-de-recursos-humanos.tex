...
\title{Presentacion - Dotacion e induccion de recursos humanos}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{dotacion-e-induccion-de-recursos-humanos.bib}
    \item Curso: Dotacion e induccion de recursos humanos
    \item Actividades: \texttt{reporte-dotacion-e-induccion-de-recursos-humanos-Actividad-N.tex}
  \end{itemize}
\end{frame}

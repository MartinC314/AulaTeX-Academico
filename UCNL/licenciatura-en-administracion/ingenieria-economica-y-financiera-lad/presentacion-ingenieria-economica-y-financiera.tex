...
\title{Presentacion - Ingenieria economica y financiera}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{ingenieria-economica-y-financiera.bib}
    \item Curso: Ingenieria economica y financiera
    \item Actividades: \texttt{reporte-ingenieria-economica-y-financiera-Actividad-N.tex}
  \end{itemize}
\end{frame}

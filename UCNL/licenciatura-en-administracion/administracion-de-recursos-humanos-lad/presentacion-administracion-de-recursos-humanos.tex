...
\title{Presentacion - Administracion de recursos humanos}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{administracion-de-recursos-humanos.bib}
    \item Curso: Administracion de recursos humanos
    \item Actividades: \texttt{reporte-administracion-de-recursos-humanos-Actividad-N.tex}
  \end{itemize}
\end{frame}

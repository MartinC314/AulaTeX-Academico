...
\title{Presentacion - Contabilidad III}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{contabilidad-III.bib}
    \item Curso: Contabilidad III
    \item Actividades: \texttt{reporte-contabilidad-III-Actividad-N.tex}
  \end{itemize}
\end{frame}

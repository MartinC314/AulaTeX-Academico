...
\title{Presentacion - Planeacion estrategica financiera}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{planeacion-estrategica-financiera.bib}
    \item Curso: Planeacion estrategica financiera
    \item Actividades: \texttt{reporte-planeacion-estrategica-financiera-Actividad-N.tex}
  \end{itemize}
\end{frame}

...
\title{Presentacion - Habilidades directivas}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{habilidades-directivas.bib}
    \item Curso: Habilidades directivas
    \item Actividades: \texttt{reporte-habilidades-directivas-Actividad-N.tex}
  \end{itemize}
\end{frame}

...
\title{Presentacion - Diagnostico y evaluacion empresarial}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{diagnostico-y-evaluacion-empresarial.bib}
    \item Curso: Diagnostico y evaluacion empresarial
    \item Actividades: \texttt{reporte-diagnostico-y-evaluacion-empresarial-Actividad-N.tex}
  \end{itemize}
\end{frame}

...
\title{Presentacion - Macroeconomia}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{macroeconomia.bib}
    \item Curso: Macroeconomia
    \item Actividades: \texttt{reporte-macroeconomia-Actividad-N.tex}
  \end{itemize}
\end{frame}

...
\title{Presentacion - Practicas profesionales I}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{practicas-profesionales-I.bib}
    \item Curso: Practicas profesionales I
    \item Actividades: \texttt{reporte-practicas-profesionales-I-Actividad-N.tex}
  \end{itemize}
\end{frame}

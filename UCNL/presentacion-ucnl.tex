...
\title{Presentacion institucional UCNL}
...
\begin{frame}{Estructura academica}
  \begin{itemize}
    \item Bibliografia: \texttt{bibliografia-ucnl.bib}
    \item Materias: Administracion, Contabilidad, Inductivo, Sustentable, Ingles, Matematicas y Microeconomia

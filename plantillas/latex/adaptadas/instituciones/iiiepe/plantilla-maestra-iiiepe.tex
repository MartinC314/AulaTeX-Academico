...
\def\documentsubtitle {Actividad X - Unidad de aprendizaje}
\def\documentsubject {Informe academico}

\def\documentauthor {Mtro. Martin Jonathan de la Cruz Munoz}
\def\coursename {Nombre de la unidad de aprendizaje}
\def\coursecode {MAEM}
...
\def\universitydepartment {Nombre de la unidad de aprendizaje}

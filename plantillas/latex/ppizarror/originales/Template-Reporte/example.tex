...
\subsection{Otros párrafos más normales}
	...
	\begin{multicols}{2}
		...
		\insertimage{ejemplos/test-image-wrap}{width=3.9cm}{Imagen en párrafo.}
...
\begin{images}[\label{imagenmultiple}]{Ejemplo de imagen múltiple.}
	...
	\imagesnewline
	\addimage{ejemplos/test-image}{width=7.75cm}{Ciudad más grande}
\end{images}
\end{sourcecode}
...
\begin{appendixd}
	...
	\insertimage[\label{img:anexo-2}]{ejemplos/test-image.png}{scale=0.18}{Imagen en anexo.}

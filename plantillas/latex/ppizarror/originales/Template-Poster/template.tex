...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={1.3.1-PRES},
		Template.Version.Hash={A05250262B89637EED4D22F1D803F09A},
		Template.Version.Release={1.3.1},
	...
	pdfproducer={Template-Presentacion v1.3.1 | (Pablo Pizarro R.) ppizarror.com},
...
\addtobeamertemplate{block alerted begin}{}{
	\setlength\abovedisplayskip{0pt}%
	\vspace{\dimexpr-0.7em + \blockaepaddingtop em} % Padding superior alerta
	\begin{adjustwidth}{%
			\dimexpr-0.4em + \blockaepaddingleft em % Padding izquierdo alerta
		}{
			\dimexpr-0.4em + \blockaepaddingright em % Padding derecho alerta
		}
	}
\addtobeamertemplate{block alerted end}{
	\end{adjustwidth}
	\vspace{\dimexpr-0.6em + \blockaepaddingbottom em} % Padding inferior alerta
}{
	\vspace{\dimexpr-1.07em + \blockaemarginbottom em} % Margen inferior alerta
}
% Ejemplo
\addtobeamertemplate{block example begin}{}{
	\setlength\abovedisplayskip{0pt}%
	\vspace{\dimexpr-0.7em + \blockaepaddingtop em} % Padding superior ejemplo
	\begin{adjustwidth}{%
			\dimexpr-0.4em + \blockaepaddingleft em % Padding izquierdo ejemplo
		}{
			\dimexpr-0.4em + \blockaepaddingright em % Padding derecho ejemplo
		}
	}
\addtobeamertemplate{block example end}{
	\end{adjustwidth}
	\vspace{\dimexpr-0.6em + \blockaepaddingbottom em} % Padding inferior ejemplo
}{
	\vspace{\dimexpr-1.07em + \blockaemarginbottom em} % Margen inferior ejemplo
}

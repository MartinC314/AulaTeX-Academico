...
\begin{block}{Insertar tablas}
	...
	O bien, con notas presentadas directamente en el bloque para evitar flotantes incompatibles con `beamer`:
	...
	{\footnotesize\textit{Notas:} Esta tabla acepta comentarios al margen del bloque. (a) Este elemento tiene una descripción debajo de la tabla. (1) Más comentarios.}

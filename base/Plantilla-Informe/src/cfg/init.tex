...
\ifthenelse{\equal{\cfgpdfbookmarkopen}{true}}{
	\bookmarksetup{open=true,openlevel=\cfgbookmarksopenlevel}
}{
	\bookmarksetup{open=false,openlevel=\cfgbookmarksopenlevel}
}
